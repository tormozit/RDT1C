...
Функция ВыбранныеПрава(ВВидеТаблицы = Истина, ДобавитьПустоеЗначение = Ложь) Экспорт 
	...
	ирОбщий.НайтиДобавитьЭлементОтбораКомпоновкиЛкс(НастройкаКомпоновки.Отбор, "Имя", НаборПрав);
	ТаблицаВидовПравНаОбъекты = ирОбщий.ОтобратьТаблицуЗначенийКомпоновкойЛкс(ирКэш.ВсеВидыПравДоступаЛкс(), НастройкаКомпоновки);
	#Если Сервер И Не Сервер Тогда
		ТаблицаВидовПравНаОбъекты = Новый ТаблицаЗначений;
	#КонецЕсли
	ТаблицаВидовПравНаОбъекты = ТаблицаВидовПравНаОбъекты.Скопировать(, "Имя, Представление, Порядок");
	Если ВВидеТаблицы Тогда
		Результат = ТаблицаВидовПравНаОбъекты;
	...
	Иначе
		...
		Для Каждого Строка Из ТаблицаВидовПравНаОбъекты Цикл
