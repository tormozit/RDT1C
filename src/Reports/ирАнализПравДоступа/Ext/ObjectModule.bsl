...
Процедура ИнициироватьТаблицуПрав()
	...
	Если Метаданные.Справочники.Найти("ПрофилиГруппДоступа") <> Неопределено Тогда
		ТипЗначения = Новый ОписаниеТипов("СправочникСсылка.ПрофилиГруппДоступа");  //@skip-check unknown-method-property
		СхемаКомпоновкиДанных.НаборыДанных.ПрофилиГруппДоступа.Поля.Найти("ПрофильГруппДоступа").ТипЗначения = ТипЗначения;
	КонецЕсли;
