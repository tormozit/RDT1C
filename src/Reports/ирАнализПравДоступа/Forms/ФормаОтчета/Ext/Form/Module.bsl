...
Процедура ДействиеРасшифровки(ВыбранноеДействие, ПараметрВыбранногоДействия, СтандартнаяОбработка) Экспорт
	...
	ИначеЕсли ВыбранноеДействие = "ОткрытьОписаниеТипов" Тогда
		...
		ирОбщий.ОткрытьЗначениеЛкс(ОписаниеТипов, Ложь,,, Ложь);
	...
	ИначеЕсли ВыбранноеДействие = "ОткрытьФункциональныеОпции" Тогда
		...
		ирОбщий.ОткрытьЗначенияФункциональныхОпцийЛкс(ЗначенияФункОпций, ОбъектМетаданных.ПолноеИмя());
	КонецЕсли; 
...
Процедура ПолеОбъектаНачалоВыбора(Элемент, СтандартнаяОбработка)
	...
	#КонецЕсли
	РезультатВыбора = ирОбщий.ОткрытьТаблицуЗначенийЛкс(ПоляТаблицы, ПоляТаблицы.Найти(ПолеОбъекта, "Имя"),, "Выберите поле", Истина);
	Если РезультатВыбора <> Неопределено Тогда
		ирОбщий.ИнтерактивноЗаписатьВПолеВводаЛкс(ЭлементыФормы.ПолеОбъекта, РезультатВыбора.Имя);
	КонецЕсли; 
КонецПроцедуры
...
Процедура ДействияФормыАнализПравНаБазу(Кнопка)
	...
	ФормаОтчета = ирОбщий.ПолучитьФормуЛкс("Отчет.ирАнализПравНаБазу.Форма",,, Пользователь);
...
Процедура КПНаборПолейРедактироватьСписокСтрок(Кнопка)
	ФормаВыбора = ирОбщий.ОткрытьСписокЗначенийЛкс(НаборПолей);
КонецПроцедуры

Процедура КПНаборПолейРедактироватьСписокКолонокБД(Кнопка = Неопределено)
	ФормаВыбора = ирОбщий.ФормаВыбораКолонокБДЛкс(ЭтаФорма, НаборПолей.ВыгрузитьЗначения(),, Истина);
