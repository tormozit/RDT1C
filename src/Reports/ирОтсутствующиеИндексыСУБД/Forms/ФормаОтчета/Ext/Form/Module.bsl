...
Процедура ДействиеРасшифровки(ВыбранноеДействие, ПараметрВыбранногоДействия, СтандартнаяОбработка) Экспорт
	...
	Если ВыбранноеДействие = "ОткрытьОбъектМетаданных" Тогда
		...
		ирКлиент.ОткрытьОбъектМетаданныхЛкс(ирКэш.ОбъектМДПоПолномуИмениЛкс(ИмяВМетаданных));
	КонецЕсли; 
...
ирКлиент.ИнициироватьФормуЛкс(ЭтаФорма, "Отчет.ирОтсутствующиеИндексыСУБД.Форма.ФормаОтчета");
