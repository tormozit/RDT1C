...
Функция ВнешниеНаборыДанных() Экспорт 
	...
	Таблица.Колонки.Добавить("Файл", Новый ОписаниеТипов("Строка",,,, Новый КвалификаторыСтроки(999)));
	Таблица.Колонки.Добавить("Модуль", Новый ОписаниеТипов("Строка",,,, Новый КвалификаторыСтроки(999)));
	Таблица.Колонки.Добавить("ИДМодуля", Новый ОписаниеТипов("Строка",,,, Новый КвалификаторыСтроки(999)));
	Таблица.Колонки.Добавить("Текст", Новый ОписаниеТипов("Строка",,,, Новый КвалификаторыСтроки(999)));
	...
	Таблица.Колонки.Добавить("Метод", Новый ОписаниеТипов("Строка",,,, Новый КвалификаторыСтроки(999)));
