...
Процедура КПВыражениеСгенерироватьПрограммныйКод(Кнопка)
	...
	|RegExp.Pattern = " + РазвернутоеВыражение() + ";";
	ПрограммныйКод = ПрограммныйКод + "
...
Функция ОбновитьПроверочныйТекст(РазрешитьАвтовыделение = Истина)
...
Процедура КП_ПроверочныйТекстОткрытьВРедакторе(Кнопка)
	ирКлиент.ОткрытьТекстЛкс(ПроверочныйТекст(),, "XML",,, ЭтаФорма);
КонецПроцедуры
