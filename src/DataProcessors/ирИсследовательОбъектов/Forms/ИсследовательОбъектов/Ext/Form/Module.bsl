...
Процедура ПриОткрытии()
	...
	ЭлементыФормы.КоманднаяПанельДерева.Кнопки.ОтображениеJSON.Доступность = ирКэш.ДоступенJSONЛкс();
	ЭлементыФормы.КоманднаяПанельДерева.Кнопки.ОтображениеJSONПрямое.Доступность = ирКэш.ДоступенJSONЛкс();
