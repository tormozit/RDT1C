...
Процедура ПриОткрытии()
	...
	ПрименитьФильтрПоПодстрокеБезСохранения(); // иначе при первой установке значения отбора будет перескакивать каретка в начало
	КПТипыОбновить();
...
Процедура ПоляПриВыводеСтроки(Элемент, ОформлениеСтроки, ДанныеСтроки) Экспорт
	...
	ИндексКартинки = ирОбщий.ИндексКартинкиТипаЗначенияБДЛкс(мОписанияТиповПолей.Найти(ДанныеСтроки.ИмяПоля, "Имя").ОписаниеТипов);
...
Процедура СписокСсылокНачалоВыбора(Элемент, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = Ложь;
	ирОбщий.ОткрытьСписокЗначенийЛкс(Элемент.Значение);
...
Процедура ПрименитьФильтрПоПодстрокеБезСохранения()
	...
	ирОбщий.ПриИзмененииПоляВводаОтбораСодержитЛкс(ЭтаФорма, ЭлементыФормы.ФильтрИмя);
	ирОбщий.ПриИзмененииПоляВводаОтбораСодержитЛкс(ЭтаФорма, ЭлементыФормы.ФильтрПредставление);
...
ирОбщий.ИнициироватьФормуЛкс(ЭтаФорма, "Обработка.ирИсторияДанных.Форма.Форма");
...
мОтборВерсий = Новый Структура;
ЭлементыФормы.ФильтрИмя.Данные = "ЭлементыФормы.Типы.Отбор.ПредставлениеМД.Значение";
...
ЭлементыФормы.ФильтрПредставление.Данные = "ЭлементыФормы.Типы.Отбор.ИмяМД.Значение";
