...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	Если Не Отказ Тогда
		...
		Если РедакторHTML() <> Неопределено Тогда
			УдалитьОбработчик ЭлементыФормы.РедакторHTML.Документ.defaultView.onclick, ЭтаФорма.РедакторHTMLonclick; // Иначе при следующем вызове ДобавитьОбработчик будет аварийное завершение
		КонецЕсли;
	КонецЕсли; 
