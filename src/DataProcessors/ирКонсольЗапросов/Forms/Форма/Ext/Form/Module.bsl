...
Процедура КоманднаяПанельОбработкиРезультатаКонсольКода(Кнопка)
	...
	ирОбщий.ОперироватьСтруктуройЛкс(ЭлементыФормы.КодОбработкиРезультата.ПолучитьТекст(), , СтруктураПараметров, НаСервере);
...
Процедура КоманднаяПанельОбработкаСтрокиРезультатаКонсольКода(Кнопка)
	...
	ирОбщий.ОперироватьСтруктуройЛкс(ТекстАлгоритма, , СтруктураПараметров, НаСервере);
