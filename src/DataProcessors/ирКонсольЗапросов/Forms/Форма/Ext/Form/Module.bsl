...
Процедура КП_ТаблицаПакетаНайтиЗапросВДереве(Кнопка = Неопределено)
	...
	Иначе
		...
		Фрагменты = мПлатформа.РазбитьГрубоТекстПакетногоЗапросаНаТекстыЗапросов(ПолеТекстаЗапроса.ПолеТекста.ПолучитьТекст(),, ПозицииЗапросов);
...
Процедура ЗаменитьЛитераломЗНАЧЕНИЕОбращенияКПараметру(Знач СтрокаПараметра)
	...
	Тогда
		...
		Для Каждого ЭлементМассива Из Массив Цикл
			...
			КонецЕсли; 
			ТекстЗаменыЭлемента = ирОбщий.ПредставлениеЗначенияВЯзыкеЗапросовЛкс(ЭлементМассива, Истина);
	...
	Иначе
		...
		ТекстЗамены = ирОбщий.ПредставлениеЗначенияВЯзыкеЗапросовЛкс(ЗначениеПараметра, Истина);
	КонецЕсли; 
