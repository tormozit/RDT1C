...
Процедура ВыделитьВесьТекст(Знач Форма = Неопределено) Экспорт
	КоличествоСтрок = КоличествоСтрок();
	УстановитьГраницыВыделения(1, 1, Макс(1, КоличествоСтрок), СтрДлина(ПолучитьСтроку(КоличествоСтрок) + 1),, Форма);
КонецПроцедуры
