...
Процедура ЗаполнитьТаблицуТиповСобытий() Экспорт
	...
	ТаблицаИзМакета = ирОбщий.ТаблицаЗначенийИзТабличногоДокументаЛкс(ПолучитьМакет("ТипыСобытий"),,,,,,,, Ложь);
...
Процедура ЗаписатьДОМ(Документ, ИмяФайла) Экспорт
	...
	ирОбщий.ЗаписатьТекстВФайлЛкс(СтрокаХМЛ, ИмяФайла, мКодировкаФайла, НаСервере);
...
мВариантыРасположенияФайла = ирОбщий.ВариантыРазмещенияКонфигФайлаПлатформыЛкс(мСписокВариантовРасположенияКонфигурационногоФайла);
