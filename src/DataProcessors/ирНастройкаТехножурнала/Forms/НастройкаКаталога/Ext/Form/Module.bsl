...
Процедура ОткрытьФормуРедактированияУсловий(Знач ТабличноеПоле, Знач ТекущееСвойство = "")
	
	ФормаРедактированияУсловий = ОбработкаОбъект.ПолучитьФорму("УсловияЗаписиСвойства");
	//Если ТабличноеПоле.Имя = "ТабличноеПолеСписокСвойств" Тогда
	//	УзелСобытий = ПолучитьУзелСвойства(ТекущийЖурнал, ТабличноеПоле.ТекущаяСтрока.НомерСвойства);
	//	ИмяСвойства = ТабличноеПоле.ТекущаяСтрока.ИмяСвойства;
	//	Если УзелСобытий <> Неопределено Тогда
	//		УзелСобытий = УзелСобытий.ПервыйДочерний;
	//	КонецЕсли;
	//Иначе
	//	УзелСобытий = ПолучитьУзелСобытия(ТекущийЖурнал, ТабличноеПоле.ТекущаяСтрока.НомерСобытия);
	//КонецЕсли;
	...
	Если Результат = "ОК" Тогда
		//Если ТабличноеПоле.Имя = "ТабличноеПолеСписокСобытий" Тогда
		//	//ТабЗнач = ФормаРедактированияУсловий.ЭтаФорма.РедактированиеУсловийСобытия;
		//	//УстановитьЭлементОтбораСобытий(ТабЗнач, мТекущийНомерУзлаСобытия, ТабличноеПоле.ТекущаяСтрока);
		//Иначе
			...
			КонецЦикла;
			ТабличноеПоле.ТекущаяСтрока.ИмяСвойства = ЗаменитьСимвол(ФормаРедактированияУсловий.ВыборИмениСвойства, "_", ":");
			//ТабличноеПолеСписокСвойствПриАктивизацииСтроки(ТабличноеПоле);
		//КонецЕсли;
...
Процедура ТабличноеПолеСписокСвойствПередНачаломИзменения(Элемент, Отказ)
	...
	ОткрытьФормуРедактированияУсловий(Элемент);
...
Процедура ПриЗакрытии()
	...
	ОсновнаяФорма = ЭтаФорма.ВладелецФормы; // см. Обработка.ирНастройкаТехножурнала.Форма.НастройкаТехножурнала
