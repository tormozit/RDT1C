...
Процедура ПриОткрытии()
	ЭтаФорма.Активно = Ложь;
	ЭтаФорма.Завершено = Ложь;
	ЭтаФорма.ЗавершеноАварийно = Ложь;
	ЭтаФорма.Отменено = Ложь;
	Если Отбор <> Неопределено Тогда
		Для Каждого Свойство из Отбор Цикл
			Если Свойство.Ключ = "ДлительностьМин" Тогда
				ЭтаФорма.ДлительностьМин = Свойство.Значение;
			ИначеЕсли Свойство.Ключ = "ДлительностьМакс" Тогда
				ЭтаФорма.ДлительностьМакс = Свойство.Значение;
			...
			ИначеЕсли Свойство.Ключ = "ИмяМетода" Тогда
				ЭтаФорма.Метод = Свойство.Значение;
			ИначеЕсли Свойство.Ключ = "РегламентноеЗадание" Тогда
				Регламентное = Свойство.Значение; // РегламентноеЗадание
				Если Регламентное <> Неопределено Тогда
