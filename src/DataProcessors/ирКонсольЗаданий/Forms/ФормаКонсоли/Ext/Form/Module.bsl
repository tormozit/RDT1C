...
Процедура ПриОткрытии()
	...
	ирОбщий.ДопСвойстваЭлементаФормыЛкс(ЭтаФорма, ЭлементыФормы.СписокРегламентныхЗаданий).МенеджерПоиска = ирОбщий.СоздатьМенеджерПоискаВТабличномПолеЛкс(КолонкиПоиска,,, Истина);
