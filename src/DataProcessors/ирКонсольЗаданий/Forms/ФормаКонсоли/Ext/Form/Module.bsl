...
Процедура РегламентныеЗаданияОбновитьПодменюПоследниеВыбранные()
	...
	ирКлиент.ПоследниеВыбранныеЗаполнитьПодменюЛкс(ЭтаФорма, ЭлементыФормы.КоманднаяПанельРегламентныеЗадания.Кнопки.ПоследниеВыбранные, ЭлементыФормы.СписокРегламентныхЗаданий,
...
Процедура КоманднаяПанельРегламентныеЗаданияВыполнитьРегламентноеЗаданиеВФоновомЗадании(Кнопка)
	...
	Для Каждого ВыделеннаяСтрока Из ЭлементыФормы.СписокРегламентныхЗаданий.ВыделенныеСтроки Цикл
		Если Не ЗначениеЗаполнено(ВыделеннаяСтрока.Идентификатор) Тогда
			Продолжить;
		КонецЕсли; 
		ЗапуститьРегЗадание(ВыделеннаяСтрока);
...
Процедура ЗапуститьРегЗадание(Знач ВыделеннаяСтрока, ТипЗапуска = "Ручной")
	...
	КонецЕсли; 
	НаименованиеЗадания = ТипЗапуска + " запуск """ + ПредставлениеЗадания + """ пользователем """ + ИмяПользователя() + """";
...
Процедура КоманднаяПанельРегламентныеЗаданияПоОбъекту(Кнопка)
	ТекущаяСтрока = ЭлементыФормы.СписокРегламентныхЗаданий.ТекущаяСтрока;
	Если ТекущаяСтрока = Неопределено Тогда
		Возврат;
	КонецЕсли; 
