...
Процедура РегламентныеЗаданияОбновитьПодменюПоследниеВыбранные()
	...
	ирКлиент.ПоследниеВыбранныеЗаполнитьПодменюЛкс(ЭтаФорма, ЭлементыФормы.КПРегламентныеЗадания.Кнопки.ПоследниеВыбранные, ЭлементыФормы.СписокРегламентныхЗаданий, "РегламентныеПоследниеВыбранныеНажатие");
