...
Процедура ОсновныеДействияФормыОК(Кнопка)
	...
	Для Каждого ИмяПользователя Из ПараметрИменаПользователей Цикл
		...
		Если ПарольУстановить Тогда
			...
			БылиИзменения = Истина;
		КонецЕсли; 
		Если ОтключитьАутентификацию Тогда
...
Процедура ОбновитьДоступность()
	...
	ЭлементыФормы.ВариантИнтерфейсаКлиентскогоПриложенияВерсия8_5.Доступность = ВариантИнтерфейсаКлиентскогоПриложенияУстановить И ирКэш.НомерИзданияПлатформыЛкс() >= "85";
