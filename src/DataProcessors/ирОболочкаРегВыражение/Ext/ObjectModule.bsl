...
Функция ДоступенVBScript() Экспорт 
	...
	Возврат ирКэш.ЛиДоступенVBScriptЛкс();
...
Функция НоваяТаблицаВхождений() Экспорт 
	...
	//! ТаблицаВхождений.Колонки.Добавить("Группа0", Новый ОписаниеТипов("Строка"));
	//! ТаблицаВхождений.Колонки.Добавить("Группа1", Новый ОписаниеТипов("Строка"));
