...
Процедура НайденныеСсылкиПриВыводеСтроки(Элемент, ОформлениеСтроки, ДанныеСтроки) Экспорт
	...
	ирОбщий.ТабличноеПолеПриВыводеСтрокиЛкс(ЭтаФорма, Элемент, ОформлениеСтроки, ДанныеСтроки, Новый Структура("Текст", "Отображать пустые"),,,,, "Ссылка");
...
Процедура ПроверитьИзменениеОтбораНайдененныхДляИсторииОтложенно()
	...
	ДобавленВСписок = ирОбщий.ДобавитьОтборВИсториюТабличногоПоляЛкс(ЭтаФорма, ТабличноеПоле, ТабличноеПоле.ОтборСтрок, СтарыйОтборНайденных, "Ссылка");
	Если ДобавленВСписок Тогда
		ОбновитьПодменюПоследнихОтборовНайденных();
	КонецЕсли;
