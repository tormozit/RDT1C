...
Процедура КоманднаяПанельНайденныеСсылкиВключитьВсе(Кнопка)
	...
	ирОбщий.ИзменитьПометкиВыделенныхИлиОтобранныхСтрокЛкс(ЭтаФорма, ЭлементыФормы.НайденныеСсылки, , Истина);
	ОбновитьСчетчикиПравилЗамены();
...
Процедура КоманднаяПанельНайденныеСсылкиВыключитьВсе(Кнопка)
	...
	ирОбщий.ИзменитьПометкиВыделенныхИлиОтобранныхСтрокЛкс(ЭтаФорма, ЭлементыФормы.НайденныеСсылки, , Ложь);
	ОбновитьСчетчикиПравилЗамены();
...
Процедура КоманднаяПанельНайденныеЗависимыеСсылкиВключитьВсе(Кнопка)
	ирОбщий.ИзменитьПометкиВыделенныхИлиОтобранныхСтрокЛкс(ЭтаФорма, ЭлементыФормы.НайденныеЗависимыеСсылки, , Истина);
	ОбновитьСчетчикиПравилЗамены();
КонецПроцедуры
...
Процедура КоманднаяПанельЗаменаСсылокВключитьВсе(Кнопка)
	...
	ирОбщий.ИзменитьПометкиВыделенныхИлиОтобранныхСтрокЛкс(ЭтаФорма, ЭлементыФормы.ПравилаЗаменыСсылок, , Истина);
	//ОбновитьКоличествоПомеченныхПравил();
...
Процедура КоманднаяПанельЗаменаСсылокВыключитьВсе(Кнопка)
	...
	ирОбщий.ИзменитьПометкиВыделенныхИлиОтобранныхСтрокЛкс(ЭтаФорма, ЭлементыФормы.ПравилаЗаменыСсылок, , Ложь);
	//ОбновитьКоличествоПомеченныхПравил();
...
Процедура КоманднаяПанельЭлементыТекущейГруппыСравнитьСтроки(Кнопка)
	...
	Для Каждого ВыделеннаяСтрока Из ВыделенныеСтроки Цикл
		Объект = ирОбщий.ОбъектБДПоКлючуЛкс(ПолноеИмяОбъекта, ВыделеннаяСтрока.Ссылка).Методы;
		Объекты.Добавить(Объект, "" + ВыделеннаяСтрока.Ссылка);
		Если ТабличноеПоле.ТекущаяСтрока = ВыделеннаяСтрока Тогда
			ТекущийОбъект = Объект;
		КонецЕсли;
	КонецЦикла;
	ирОбщий.СравнитьОбъектыВФормеЛкс(Объекты,, ТекущаяКолонка, ТекущийОбъект);
...
Процедура КоманднаяПанельЗаменаСсылокСравнитьОбъекты(Кнопка)
	...
	ирОбщий.Сравнить2ЗначенияВФормеЛкс(ДанныеСтроки1, ДанныеСтроки2);
...
Процедура ОткрытьРедакторОбъектаБДСтроки(Связанный = Ложь)
	...
	КонецЕсли;
	ирОбщий.ОткрытьТекущуюСтрокуТабличногоПоляТаблицыБДВРедактореОбъектаБДЛкс(ЭлементыФормы.ЭлементыТекущейГруппы, ПолноеИмяОбъекта,, Связанный, СвязанныйРедакторОбъектаБД,, Ложь,,,
		мОбработкаПоискаСсылок.СсылкиНаОбъект.Выгрузить(Новый Структура("Ссылка", Ссылка)));
	Если Связанный Тогда
