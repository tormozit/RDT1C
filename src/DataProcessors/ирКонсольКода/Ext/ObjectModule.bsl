...
Функция НовыеПараметрыВыполненияАлгоритмаВКонтексте() Экспорт
	ПараметрыЗапуска = Новый Структура("ТекстАлгоритма, ТекстДляВыполнения, СтруктураПараметров, ВыполнятьНаСервере, ЧерезВнешнююОбработку, ИмяФайлаВнешнейОбработки, ВерсияАлгоритма, ЛиСинтаксическийКонтроль, ЛиМодульОтФормы");
	ПараметрыЗапуска.ВыполнятьНаСервере = Ложь;
	ПараметрыЗапуска.ЛиСинтаксическийКонтроль = Ложь;
	ПараметрыЗапуска.ЧерезВнешнююОбработку = Ложь;
	Возврат ПараметрыЗапуска;
КонецФункции

//.
// Параметры:
//   Параметры - см. НовыеПараметрыВыполненияАлгоритмаВКонтексте - 
