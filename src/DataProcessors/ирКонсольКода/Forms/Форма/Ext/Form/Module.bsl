...
Процедура ПриПовторномОткрытии(СтандартнаяОбработка)
	Если ТипЗнч(мСписокВнешнихПараметров) = Тип("СписокЗначений") Тогда
		...
		Иначе
			ирОбщий.СообщитьЛкс("Не найдены нужные параметры в связанной консоли кода: " + ирОбщий.СтрСоединитьЛкс(ирОбщий.ВыгрузитьСвойствоЛкс(мСписокВнешнихПараметров, "Представление")));
		КонецЕсли;
	КонецЕсли;
КонецПроцедуры
