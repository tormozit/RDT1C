...
Процедура ПараметрыВыбор(Элемент, ВыбраннаяСтрока, Колонка, СтандартнаяОбработка)
	...
	Тогда
		...
		Тогда
			ирКлиент.ОткрытьТаблицуЗначенийЛкс(ВыбраннаяСтрока.Значение.Таблица, ВыбраннаяСтрока.Значение.Таблица.Найти(ПолеТекстаАлгоритма.ПолеТекста.ДвухмерноеВыделение().НачальнаяСтрока, "НомерСтроки"), Ложь,
