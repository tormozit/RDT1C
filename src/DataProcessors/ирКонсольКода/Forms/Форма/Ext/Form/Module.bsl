...
Функция ВычислитьВыражение(ТекущееВыражение = "", УспехЗначения = Истина, ДляПодсказки = Истина) Экспорт 
	...
	АлгоритмВычисления = "";
	Для Каждого СтрокаПараметра Из Параметры Цикл
		СтруктураПараметров.Вставить(СтрокаПараметра.Имя, ЗначениеВСтрокуВнутр(СтрокаПараметра.Значение));
		АлгоритмВычисления = АлгоритмВычисления + СтрокаПараметра.Имя + " = ЗначениеИзСтрокиВнутр(_АлгоритмОбъект." + СтрокаПараметра.Имя + ");" + Символы.ПС;
	КонецЦикла;
