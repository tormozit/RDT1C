...
Процедура ВыбранСпособВыполнения(Кнопка = Неопределено)
	...
	ПолеТекстаАлгоритма.мФлагиКомпиляции = мПлатформа.НовыеФлагиКомпиляции(Не ЛиКонтекстКлиент(), КонтекстВыполнения = "КлиентТолстый" Или КонтекстВыполнения = "ФормаТолстый",
