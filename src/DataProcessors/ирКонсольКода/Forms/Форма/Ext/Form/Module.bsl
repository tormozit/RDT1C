...
Процедура КоманднаяПанельВстроенныйЯзыкВОднострочныйВид(Кнопка)
	...
	КонецЦикла;
	ВыходнойТекст = ""
		+              Отступ + "_РежимОтладки = Ложь;"
		+ Символы.ПС + Отступ + "Если _РежимОтладки Тогда // Можно менять на Истина в точке останова"
		...
		+ Символы.ПС + Отступ + "Иначе"
		+ Символы.ПС + Отступ + КомментарийОднострочногоВида() 
		+ Символы.ПС + Отступ + ОднострочныйТекст.Закрыть()
