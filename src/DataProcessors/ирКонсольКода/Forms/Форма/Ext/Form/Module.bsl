	...
	Для Каждого СтрокаПараметра Из Параметры Цикл
		Если СтрокаПараметра.Выход Тогда
			...
			Если РазрешитьДесериализацию И КонтекстВыполнения <> "Клиент" И СтрокаПараметра.Значение <> Неопределено Тогда
				СтрокаПараметра.Значение = ирОбщий.ЗначениеИзСтрокиВнутрЛкс(СтрокаПараметра.Значение);
			КонецЕсли; 
		КонецЕсли; 
		ОбновитьПредставлениеИТипЗначенияВСтроке(СтрокаПараметра);
	КонецЦикла;
	...
	Для Каждого СтрокаПараметра Из Параметры Цикл
		...
		Если СтрокаПараметра.Вход Тогда 
			...
			Если КонтекстВыполнения <> "Клиент" Тогда
				ВыражениеЧтенияЗначения = "ирОбщий.ЗначениеИзСтрокиВнутрЛкс(" + ВыражениеЧтенияЗначения + ")";
			КонецЕсли; 
	...
	Если КонтекстВыполнения <> "Клиент" Тогда
		...
		Для Каждого СтрокаПараметра Из Параметры Цикл
			Если СтрокаПараметра.Выход Тогда
				...
				ТекстВыхода = ТекстВыхода + "
				|		Если _АлгоритмОбъект." + СтрокаПараметра.Имя + " <> Неопределено И ирОбщий.ЗначениеИзСтрокиВнутрЛкс(ЗначениеВСтрокуВнутр(_АлгоритмОбъект." + СтрокаПараметра.Имя + ")) = Неопределено Тогда
				|			_АлгоритмОбъект." + СтрокаПараметра.Имя + " = Неопределено;
