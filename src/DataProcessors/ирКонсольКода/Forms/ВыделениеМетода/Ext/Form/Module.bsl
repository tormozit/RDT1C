...
Процедура ПриОткрытии()
	...
	ЭлементыФормы.ТаблицаПараметров.Колонки.Модуль.Видимость = ТаблицаПараметров.Найти(Истина, "Модуль") <> Неопределено;
...
ирКлиент.ИнициироватьФормуЛкс(ЭтаФорма, "Обработка.ирКонсольКода.Форма.ВыделениеМетода");
