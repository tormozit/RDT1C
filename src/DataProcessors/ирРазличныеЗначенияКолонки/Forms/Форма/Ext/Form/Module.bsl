...
Функция ОбновитьДанные(РежимОтладки = Ложь, ИзменятьФлагУчитыватьОтбор = Ложь)
	...
	Тогда
		...
		ирОбщий.НайтиДобавитьЭлементНастроекКомпоновкиПоПолюЛкс(НастройкаКомпоновки.Выбор, ИмяПоляКоличества + ".ПроцентВГруппе");
		...
		ТаблицаРезультата.Колонки[ИмяПоляКоличества + "ПроцентВГруппе"].Имя = "Вес";
