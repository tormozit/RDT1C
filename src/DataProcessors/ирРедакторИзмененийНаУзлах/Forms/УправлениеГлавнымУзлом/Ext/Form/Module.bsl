...
Процедура ОтключитьсяОтГлавногоУзлаНажатие(Элемент)
	...
	Если УстановитьВНовыйГлавныйУзел Тогда
		ирОбщий.ИнтерактивноЗаписатьВПолеВводаЛкс(ЭлементыФормы.НовыйГлавныйУзел, ТекущийГлавныйУзел);
	КонецЕсли; 
...
ирОбщий.ИнициироватьФормуЛкс(ЭтаФорма, "Обработка.ирРедакторИзмененийНаУзлах.Форма.УправлениеГлавнымУзлом");
