...
Функция СохраняемаяНастройкаФормы(выхНаименование, выхИменаСвойств) Экспорт 
	...
	Возврат Новый Структура("ПометкиУзлов", мПометкиУзлов);
КонецФункции
...
Процедура ПриОткрытии()
	...
	ПометкиУзлов = ирОбщий.ВосстановитьЗначениеЛкс("ирРедакторИзмененийНаУзлах.ПометкиУзлов");
	...
	Для Каждого лИмяПланаОбмена Из мИменаПлановОбмена Цикл
		...
		Пока ВыборкаУзлов.Следующий() Цикл
			...
			Если СтрокаПометки <> Неопределено Тогда
				СтрокаУзла.Пометка = СтрокаПометки.Пометка;
			КонецЕсли;
