...
Процедура ДействияФормыЗаполнитьТаблицу(Кнопка = Неопределено, РазрешитьАсинхронно = Истина)
	...
	ирОбщий.ВыполнитьЗаданиеФормыЛкс("ЗаполнитьТаблицуКолонок", ПараметрыЗадания, ЭтаФорма,,,
		ЭлементыФормы.ДействияФормы.Кнопки.ЗаполнитьТаблицу, "ЗаполнитьТаблицуКолонокЗавершение", РазрешитьАсинхронно И КлючУникальности = Неопределено И КолонкиБД.Количество() = 0,, Истина);
КонецПроцедуры
