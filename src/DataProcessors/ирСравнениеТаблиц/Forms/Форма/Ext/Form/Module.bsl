...
Процедура ОткрытьТаблицуИсточника(Знач НомерСтроны, Знач НомерСтроки = Неопределено)
	...
	КонецЕсли;
	КопияСсылкиТаблицы = ирОбщий.ОткрытьТаблицуЗначенийЛкс(КопияСсылкиТаблицы, ТекущаяСтрока, Истина, "Таблица " + НомерСтроны,, Ложь);
...
Процедура ДействияФормыСравнитьЧерезТабличныеДокументы(Кнопка)
	...
	ирОбщий.Сравнить2ЗначенияВФормеЛкс(СравниваемыйДокумент1, СравниваемыйДокумент2,, "Таблица 1", "Таблица 2");
