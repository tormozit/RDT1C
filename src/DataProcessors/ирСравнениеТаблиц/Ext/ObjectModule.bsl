...
Процедура ОбновитьСопоставлениеКолонок() Экспорт 
	...
	Для Каждого Колонка Из Таблица2.Колонки Цикл
		Если ирОбщий.ОбъектВСтрокуXMLЛкс(Таблица2[0][Колонка.Имя],,, Ложь) = Неопределено Тогда
	...
	Для Каждого Колонка Из Таблица1.Колонки Цикл
		Если ирОбщий.ОбъектВСтрокуXMLЛкс(Таблица1[0][Колонка.Имя],,, Ложь) = Неопределено Тогда
