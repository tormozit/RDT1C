...
Процедура ОбновитьСопоставлениеКолонок() Экспорт 
	...
	Для Каждого Колонка Из Таблица2.Колонки Цикл
		...
		КонецЕсли; 
		СопоставлениеКолонки.ОписаниеТипов = ирОбщий.РасширенноеПредставлениеЗначенияЛкс(Колонка.ТипЗначения);
	КонецЦикла;
...
Процедура СопоставитьКолонку(Знач СтрокаСопоставления, Знач Колонка = Неопределено) Экспорт 
	...
	Если Колонка <> Неопределено Тогда
		...
		СтрокаСопоставления.ОписаниеТипов2 = ирОбщий.РасширенноеПредставлениеЗначенияЛкс(Колонка.ТипЗначения);
	Иначе
