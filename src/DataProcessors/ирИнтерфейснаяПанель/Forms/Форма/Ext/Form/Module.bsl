...
Процедура КомандыПанелиВыгрузитьМетаданные(Кнопка)
	...
	Если Не ЗначениеЗаполнено(ТекстСпискаОбъектов) Тогда
		...
		Возврат;
	КонецЕсли;
	КаталогГита = ирКлиент.ГитРепозиторий() + ирОбщий.РазделительПутиКФайлуЛкс() + "src";
	КаталогВыгрузкиКонфигурации = ирКлиент.ВыбратьКаталогВФормеЛкс(КаталогГита,, "Укажите каталог куда выгружать файлы метаданных");
...
Процедура КомандыПанелиЗагрузитьМетаданные(Кнопка)
	ТекстовыйДокумент = Новый ТекстовыйДокумент;
	КаталогГита = ирКлиент.ГитРепозиторий() + ирОбщий.РазделительПутиКФайлуЛкс() + "src";
	КаталогВыгрузкиКонфигурации = ирКлиент.ВыбратьКаталогВФормеЛкс(КаталогГита,, "Укажите каталог откуда загружать файлы метаданных");
	Если Не ЗначениеЗаполнено(КаталогВыгрузкиКонфигурации) Тогда 
		Возврат;
	КонецЕсли;
