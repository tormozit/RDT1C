...
//   ИспользоватьПолноеИмя -  - 
//   ЕстьДоступ -  - 
//   КоллекцияМД -  - 
//   Представление -  - 
Процедура ДобавитьВетвьМетаданных(Знач ИмяЕдинственное, Знач ИндексКартинкиВетви = 0, Знач ИндексКартинкаОбъекта = 0, Знач ИспользоватьПолноеИмя = Ложь, Знач ЕстьДоступ = Истина, 
