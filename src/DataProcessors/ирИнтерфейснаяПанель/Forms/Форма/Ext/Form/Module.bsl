...
Процедура СгенерироватьКомандыКонтекстногоМенюПоСтроке(Знач ТабличноеПоле, Знач ТекущаяСтрока)
	...
	ИначеЕсли ЗначениеЗаполнено(ВидОбъекта) И ЗначениеЗаполнено(ИмяОбъекта) Тогда
		...
		Если ОбъектМД.Макеты.Количество() Тогда
...
Процедура СохранитьНастройки() Экспорт
	...
	мНастройкиФормы.СтатистикаИспользования = КопияСтатистики; // Восстановим кэш поиска
...
Функция НайтиСсылкиВМетаданных(ОбъектМД)
	...
	//ирОбщий.НайтиОбъектыМетаданныхРекурсивноЛкс(, ОбъектМД, СсылкиНаОбъект);
	//Форма = ирКлиент.ОткрытьТаблицуЗначенийЛкс(Результат,,, "Ссылки на " + ОбъектМД.ПолноеИмя());
	//
	...
	#КонецЕсли
	ирОбщий.НайтиОбъектыМетаданныхРекурсивноЛкс(, ОбъектМД, НовыйОбъект.СсылкиНаОбъект);
...
Процедура ОбновитьПредставлениеБуфераОбмена() 
	...
	ЗначениеИзБуфера = ирКлиент.ЗначениеИзБуфераОбменаЛкс();
	ЭтаФорма.БуферОбмена = ирОбщий.РасширенноеПредставлениеЗначенияЛкс(ЗначениеИзБуфера) + " : " + ТипЗнч(ЗначениеИзБуфера);
...
Процедура ГлавнаяКоманднаяПанельВыгрузитьБД(Кнопка)
	...
	ИсполняемыйФайл = ирОбщий.ИсполняемыйФайлАвтономногоСервераЛкс(, Истина);
	...
	ирОбщий.ВыполнитьКомандуАвтоСервераЭтойБазыЛкс(Команда,,, ИсполняемыйФайл.ПолноеИмя, Ложь,,,,, ЭтаФорма);
