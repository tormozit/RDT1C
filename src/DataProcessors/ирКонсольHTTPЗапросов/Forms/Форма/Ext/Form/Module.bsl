...
Процедура ОчиститьОтвет()
	...
	ЭтаФорма.КоличествоСимволовОтвета = 0;
...
Процедура ГруппаКодовСостоянийНачалоВыбора(Элемент, СтандартнаяОбработка)
	...
	ирОбщий.ВыбратьСтрокуТаблицыЗначенийЛкс(мГруппыСостояний, мГруппыСостояний.Найти(КодСостояния, "Код"), Ложь, "Группы состояний");
