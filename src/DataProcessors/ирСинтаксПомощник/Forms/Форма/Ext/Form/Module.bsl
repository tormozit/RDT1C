...
Процедура КоманднаяПанельХтмлСсылкиНаМетод(Кнопка)
	...
	#КонецЕсли
	ПолеТекстаПрограммы.ИнициализироватьНеинтерактивно();
	ФормаВызовов = ПолеТекстаПрограммы.ПолучитьФорму("ПоискВызововМетода",, ирОбщий.ПоследнийФрагментЛкс(ПолноеИмяСвойства));
