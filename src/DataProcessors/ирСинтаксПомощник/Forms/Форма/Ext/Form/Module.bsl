...
Процедура КоманднаяПанельХтмлСписокИзмененийПлатформы(Кнопка)
	...
	ИзмененияПлатформы.Колонки.Добавить("Раздел", Новый ОписаниеТипов("Строка"),, 10);
	ИзмененияПлатформы.Колонки.Добавить("Функциональность", Новый ОписаниеТипов("Строка"),, 20);
	ИзмененияПлатформы.Колонки.Добавить("Версия", Новый ОписаниеТипов("Строка"),, 5);
