...
Функция ЗагрузитьОписаниеМетода(Знач ТипКонтекста, Знач ИмяМетода, Знач ОписаниеХТМЛ, Знач ТипСлова = "Метод", Знач ЯзыкПрограммы = 0, Знач ТаблицаПараметров = Неопределено, Знач РабочийКаталог = "",
	...
	ВхожденияДоступности = ВычислительРегВыражений.НайтиВхождения(ОписаниеХТМЛ);
	ОписаниеДоступности = "";
	...
	ВхожденияВариантов = ВычислительРегВыражений.НайтиВхождения(ОписаниеХТМЛ);
...
Функция ЗагрузитьОписаниеСвойства(Знач СтрокаОписания) Экспорт 
	...
	ВычислительРегВыражений.Pattern = шТегКлючСлабый + ирОбщий.ТекстДляРегВыраженияЛкс(ирОбщий.КодироватьТекстВXMLЛкс(СтрокаОписания.Слово)) + "\s*(\([^<>\)]+\))?" + шКонецТегаКлючСлабый
