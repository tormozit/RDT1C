...
Процедура ДействияФормыСжатьБазуВСУБД(Кнопка)
	...
	Тогда
		ВыделенныеСтроки = ирОбщий.ВыделенныеСтрокиТабличногоПоляЛкс(ЭлементыФормы.БазыКластера);
...
ирОбщий.ИнициироватьФормуЛкс(ЭтаФорма, "Обработка.ирУправлениеСлужбамиСервера1С.Форма.СписокБазКластера");
