...
Процедура ПриОткрытии()
	...
	КонецЕсли; 
	ЭлементыФормы.КП_Список.Кнопки.СброситьНастройкиСписка.Подсказка = ирОбщий.СтрЗаменитьЛкс(ЭлементыФормы.КП_Список.Кнопки.СброситьНастройкиСписка.Подсказка, "777", XMLСтрока(ирОбщий.ПредельноеЧислоВидимыхКолонокДинамСпискаЛкс()));
