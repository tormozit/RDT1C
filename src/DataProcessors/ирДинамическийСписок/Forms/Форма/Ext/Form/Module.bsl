...
Процедура ОбновлениеОтображения()
	...
	//ЧислоНевидимых = ирОбщий.ОтобратьКоллекциюСтруктуройЛкс(ЭлементыФормы.ДинамическийСписок.Колонки, Новый Структура("Видимость", Ложь)).Количество();
	#Если Сервер И Не Сервер Тогда
		Э = ЭлементыФормы.ДинамическийСписок.Колонки[0];
	#КонецЕсли
	ЧислоНевидимых = ирОбщий.ОтобратьКоллекциюУсловиемЛкс(ЭлементыФормы.ДинамическийСписок.Колонки, "Не Э.Видимость ").Количество();
