...
Процедура ВывестиПодключаемыеКомандыБСПНаСервере()
	...
	ПодключаемыеКомандыМой.ПриСозданииНаСервере(ЭтотОбъект, ПараметрыРазмещения);
КонецПроцедуры
...
Процедура ВыполнитьКомандуНаСервере(ПараметрыВыполнения)
	...
	#Если Сервер И Не Сервер Тогда
		ПодключаемыеКомандыМой = ПодключаемыеКоманды;
	#КонецЕсли
	ПодключаемыеКомандыМой.ВыполнитьКоманду(ЭтотОбъект, ПараметрыВыполнения, Элементы.ДинамическийСписок);
КонецПроцедуры
...
Процедура Подключаемый_ВыполнитьКоманду(Команда)
	...
	#КонецЕсли
	ПодключаемыеКомандыКлиентМой.ВыполнитьКоманду(ЭтотОбъект, Команда, Элементы.ДинамическийСписок);
КонецПроцедуры
...
Процедура ВосстановитьВыделеннуюСтрокуОтбора()
	...
	ТаблицаФормы = Элементы.КомпоновщикНастроекПользовательскиеНастройкиОтбор;
	Если Истина
