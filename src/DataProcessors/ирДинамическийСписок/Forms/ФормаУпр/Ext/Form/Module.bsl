...
Процедура ОбновитьПоказательНевидимыхКолонок()
	...
	//ЧислоНевидимых = ирОбщий.ОтобратьКоллекциюСтруктуройЛкс(фОбъект.НастройкиКолонок, Новый Структура("Видимость", Ложь)).Количество();
	ЧислоНевидимых = ирОбщий.ОтобратьКоллекциюУсловиемЛкс(фОбъект.НастройкиКолонок, "Не Э.Видимость ").Количество();
