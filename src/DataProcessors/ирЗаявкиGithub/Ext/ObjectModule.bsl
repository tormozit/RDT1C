...
Функция ДатаПоследнегоКоммита(Знач ПолноеИмяФайла = "") Экспорт
	...
	Если ЗначениеЗаполнено(ПолноеИмяФайла) Тогда
		ИмяФайлаГита = СтрЗаменить(ПолноеИмяФайла, Репозиторий + ирОбщий.РазделительПутиКФайлуЛкс(), "");
...
#Если Клиент Тогда
	Репозиторий = ирКлиент.ГитРепозиторий();
#КонецЕсли
Репозиторий = "SeiOkami/OneS";