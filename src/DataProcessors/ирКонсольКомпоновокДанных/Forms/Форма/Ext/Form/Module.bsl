...
Процедура УстановитьМакетКомпоновкиДанных(Знач МакетКомпоновкиДанных = Неопределено)
	...
	ирОбщий.ОбновитьТекстПослеМаркераЛкс(ЭлементыФормы.КП_МакетКомпоновкиДанных.Кнопки.ИсполняемыеЗапросы.Текст,, "" + МакетКомпоновкиДанных.НаборыДанных.Количество() + ")", " (");
