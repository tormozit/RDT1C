...
Функция ЗагрузитьЗапросыИзФайла(ПриЗапуске, ИмяФайла = "", ЭтоФайлВосстановления = Ложь)
	...
	Попытка
		...
		Если ТипЗнч(ПолученноеЗначение) = Тип("ДеревоЗначений") Тогда
			...
			ирКлиент.УстановитьАвтоматическоеРаскрытиеУзловДереваЛкс(ЭлементыФормы.ДеревоОтчетов);
...
Процедура ПриОткрытии()
	...
	КонецЕсли; 
	Если Не ЛиВКонфигурацииЕстьМеханизмЗаменыЗапросовПустышек() Тогда
...
Процедура ПриПолученииДанныхДоступныхПолей(Элемент, ОформленияСтрок)
	ирКлиент.ПриПолученииДанныхТабличногоПоляКомпоновкиЛкс(ЭтаФорма, Элемент, ОформленияСтрок, ЭлементыФормы.Выбор);
КонецПроцедуры
...
Процедура КП_ЗапросыСхемыЗаменитьЗапросыПустышки(Кнопка)
	...
	ЗаменитьЗапросыПустышки(НоваяСхема);
