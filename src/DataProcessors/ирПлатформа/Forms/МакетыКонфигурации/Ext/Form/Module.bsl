...
Процедура ПрименитьФильтрПоПодстрокеБезСохранения()
	ЭлементОтбора = ЭлементыФормы.МакетыКонфигурации.ОтборСтрок.Имя;
...
ЭлементыФормы.ФильтрПоПодстроке.Данные = "ЭлементыФормы.МакетыКонфигурации.Отбор.Имя.Значение";
