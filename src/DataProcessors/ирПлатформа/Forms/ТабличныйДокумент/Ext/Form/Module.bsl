...
Процедура ПриОткрытии()
	...
	ДопСвойства = ирОбщий.ДопСвойстваЭлементаФормыЛкс(ЭтаФорма, ЭлементыФормы.ПолеТабличногоДокумента);
...
Процедура ОсновныеДействияФормыРедактироватьКопию(Кнопка)
	...
	ирОбщий.ОткрытьЗначениеЛкс(ПолучитьРезультат().ПолучитьОбласть(),,, ирОбщий.ЗаголовокДляКопииОбъектаЛкс(ЭтаФорма), Ложь);
...
Процедура УстановитьВыделятьТекущиеСтроки(Знач НовыйРежим = Истина)
	...
	ирОбщий.ПолеТабличногоДокументаПриАктивизацииОбластиЛкс(ЭтаФорма, ЭлементыФормы.ПолеТабличногоДокумента);
