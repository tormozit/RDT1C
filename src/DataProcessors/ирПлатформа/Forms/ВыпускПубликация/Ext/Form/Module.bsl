...
Процедура ОсновныеДействияФормыВыполнить(Кнопка)
	...
	ВариантыПоставки = Новый Структура("Расширение, Портативный, Конфигурация", "cfe", "zip", "cf");
	Для Каждого КлючИЗначение Из ВариантыПоставки Цикл
		...
		Файл = Новый Файл(КаталогВременныхФайлов() + "ИР " + ВерсияВарианта + "." + КлючИЗначение.Значение);
