...
Функция ИмяТипаИзПредставления(Знач Представление)
	Если Представление = "" Или Найти(Представление, ".") > 0 Тогда
...
// {ОписаниеРегулярногоВыражения.Конец}
	...
	Для Каждого Item Из Результат Цикл
		...
		Если ТипКонтекста = Неопределено Тогда
			...
			Иначе 
				ТипКонтекста = ИмяТипаИзПредставления(ТипКонтекста);
			КонецЕсли;
