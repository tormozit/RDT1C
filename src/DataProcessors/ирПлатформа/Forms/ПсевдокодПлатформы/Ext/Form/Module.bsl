...
Функция ПолучитьФормуНаСервере(ИмяФормы, Параметры, Отказ) Экспорт
	...
	Для Каждого ТаблицаДинамическийСписок Из Элементы Цикл
		Если "ЕстьСохраненнаяНастройкаСписка" Тогда
			//=== ПередЗагрузкойПользовательскихНастроекНаСервере - РасширениеТаблицыФормыДляДинамическогоСписка
			//=== ПриЗагрузкеПользовательскихНастроекНаСервере - РасширениеТаблицыФормыДляДинамическогоСписка
		КонецЕсли;
		//=== ПриОбновленииСоставаПользовательскихНастроекНаСервере - РасширениеТаблицыФормыДляДинамическогоСписка
	КонецЦикла;
	Если "ЕстьПараметрПользовательскиеНастройки" Тогда
		//=== ПередЗагрузкойПользовательскихНастроекНаСервере - РасширениеТаблицыФормыДляДинамическогоСписка
		//=== ПриЗагрузкеПользовательскихНастроекНаСервере - РасширениеТаблицыФормыДляДинамическогоСписка
	КонецЕсли;
