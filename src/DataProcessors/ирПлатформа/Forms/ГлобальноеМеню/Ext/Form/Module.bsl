...
Процедура ОбновитьДоступныеКоманды()
	...
	Если АктивнаяФорма = Неопределено Тогда
		Возврат;
	КонецЕсли; 
	ирОбщий.ОбновитьТекстПослеМаркераЛкс(ЭтаФорма.Заголовок,, ирОбщий.ПервыйФрагментЛкс(АктивнаяФорма.Заголовок, ":"), ": ");
	...
	ТекущийЭлементФормы = ирКлиент.ТекущийЭлементАктивнойФормыЛкс(АктивнаяФорма);
