...
Процедура ОбновитьДоступныеКоманды()
	...
	Тогда 
		ТекущаяКолонка = ирКлиент.ТабличноеПоле_ТекущаяКолонкаЛкс(ТекущийЭлементАктивнойФормы);
	...
	Если Ложь
		Или ЭтоПолеТекста
		Или СтрДлина(ирКлиент.Форма_ЗначениеТекущегоПоляЛкс(АктивнаяФорма)) > 150
	Тогда
	...
	Тогда
		...
		КонецЕсли; 
	КонецЕсли; 
	КлючОсновногоОбъекта = ирКлиент.КлючОсновногоОбъектаФормыЛкс(АктивнаяФорма);
	Если ирКлиент.КлючОсновногоОбъектаФормыЛкс(АктивнаяФорма) <> Неопределено Тогда
		#Если Сервер И Не Сервер Тогда
