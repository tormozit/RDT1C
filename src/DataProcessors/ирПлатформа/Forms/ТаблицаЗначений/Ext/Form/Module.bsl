...
Процедура ПриОткрытии()
	...
	Если Не ЗначениеЗаполнено(НовыйЗаголовок) Тогда 
		...
		КонецЕсли; 
	КонецЕсли;
	ирОбщий.ФормаОбъекта_ОбновитьЗаголовокЛкс(ЭтаФорма, НовыйЗаголовок);
	Если РежимВыбора Тогда
...
Процедура ОсновныеДействияФормыРедактироватьКопию(Кнопка)
	...
	ирОбщий.ОткрытьЗначениеЛкс(ПолучитьРезультат().Скопировать(),,, ирОбщий.ЗаголовокДляКопииОбъектаЛкс(ЭтаФорма), Ложь,, ЭлементыФормы.Коллекция);
