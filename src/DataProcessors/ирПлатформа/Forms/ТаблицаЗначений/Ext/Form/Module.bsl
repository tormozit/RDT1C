...
Процедура УстановитьРедактируемоеЗначение(НовоеЗначение, ТабличноеПоле = Неопределено, ПредлагатьОбъединение = Истина) Экспорт 
	...
	Если ИндексПервойСтроки = 0 Тогда 
		...
		ЭлементыФормы.КоманднаяПанельТаблица.Кнопки.ПодменюТипы.Кнопки.СузитьТипыЗначений.Доступность = Не ЭтоДерево;
		ЭлементыФормы.КоманднаяПанельТаблица.Кнопки.ПодменюТипы.Кнопки.СброситьКвалификаторы.Доступность = Не ЭтоДерево;
...
Процедура ТаблицаПриВыводеСтроки(Элемент, ОформлениеСтроки, ДанныеСтроки) Экспорт
	...
	ирОбщий.ТабличноеПолеПриВыводеСтрокиЛкс(ЭтаФорма, Элемент, ОформлениеСтроки, ДанныеСтроки, ЭлементыФормы.КоманднаяПанельТаблица.Кнопки.Идентификаторы,,,,,, Истина);
