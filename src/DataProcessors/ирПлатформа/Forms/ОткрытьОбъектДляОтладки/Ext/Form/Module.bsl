...
Процедура НадписьКакСохранитьНажатие(Элемент)
	...
	ирКлиент.ОткрытьПанельИнструментовЛкс(Истина, Истина, "КаталогОбъектовДляОтладки");
...
Процедура ПриОткрытии()
	...
	ДоступенСписокХранения = Метаданные.Справочники.Найти("ирОбъектыДляОтладки") <> Неопределено Или ЗначениеЗаполнено(ирОбщий.КаталогОбъектовДляОтладкиЛкс(Истина));
