...
Процедура ФункцииВыбор(Элемент, ВыбраннаяСтрока, Колонка, СтандартнаяОбработка)
	...
	ИначеЕсли Колонка = ЭлементыФормы.Функции.Колонки.Описание Тогда
		ирОбщий.ОткрытьТекстЛкс(ВыбраннаяСтрока.Описание, "Функция " + ВыбраннаяСтрока.Имя, "Обычный", Истина);
	КонецЕсли; 
КонецПроцедуры
...
Процедура ОбновитьОтбор()
	...
	ирОбщий.ТабличноеПолеСДаннымиПоискаУстановитьОтборПоПодстрокеЛкс(ЭтаФорма, ЭлементыФормы.Функции, ПодстрокаПоиска, КолонкиПоиска);
