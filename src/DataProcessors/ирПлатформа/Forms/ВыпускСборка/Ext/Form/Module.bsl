Функция СохраняемаяНастройкаФормы(выхНаименование, выхИменаСвойств) Экспорт 
	выхИменаСвойств = "Форма.Каталог, Форма.ИсполняемыйФайлПлатформы, Форма.ИмяПользователя, Форма.ПарольПользователя, Форма.СтрокаСоединенияБазыПодсистемы, Форма.СобиратьРасширение, Форма.СобиратьПортативный";
КонецФункции
...
Процедура СобратьПортативный()
	...
	КонецЦикла;
	КаталогВерсии = Каталог + "\Портативный\" + Метаданные.Версия;
...
Процедура ОсновныеДействияФормыВыполнить(Кнопка)
	...
	Если СобиратьРасширение Тогда
		СобратьРасширение()
	КонецЕсли;
	Если СобиратьПортативный Тогда
		СобратьПортативный();
	КонецЕсли;
