...
Процедура ОсновныеДействияФормыКнопкаОК(Кнопка = Неопределено)
	...
	Если ПроверитьСоединение() Тогда 
		...
		ирОбщий.СохранитьЗначениеЛкс("ирПараметрыСоединенияСУБД.СобиратьТрассу", СобиратьТрассу);
		ирОбщий.СохранитьЗначениеЛкс("ирПараметрыСоединенияСУБД.ТипСУБД", ТипСУБД);
