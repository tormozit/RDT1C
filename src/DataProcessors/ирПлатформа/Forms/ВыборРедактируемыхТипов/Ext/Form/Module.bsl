...
Процедура КоманднаяПанельТиповУстановитьФлажки(Кнопка)
	...
	ирОбщий.ИзменитьПометкиВыделенныхИлиОтобранныхСтрокЛкс(ЭлементыФормы.РедактируемыеТипы,, Истина);
	
КонецПроцедуры

Процедура КоманднаяПанельТиповСнятьФлажки(Кнопка)
	
	ирОбщий.ИзменитьПометкиВыделенныхИлиОтобранныхСтрокЛкс(ЭлементыФормы.РедактируемыеТипы,, Ложь);
...
Процедура ТаблицаРедактируемыхТиповПометкаПриИзменении(Элемент = Неопределено)
	...
	Если РедактируемыеТипы.Найти(Истина, "Пометка") = Неопределено Тогда
		КоманднаяПанельТиповТолькоВыбранные(, Ложь);
	КонецЕсли;
