...
Процедура СтрокаПоискаПриИзменении(Знач Элемент = Неопределено, Знач АктивизироватьПервуюСтроку = Неопределено, Знач Текст = Неопределено)
	...
	ирКлиент.ПрименитьСтрокуПоискаКТабличномуПолюДереваЛкс(ЭтаФорма, ЭлементыФормы.ДеревоПодсистем, Текст, "Представление, Имя", АктивизироватьПервуюСтроку <> Ложь,, Кнопки, Истина);
