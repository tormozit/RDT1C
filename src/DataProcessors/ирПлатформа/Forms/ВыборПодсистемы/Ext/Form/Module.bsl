...
Функция ПоследниеВыбранныеНажатие(Кнопка) Экспорт
	...
	ирКлиент.ПоследниеВыбранныеНажатиеЛкс(ЭтаФорма, ЭлементыФормы.ДеревоПодсистем, ДеревоПодсистем.Колонки.ПолноеИмя.Имя, Кнопка);
...
Функция РезультатВыбора() Экспорт
	Если МножественныйВыбор Тогда
...
Процедура ОбновитьПредставлениеВыбора() Экспорт
	ЭтаФорма.ПредставлениеВыбора = "Выбрано: " + ирОбщий.РасширенноеПредставлениеЗначенияЛкс(РезультатВыбора());
КонецПроцедуры
