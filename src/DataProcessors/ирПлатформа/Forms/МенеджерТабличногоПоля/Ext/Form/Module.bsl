...
Процедура ОтборЗначениеНачалоВыбора(Элемент, СтандартнаяОбработка)
	...
	Если МенеджерТипаЗначения = Неопределено Тогда 
		Возврат;
	КонецЕсли;
	ФормаВыбораЗначения = ирОбщий.ПолучитьФормуСпискаЛкс(ТипЗнч(ЭлементыФормы.Отбор.ТекущаяСтрока.Значение), СтруктураОтбора, "Обычная", ЭтаФорма, Истина,, ЭлементыФормы.Отбор.ТекущиеДанные.Значение,,
...
Процедура ОсновнаяПанельПриСменеСтраницы(Элемент, ТекущаяСтраница)
	Если ЭлементыФормы.ОсновнаяПанель.ТекущаяСтраница = ЭлементыФормы.ОсновнаяПанель.Страницы.Обработка Тогда
		...
		Если ПолеВыбораКолонки <> НовоеПолеДляОбработки Тогда
			ирОбщий.ИнтерактивноЗаписатьВПолеВводаЛкс(ЭлементыФормы.ПолеВыбораКолонки, НовоеПолеДляОбработки, ЭтаФорма);
		КонецЕсли;
