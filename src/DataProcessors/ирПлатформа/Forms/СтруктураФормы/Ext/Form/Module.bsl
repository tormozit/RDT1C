...
Процедура ПриОткрытии()
	...
	Если ПараметрЭлементФормы <> Неопределено Тогда
		...
		КонецЕсли; 
	КонецЕсли; 
	ирОбщий.ДопСвойстваЭлементаФормыЛкс(ЭтаФорма, ЭлементыФормы.Найденные).МенеджерПоиска = ирОбщий.СоздатьМенеджерПоискаВТабличномПолеЛкс(,,,,, ЭлементыФормы.Дерево.Имя);
...
Процедура ОбновитьОтбор()
	ирОбщий.ТабличноеПолеСДаннымиПоискаУстановитьОтборПоПодстрокеЛкс(ЭтаФорма, ЭлементыФормы.СистемныеСочетанияКлавиш, ПодстрокаПоиска);
КонецПроцедуры
