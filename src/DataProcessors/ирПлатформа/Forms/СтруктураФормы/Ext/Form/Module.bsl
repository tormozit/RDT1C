...
Процедура ПриОткрытии()
	...
	Если ПараметрЭлементФормы <> Неопределено Тогда
		...
		КонецЕсли; 
	КонецЕсли;
	ЭлементыФормы.КоманднаяПанельДерева.Кнопки.Прочее.Кнопки.АнализКонтекстныхВызовов.Доступность = ТипЗнч(Форма) = Тип("УправляемаяФорма");
...
Процедура ЗапроситьСерверныеМетаданные()
	...
	Для Каждого СтрокаДерева Из ирОбщий.ВсеСтрокиДереваЗначенийЛкс(Дерево) Цикл
		Если мСерверныеМетаданныеФормы <> Неопределено Тогда
			Если ТипЗнч(СтрокаДерева.ЭлементФормы) = Тип("УправляемаяФорма") Тогда
...
Процедура ДеревоПриАктивизацииСтроки(Элемент)
	...
	Иначе
		...
		ИначеЕсли мТекущаяСтрока.Тип = Тип("УправляемаяФорма") Тогда
...
Процедура СистемныеСочетанияКлавишПриВыводеСтроки(Элемент, ОформлениеСтроки, ДанныеСтроки)
	ирКлиент.ТабличноеПолеПриВыводеСтрокиЛкс(ЭтаФорма, Элемент, ОформлениеСтроки, ДанныеСтроки);
КонецПроцедуры
