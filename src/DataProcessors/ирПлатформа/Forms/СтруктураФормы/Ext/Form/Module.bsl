...
Процедура ИндикацияЭлементаФормыСЗаголовком(Знач ТекущаяСтрока, СтруктураСвойств = Неопределено, ИмяСвойстваЗаголовок = "Заголовок")
	...
	Иначе
		//Если ТипЗнч(Форма) = Тип("Форма") Тогда
			Маркер = Лев("===========================================================", СтрДлина(ирОбщий.ЗначениеСвойстваПолучитьБезопасноЛкс(ЭлементФормы, ИмяСвойстваЗаголовок)));
...
Процедура ДеревоПриАктивизацииСтроки(Элемент)
	...
	Если ТипЗнч(Форма) = Тип("Форма") Тогда
		...
		КонецЦикла;
		Если Ложь
			Или мТекущаяСтрока.Тип = Тип("КнопкаКоманднойПанели") 
			Или мТекущаяСтрока.Тип = Тип("Кнопка")
		Тогда
			СтрокаОбработчика = ОбработчикиСобытий.Добавить();
	...
	Иначе
		Если Истина
			И мТекущаяСтрока.Тип = Тип("КнопкаФормы") 
