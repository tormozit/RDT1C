...
Процедура ЗапроситьСерверныеМетаданные()
	...
	Если ТипЗнч(Форма) = ирОбщий.ТипУправляемаяФормаЛкс() Тогда
		мСерверныеМетаданныеФормы = ирОбщий.УправляемаяФормаБСП_ВыполнитьНаСервереЛкс(Форма, "ирОбщий.УправляемаяФормаБСП_СерверныеМетаданныеЛкс"); // см. ирОбщий.УправляемаяФормаБСП_СерверныеМетаданныеЛкс
