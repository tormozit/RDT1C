...
Процедура ОтобратьСтроки(Знач НовоеИспользованиеОтбора = Неопределено)
	...
	ирКлиент.ТабличноеПолеСОтборомПросмотраОтобратьЛкс(ЭтаФорма, ЭлементыФормы.Таблица,,, НовоеИспользованиеОтбора);
КонецПроцедуры

Процедура КоллекцияИскомаяСтрокаПриИзменении(Элемент)
	ирКлиент.ПолеВводаСИсториейВыбора_ПриИзмененииЛкс(Элемент, ЭтаФорма);
	ОтобратьСтроки(Истина);
КонецПроцедуры
...
Процедура ТаблицаИспользоватьОтборПриИзменении(Элемент)
	ОтобратьСтроки();
КонецПроцедуры
