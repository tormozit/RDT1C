...
Процедура УстановитьРедактируемоеЗначение(НовоеЗначение, РазрешитьПропускНеуникальных = Истина)
	...
	Если НовоеЗначение.ДоступныеЗначения <> Неопределено Тогда
		ЭлементыФормы.Таблица.Колонки.ПредставлениеЗначения.ЭлементУправления.СписокВыбора = НовоеЗначение.ДоступныеЗначения;
		ЭлементыФормы.Таблица.Колонки.ПредставлениеЗначения.ЭлементУправления.РежимВыбораИзСписка = Истина;
	КонецЕсли;
