						...
						Если Не УдалитьМетаТЧ Тогда
							...
							УдалитьМетаТЧ = Ложь
								Или (Истина
									...
									И Не ирОбщий.ЛиСтрокаСодержитВсеПодстрокиЛкс(СтрокаМетаТЧ.Имя + " " + СтрокаМетаТЧ.Представление, СловаПоиска)) 
								Или (Истина
