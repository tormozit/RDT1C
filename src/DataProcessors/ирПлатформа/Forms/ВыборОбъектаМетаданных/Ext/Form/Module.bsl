						...
						Если Не УдалитьМетаТЧ Тогда
							УдалитьМетаТЧ = Ложь
								Или (Истина
									...
									И Не ирОбщий.ЛиСтрокаСодержитВсеПодстрокиЛкс(СтрокаМетаТЧ[ИмяТекущейКолонки], ПодстрокиФильтра)) 
								Или (Истина
