...
Процедура ОбновитьПоиск(ИспользоватьВнешнийТекст = Ложь, СохранитьПозицию = Ложь)
	...
	мПолеТекстаПоиска.РазметитьТекстРезультатамиПоискаИУстановитьВПоле(Текст, РезультатыПоиска,, ПереносСлов);
...
Процедура ПредыдущееВхождениеНажатие(Элемент = Неопределено)
	мПолеТекстаПоиска.ПредыдущееВхождениеНажатие();
КонецПроцедуры

Процедура СледующееВхождениеНажатие(Элемент = Неопределено)
	мПолеТекстаПоиска.СледующееВхождениеНажатие();
КонецПроцедуры
