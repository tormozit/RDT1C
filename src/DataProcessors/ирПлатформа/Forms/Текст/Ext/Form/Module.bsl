...
Процедура ПриОткрытии()
	...
	ЭлементыФормы.ПанельЯзыкЗапросов.Страницы.РедакторHTML.Доступность = ирКэш.ДоступенРедакторМонакоЛкс();
...
Процедура ПредыдущееВхождениеНажатие(Элемент = Неопределено)
	...
	Для Каждого Вхождение Из мПолеТекстаПоиска.РезультатыПоиска Цикл
