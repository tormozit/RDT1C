...
Процедура ПриОткрытии()
	...
	ЭлементыФормы.ОсновныеДействияФормы.Кнопки.ПросмотрДереваJSON.Доступность = ирКэш.ЛиДоступенJSONЛкс();
	ЭлементыФормы.ОсновныеДействияФормы.Кнопки.ФорматироватьJSON.Доступность = ирКэш.ЛиДоступенJSONЛкс();
