...
Функция ИменаСохраняемыхСвойств() Экспорт
	Возврат "АвторегистрацияComКомпонент, ВыделениеРезультатовПоиска, ИспользоватьЭмуляциюНажатияКлавиш, КлючСервисаИИ, КлючСервисаНапарник, СерверИИ, МодельИИ, ПредлагатьОчиститьМенеджерВременныхТаблицЧерезМинут";
КонецФункции
