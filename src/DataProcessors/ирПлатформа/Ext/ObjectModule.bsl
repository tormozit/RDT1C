...
//  *ЖдатьКонца   - Булево -
//
Процедура ОткрытьМодульВнешнейОбработкиВКонфигураторе(Знач ПолноеИмяФайла, Знач НомерСтрокиВМодуле = 0, Знач ИдентификаторПроцесса = 0, Знач ВыполнитьПереход = Ложь, Знач ВнутреннееИмя = "") Экспорт 
