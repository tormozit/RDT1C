...
Процедура ИнициацияОписанияМетодовИСвойств() Экспорт
	...
	ТаблицаКонтекстов = МассивТаблиц.ТаблицаКонтекстов; // ТаблицаЗначений
	//! ТаблицаКонтекстов.Колонки.Добавить("ТипКонтекста");
	//! ТаблицаКонтекстов.Колонки.Добавить("ЯзыкПрограммы");
	//! ТаблицаКонтекстов.Колонки.Добавить("ТипЯзыка");
	//! ТаблицаКонтекстов.Колонки.Добавить("Слово");
	//! ТаблицаКонтекстов.Колонки.Добавить("НСлово");
	//! ТаблицаКонтекстов.Колонки.Добавить("ТипСлова");
	//! ТаблицаКонтекстов.Колонки.Добавить("НомерВерсииПлатформы");
	...
	ТаблицаШаблоновКонтекстов = МассивТаблиц.ТаблицаШаблоновКонтекстов; // ТаблицаЗначений
	//! ТаблицаШаблоновКонтекстов.Колонки.Добавить("ТипКонтекста");
	//! ТаблицаШаблоновКонтекстов.Колонки.Добавить("ЯзыкПрограммы");
	//! ТаблицаШаблоновКонтекстов.Колонки.Добавить("ТипЯзыка");
	//! ТаблицаШаблоновКонтекстов.Колонки.Добавить("Слово");
	//! ТаблицаШаблоновКонтекстов.Колонки.Добавить("НСлово");
	//! ТаблицаШаблоновКонтекстов.Колонки.Добавить("ТипСлова");
	//! ТаблицаШаблоновКонтекстов.Колонки.Добавить("НомерВерсииПлатформы");
	...
	ТаблицаПараметров = МассивТаблиц.ТаблицаПараметров; // ТаблицаЗначений - Теперь на старте пустая  
	//! ТаблицаПараметров.Колонки.Добавить("ТипКонтекста");
	//! ТаблицаПараметров.Колонки.Добавить("ЯзыкПрограммы");
	//! ТаблицаПараметров.Колонки.Добавить("Слово");
...
Процедура ИнициализацияОписанияОбщихТипов() Экспорт
	...
	#КонецЕсли
	//! ТаблицаОбщихТипов.Колонки.Добавить("БазовыйТип");
	//! ТаблицаОбщихТипов.Колонки.Добавить("ЕстьКонструктор");
	//! ТаблицаОбщихТипов.Колонки.Добавить("ТипТипа");
	//! ТаблицаОбщихТипов.Колонки.Добавить("ЯзыкПрограммы");
	//! ТаблицаОбщихТипов.Колонки.Добавить("Слово");
	//! ТаблицаОбщихТипов.Колонки.Добавить("НСлово");
...
Функция ПодготовитьМодульМетаданных(Знач СтруктураТипа, Знач ТипМодуля = "", выхИмяМодуля = "", Знач НовыйТекст = Неопределено, Знач ТекущаяПозиция = Неопределено) Экспорт 
	...
	Если ЗначениеЗаполнено(выхИмяМодуля) Тогда
		...
		КонецЕсли; 
		МодульМетаданных = МодульМетаданныхИзКэша(выхИмяМодуля); // см. МодульМетаданных()
		Если Ложь
