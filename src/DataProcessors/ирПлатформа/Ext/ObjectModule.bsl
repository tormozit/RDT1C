...
Функция ПодключитьСвязанныйКонфигуратор(Знач ИД, Знач ИмяФайлаБуфера, Знач ТранзакцияАктивна = Ложь) Экспорт 
	Если мСвязанныйКонфигуратор = Неопределено Тогда
		мСвязанныйКонфигуратор = Новый Структура("ИД, ИмяФайлаБуфера");
	КонецЕсли;
	мСвязанныйКонфигуратор.ИД = ИД;
	мСвязанныйКонфигуратор.ИмяФайлаБуфера = ИмяФайлаБуфера;
