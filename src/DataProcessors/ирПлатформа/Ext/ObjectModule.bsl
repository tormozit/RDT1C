...
Функция ПодготовитьТипРезультатаМетода(СтрокаОпределения, ИмяИлиМодуль, кэшИскательВозврата = Неопределено, кэшКомпонентаПодсказки = Неопределено, Знач СФактическимиПараметрами = Ложь) Экспорт 
	...
	Тогда
		...
		ТаблицаТипов = ПодготовитьТипЗначенияСловаМодуля(ИмяПеременной, кэшКомпонентаПодсказки, СтрокаОпределения, ИмяИлиМодуль, СтрокаОпределения, СтрокаОпределения.ОписаниеРезультата, ТекстДляПоискаОпределения,
			СФактическимиПараметрами, Истина);
	КонецЕсли;
	Возврат ТаблицаТипов;
...
Функция ПодготовитьТипЗначенияСловаМодуля(Знач ИмяПеременной, кэшКомпонентаПодсказки, Знач МетодМодуля, Знач ИмяИлиМодуль, Знач СтрокаОпределения, Знач ОписаниеТипа = "", Знач ТекстДляПоискаОпределения = "",
	Знач СФактическимиПараметрами = Ложь, Знач ТолькоПрисвоения = Ложь)
	...
	Если СФактическимиПараметрами Тогда
		ТаблицаТипов = кэшКомпонентаПодсказки.ВычислитьТипЗначенияВыражения(ИмяПеременной, ТекстДляПоискаОпределения, ТекстДляПоискаОпределения,,,,, МетодМодуля = Неопределено,, Истина, ТолькоПрисвоения);
	Иначе 
