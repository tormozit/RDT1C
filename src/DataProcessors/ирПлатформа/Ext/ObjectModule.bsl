...
Процедура ПрочитатьОбщиеНастройки() Экспорт
	...
	Если ОбщиеНастройкиГлобализуемые <> Неопределено Тогда
		...
		ЗаполнитьЗначенияСвойств(ЭтотОбъект, ОбщиеНастройкиГлобализуемые);
...
Функция НовыйОбщиеНастройкиГлобализуемые() Экспорт
	...
	ОбщиеНастройки.Вставить("ИспользоватьЭмуляциюНажатияКлавиш", ИспользоватьЭмуляциюНажатияКлавиш);
	ОбщиеНастройки.Вставить("КлючСервисаИИ", КлючСервисаИИ);
	ОбщиеНастройки.Вставить("СерверИИ", СерверИИ);
	ОбщиеНастройки.Вставить("МодельИИ", МодельИИ);
	ОбщиеНастройки.Вставить("МаксОжиданиеИИ", МаксОжиданиеИИ);
	ОбщиеНастройки.Вставить("ЛиЗапросыИИНаСервере", ЛиЗапросыИИНаСервере);
	ОбщиеНастройки.Вставить("ПредлагатьОчиститьМенеджерВременныхТаблицЧерезМинут", ПредлагатьОчиститьМенеджерВременныхТаблицЧерезМинут);
	Возврат ОбщиеНастройки;
КонецФункции
