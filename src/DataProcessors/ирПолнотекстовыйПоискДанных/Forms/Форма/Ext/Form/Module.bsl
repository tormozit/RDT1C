...
Процедура КнопкаДобавитьМетаданныеНажатие(Элемент)
	...
	Форма = ирОбщий.ФормаВыбораОбъектаМетаданныхЛкс(,, СписокМетаданных.ВыгрузитьЗначения(), Истина, Истина, , Истина,,,,,,, Истина);
...
Процедура КП_ТаблицаПорцииСравнить(Кнопка)
	...
	ирОбщий.ЗапомнитьСодержимоеЭлементаФормыДляСравненияЛкс(ЭтаФорма, ЭлементыФормы.ТаблицаПорции);
...
ирОбщий.ИнициироватьФормуЛкс(ЭтаФорма, "Обработка.ирПолнотекстовыйПоискДанных.Форма.Форма");
РазмерПорции = 20;
Нечеткость = 25;
