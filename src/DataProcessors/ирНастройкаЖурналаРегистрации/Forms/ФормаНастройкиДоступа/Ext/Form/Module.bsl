...
Процедура ПостроитьДерево()
	...
	КонецЕсли;
	Если НЕ КоллекцияМетаданныхПуста("ПланыВидовХарактеристик") Тогда
	...
	КонецЕсли;
	Если НЕ КоллекцияМетаданныхПуста("ПланыВидовРасчета") Тогда
	...
	КонецЕсли;
	Если НЕ КоллекцияМетаданныхПуста("РегистрыБухгалтерии") Тогда
...
Функция КоллекцияМетаданныхПуста(ИмяКоллекции)
	...
	Если Модифицированность Тогда
		...
		Для Каждого СтрокаГруппа Из ДеревоМетаданных.Строки Цикл
			Для Каждого СтрокаОбъект Из СтрокаГруппа.Строки Цикл
				Описание = Новый Структура("Объект, ПоляРегистрации");
				Описание.Объект = СтрокаОбъект.ПолноеИмя;
				Если ЛиДоступ Тогда
					Описание.Вставить("ПоляДоступа", ПолучитьМассивПолейДоступаДляСтрокиДерева(СтрокаОбъект));
				КонецЕсли;
