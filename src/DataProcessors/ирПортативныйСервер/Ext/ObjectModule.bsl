...
Процедура ВыполнитьКомандуНаСервере(ИдентификаторКоманды, ПараметрыКоманды) Экспорт
	...
	ИначеЕсли ИдентификаторКоманды = "ВыполнитьАлгоритмЧерезВнешнююОбработкуЛкс" Тогда
		ВыполнитьАлгоритмЧерезВнешнююОбработкуЛкс(ПараметрыКоманды.ИмяФайлаВнешнейОбработки, ПараметрыКоманды.СтруктураПараметров, ПараметрыКоманды.выхВремяНачала, ПараметрыКоманды.ВерсияАлгоритма, 
			ПараметрыКоманды.ЛиСинтаксическийКонтроль);
