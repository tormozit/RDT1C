...
Процедура ИзмененныеМодулиПриАктивизацииСтроки(Элемент = Неопределено)
	...
	Если ЗначениеЗаполнено(Элемент.ТекущаяСтрока.ДатаИзмененияКэша) Тогда
		...
		ТекстИзмененийФайла = ирОбщий.ТекстБезПервогоФрагментаЛкс(мИсторияГита.ТекстИзмененийФайла, "@@");
		Если ЗначениеЗаполнено(ТекстИзмененийФайла) Тогда
			ТекстИзмененийФайла = "@@" + ТекстИзмененийФайла;
		КонецЕсли;
		мИсторияГита.ТекстИзмененийФайла = ТекстИзмененийФайла;
