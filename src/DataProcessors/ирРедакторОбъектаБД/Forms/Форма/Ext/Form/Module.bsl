...
Процедура ОсновныеДействияФормыПоказатьРазличияБД(Кнопка)
	...
	Если ТекстПосле <> Неопределено Тогда
		ирОбщий.Сравнить2ЗначенияВФормеЛкс(ТекстДо, ТекстПосле, , "Старое", "Новое", , Ложь);
	КонецЕсли; 
	...
	КонецЕсли; 
	ирОбщий.Сравнить2ЗначенияВФормеЛкс(СтруктураОбъектаДо.Методы, СтруктураОбъектаПосле.Методы,,,,,, ТекущийРеквизит);
