...
Процедура НаборЗаписейПриВыводеСтроки(Элемент, ОформлениеСтроки, ДанныеСтроки) Экспорт 
	...
	ирОбщий.ПрисвоитьЕслиНеРавноЛкс(Элемент.Подвал, мПодменюТекущаяТаблица.ПоказыватьИтоги.Пометка);
	Если Истина
...
Процедура ОсновныеДействияФормыОткрытьЗагрузкуДанныхВТабличноеПоле(Кнопка)
	...
	КонецЕсли;
	Если ирОбщий.ЗагрузитьДанныеВТабличноеПолеЛкс(ЭтаФорма, ТабличноеПоле, Ложь, МетаданныеКолонок,, ПолучитьОбъект().Данные) Тогда 
