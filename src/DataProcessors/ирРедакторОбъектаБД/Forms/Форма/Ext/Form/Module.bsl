...
Функция СохраняемаяНастройкаФормы(выхНаименование, выхИменаСвойств) Экспорт 
	выхИменаСвойств = "Реквизит.АвтозапускПодсчетаСсылок, Реквизит.АвтозапускПоискаСсылок, Реквизит.ИмяСиноним, Реквизит.КомпоновщикДопПолей, Реквизит.ПорядокРеквизитов, Реквизит.СвязиИПараметрыВыбора, Форма.ВнешняяНавигационнаяСсылка";
...
Процедура ЗагрузитьОбъектПоКлючу(Знач КлючИлиОбъект) Экспорт 
	...
	КонецЕсли; 
	УстановитьТаблицуБД(НовоеИмяОсновнойТаблицы, Истина);
	Если Не ЗначениеЗаполнено(ИмяОсновнойТаблицы) Тогда
		Возврат;
	КонецЕсли; 
...
Процедура НастроитьКолонкиТабличногоПоляДвиженийИлиТЧ(Знач ТабличноеПолеНабораДвиженийИлиТЧ)
	...
	Для Каждого КолонкаТП Из ТабличноеПолеНабораДвиженийИлиТЧ.Колонки Цикл
		Если КолонкаТП.ЭлементУправления <> Неопределено Тогда
			...
			КолонкаТП.ЭлементУправления.УстановитьДействие("АвтоПодборТекста", Новый Действие("ПолеВвода_АвтоПодборТекста"));
