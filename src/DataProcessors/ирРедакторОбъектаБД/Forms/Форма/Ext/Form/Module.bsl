...
Процедура ПриОткрытии()
	...
	ирОбщий.ДопСвойстваЭлементаФормыЛкс(ЭтаФорма, ЭлементыФормы.НаборЗаписей).НеинтерактивноеИзменение = Истина;
...
Процедура НастроитьКолонкиТабличногоПоляДвиженийИлиТЧ(Знач ТабличноеПолеНабораДвиженийИлиТЧ)
	...
	ирОбщий.ДопСвойстваЭлементаФормыЛкс(ЭтаФорма, ТабличноеПолеНабораДвиженийИлиТЧ).НеинтерактивноеИзменение = Истина;
