Функция СохраняемаяНастройкаФормы(выхНаименование, выхИменаСвойств) Экспорт 
	выхИменаСвойств = "Реквизит.ВыгружатьДвиженияВместеСДокументами, Реквизит.ВыполнятьНаСервере, Реквизит.ИмяФайла, Реквизит.ИспользоватьXDTO, Реквизит.ПропускатьОшибки, Реквизит.СопоставлятьПредопределенные, Реквизит.УзелВыборкиДанных, Реквизит.УзелОтправитель, Реквизит.КоличествоПотоков, Реквизит.КоличествоОбъектовВПорции";
