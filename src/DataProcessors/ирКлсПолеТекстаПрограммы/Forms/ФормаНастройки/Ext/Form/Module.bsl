...
Процедура ОсновныеДействияФормыОК(Кнопка = Неопределено)
	...
	ирОбщий.СохранитьЗначениеЛкс("СерверИИ", СерверИИ);
	ирОбщий.СохранитьЗначениеЛкс("МаксОжиданиеИИ", МаксОжиданиеИИ);
	ирОбщий.СохранитьЗначениеЛкс("ЛиЗапросыИИНаСервере", ЛиЗапросыИИНаСервере);
