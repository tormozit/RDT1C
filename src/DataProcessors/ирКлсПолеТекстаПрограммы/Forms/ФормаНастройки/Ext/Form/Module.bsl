...
Процедура ОбновитьПредставлениеСтатистикиВыбора() Экспорт
	ЭтаФорма.СтатистикаВыбора = ирОбщий.РасширенноеПредставлениеЗначенияЛкс(мПлатформа.ТаблицаСтатистикиВыбора);
КонецПроцедуры
...
Процедура СтатистикаВыбораОткрытие(Элемент, СтандартнаяОбработка)
	...
	СохранитьСтатистикуВыбораПодсказки(Истина);
	ирКлиент.ОткрытьТаблицуЗначенийЛкс(мПлатформа.ТаблицаСтатистикиВыбора,, Ложь, "Статистика выбора слов");
КонецПроцедуры
