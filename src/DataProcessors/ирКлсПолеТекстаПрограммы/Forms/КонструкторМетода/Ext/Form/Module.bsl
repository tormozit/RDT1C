...
Процедура ДействияФормыЗаполнитьИИ(Кнопка)
	ПараметрыЗаполнения = ПараметрыЗаполненияИИ();
	Если ПараметрыЗаполнения = Неопределено Тогда
		Возврат;
	КонецЕсли;
	ТекстМодуля = ОбновитьПолноеОпределение(ПараметрыЗаполнения.ЗаменятьТелоМетода);
	ТекстЗапроса = ТекстЗапросаИИДляДокументированияМетода(ТекстМодуля,, ШиринаГенерируемогоТекста, ПараметрыЗаполнения);
	БлокируемыеЭлементы = Новый Массив;
	БлокируемыеЭлементы.Добавить(ЭтаФорма);
	ПараметрыЗадания = Новый Структура;
	ПараметрыЗадания.Вставить("Текст", ТекстЗапроса);
	ПараметрыЗадания.Вставить("ПараметрыЗаполнения", ПараметрыЗаполнения);
	#Если Сервер И Не Сервер Тогда
		ОтправитьЗапросИИ(); 
	#КонецЕсли
	ирОбщий.ВыполнитьЗаданиеФормыЛкс("ОтправитьЗапросИИ", ПараметрыЗадания, ЭтаФорма, "ЗаполнитьИИ",, Кнопка, "ЗаполнитьИИКонец", мПлатформа.ЛиЗапросыИИНаСервере(), БлокируемыеЭлементы);
КонецПроцедуры

Функция ПараметрыЗаполненияИИ() Экспорт
...
// Параметры:
//   СостояниеЗадания -  - 
//   РезультатЗадания - см. ОтправитьЗапросИИ - 
...
Процедура ДействияФормыСоветоватьИИ(Кнопка)
	...
	#Если Сервер И Не Сервер Тогда
		ОтправитьЗапросИИ(); 
	#КонецЕсли
	ирОбщий.ВыполнитьЗаданиеФормыЛкс("ОтправитьЗапросИИ", ПараметрыЗадания, ЭтаФорма, "СоветоватьИИ",, Кнопка, "СоветоватьИИКонец", мПлатформа.ЛиЗапросыИИНаСервере(), БлокируемыеЭлементы);
КонецПроцедуры
...
Процедура ДействияФормыПараметрыИИ(Кнопка)
