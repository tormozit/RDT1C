...
Процедура ОбновитьДанные() Экспорт
	...
	Для Каждого МетодМодуля Из МетодыМодуля Цикл
		ВхожденияВызова = ирОбщий.НайтиРегВыражениеЛкс(МетодМодуля.Тело, ШаблонВызова,,,,,,,,, ВхожденияВызова); // Без подгрупп для ускорения  // TODO перевести на новый механизм получения тела
		#Если Сервер И Не Сервер Тогда
