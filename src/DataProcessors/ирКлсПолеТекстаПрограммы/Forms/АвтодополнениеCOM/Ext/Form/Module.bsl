...
Процедура ТаблицаСловПриАктивизацииСтроки(Элемент)
	...
	ТаблицаСтруктурТипов = УточнитьТипЗначенияВСтрокеТаблицыСлов(СтруктураТипаКонтекста, ТекущаяСтрока, ВернутьСтруктуруТипа);
	Если ТаблицаСтруктурТипов <> Неопределено Тогда
		СтрокаОписания = ТаблицаСтруктурТипов[0].СтрокаОписания;
