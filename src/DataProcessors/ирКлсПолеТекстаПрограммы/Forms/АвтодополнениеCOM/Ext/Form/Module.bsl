...
Процедура ТаблицаСловПриАктивизацииСтроки(Элемент)
	...
	ТаблицаТипов = УточнитьТипЗначенияВСтрокеТаблицыСлов(ТекущаяСтрока, ВернутьСтруктуруТипа);
...
Реквизиты = Метаданные().ТабличныеЧасти.ТаблицаСлов.Реквизиты;
Для Каждого КолонкаРезультата Из Реквизиты Цикл
	Если Ложь
		Или КолонкаРезультата = Реквизиты.ТипЗначения 
		Или КолонкаРезультата = Реквизиты.ТипЗначенияИндекс
	Тогда
