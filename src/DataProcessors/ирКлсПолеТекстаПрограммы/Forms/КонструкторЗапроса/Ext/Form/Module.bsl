...
Процедура ДействияФормыСоветоватьИИ(Кнопка)
	...
	#Если Сервер И Не Сервер Тогда
		ирОбщий.ОтправитьЗапросИИЛкс(); 
	#КонецЕсли
	Результат = ирОбщий.ВыполнитьЗаданиеФормыЛкс("ирОбщий.ОтправитьЗапросИИЛкс", ПараметрыЗадания, ЭтаФорма, "СоветоватьИИ",, Кнопка, "СоветоватьИИКонец", мПлатформа.ЛиЗапросыИИНаСервере());
КонецПроцедуры
