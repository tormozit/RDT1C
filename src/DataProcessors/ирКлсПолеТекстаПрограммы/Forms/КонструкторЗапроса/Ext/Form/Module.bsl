...
Процедура _ТипыДоступнойТаблицыПриВыводеСтроки(Элемент, ОформлениеСтроки, ДанныеСтроки)
	ОформлениеСтроки.Ячейки.Тип.УстановитьКартинку(ирКлиент.КартинкаКорневогоТипаМДЛкс(ДанныеСтроки.Тип));
КонецПроцедуры

Процедура _ТипыДоступнойТаблицыПриАктивизацииСтроки(Элемент = Неопределено)
	Если ЭлементыФормы.ТипыДоступнойТаблицы.ТекущаяСтрока.Тип = "<Все>" Тогда
		ЭлементыФормы.ДоступныеТаблицы.ОтборСтрок.Тип.Использование = Ложь;
	Иначе 
		ЭлементыФормы.ДоступныеТаблицы.ОтборСтрок.Тип.Установить(ЭлементыФормы.ТипыДоступнойТаблицы.ТекущаяСтрока.Тип);
	КонецЕсли;
	ЭлементыФормы.ДоступныеТаблицы.Колонки.Тип.Видимость = Не ЭлементыФормы.ДоступныеТаблицы.ОтборСтрок.Тип.Использование;
КонецПроцедуры
