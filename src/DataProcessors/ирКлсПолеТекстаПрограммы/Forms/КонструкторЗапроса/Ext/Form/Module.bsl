...
Функция ГенерироватьИменаЗапросаИИ(Знач ТекстЗапроса, Знач ИндексыЗапросовПакета) Экспорт
	ТекстПромпта = ТекстЗапросаГенерироватьИменаЗапросаИИ(ТекстЗапроса, ИндексыЗапросовПакета);
	ОтветМоделиСтр = ОтправитьЗапросOpenAI(ТекстПромпта, мПлатформа.КлючСервисаИИ(),, мПлатформа.МодельИИ());
