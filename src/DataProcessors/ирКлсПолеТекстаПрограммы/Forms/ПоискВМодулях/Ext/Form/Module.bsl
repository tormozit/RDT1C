		...
		Если СтрокаОписания <> Неопределено И ТипСлова <> ПеречТипСлова.Свойство Тогда
			...
			Тогда
				...
				//Если Не ЛиТекущийВариантУстановленВручную Тогда
					...
					ЭтаФорма.ТекущийВариант = мПлатформа.ПодобратьВариантСинтаксисаМетодаПоЧислуПараметров(ТаблицаВариантов,, ТекущийВариант, ЛиТекущийВариантУстановленВручную, НомерВарианта);
