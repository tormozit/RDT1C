...
Процедура ПереброситьВведеннуюСтроку()
	...
	Иначе
		...
		//ирОбщий.ПромежуточноеОбновлениеСтроковогоЗначенияПоляВводаЛкс(ЭтаФорма, ЭлементыФормы.ПолеОтбораПоПодстроке, ЭлементыФормы.ЭлементУправленияTextBox.Значение); // Каретка все равно встает в левый край поля
