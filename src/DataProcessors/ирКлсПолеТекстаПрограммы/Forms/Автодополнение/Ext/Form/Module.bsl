...
Процедура ПриОткрытии()
	...
	Если ТипКонтекста = "Строка" И ЗначениеЗаполнено(СтруктураТипаКонтекста.ТипЯзыка) Тогда
		ЭтаФорма.ТипКонтекста = СтруктураТипаКонтекста.ТипЯзыка;
	КонецЕсли;
...
Функция СтруктураТипаСлова(ТекущаяСтрока = Неопределено) Экспорт
	...
	Если ТекущаяСтрока <> Неопределено Тогда
		...
		ТаблицаТипов = УточнитьТипЗначенияВСтрокеТаблицыСлов(СтруктураТипаКонтекста, ТекущаяСтрока, ВернутьСтруктуруТипа, Ложь);
