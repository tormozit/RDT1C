...
Процедура ПослеПрерыванияПроверки()
	...
	Тогда
		ирКлиент.ОткрытьСсылкуВКонфигуратореЛкс("<ВывестиСообщение> Проверка модуля. Ошибок не найдено");
	Иначе
		ирКлиент.ОткрытьСсылкуВКонфигуратореЛкс("<ВывестиСообщение> Проверка модуля. Ошибок найдено " + ОшибкиМодуля.Количество());
	КонецЕсли;
КонецПроцедуры
