...
Процедура ПередОткрытием(Отказ, СтандартнаяОбработка)
	...
	ЭтаФорма.ИспользоватьЭмуляциюНажатияКлавиш = ирКэш.Получить().ИспользоватьЭмуляциюНажатияКлавиш(Истина);
	ЭтаФорма.ВыделениеРезультатовПоиска = ирКэш.Получить().ВыделениеРезультатовПоиска;
...
Процедура ОсновныеДействияФормыСохранитьНастройки(Кнопка = Неопределено)
	...
	ирКэш.Получить().ИспользоватьЭмуляциюНажатияКлавиш = ЭтаФорма.ИспользоватьЭмуляциюНажатияКлавиш;
	ирКэш.Получить().ВыделениеРезультатовПоиска = ЭтаФорма.ВыделениеРезультатовПоиска;
	...
	ирОбщий.СохранитьЗначениеЛкс("ИспользоватьЭмуляциюНажатияКлавиш", ИспользоватьЭмуляциюНажатияКлавиш);
	ирОбщий.СохранитьЗначениеЛкс("ВыделениеРезультатовПоиска", ВыделениеРезультатовПоиска);
...
Процедура КоманднаяПанельСписокОбработокУстановитьФлажки(Кнопка)
	ирОбщий.ИзменитьПометкиВыделенныхИлиОтобранныхСтрокЛкс(ЭтаФорма, ЭлементыФормы.СписокИнструментов, "Видимость", Истина,,, Истина);
КонецПроцедуры

Процедура КоманднаяПанельСписокОбработокСнятьФлажки(Кнопка)
	ирОбщий.ИзменитьПометкиВыделенныхИлиОтобранныхСтрокЛкс(ЭтаФорма, ЭлементыФормы.СписокИнструментов, "Видимость", Ложь,,, Истина);
КонецПроцедуры
...
Процедура СписокИнструментовПриВыводеСтроки(Элемент, ОформлениеСтроки, ДанныеСтроки) Экспорт
	...
	ОформлениеСтроки.Ячейки.Автозапуск.ТолькоПросмотр = ДанныеСтроки.ПолноеИмя = "ирОбщий.ОткрытьОтладчикЛкс";
...
ирОбщий.ИнициироватьФормуЛкс(ЭтаФорма, "Обработка.ирПортативный.Форма.ФормаНастроек");
