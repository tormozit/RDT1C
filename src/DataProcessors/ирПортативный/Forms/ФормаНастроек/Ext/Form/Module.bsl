...
Процедура КоманднаяПанельСписокОбработокУстановитьФлажки(Кнопка)
	ирОбщий.ИзменитьПометкиВыделенныхИлиОтобранныхСтрокЛкс(ЭлементыФормы.СписокИнструментов, "Видимость", Истина);
КонецПроцедуры

// снять флажки
Процедура КоманднаяПанельСписокОбработокСнятьФлажки(Кнопка)
	ирОбщий.ИзменитьПометкиВыделенныхИлиОтобранныхСтрокЛкс(ЭлементыФормы.СписокИнструментов, "Видимость", Ложь);
КонецПроцедуры
