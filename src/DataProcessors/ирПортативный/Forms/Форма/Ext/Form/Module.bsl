...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник) Экспорт
	...
	Если ИмяСобытия = "ИсключениеЕслиВыполненоОбновлениеИР" И ирПортативный = Неопределено Тогда
		ВызватьИсключение "Выполнено обновление ИР";
	КонецЕсли;
	...
	Если ирКэш.ЛиПортативныйРежимЛкс() Тогда
		...
		Если Структура.Ответ Тогда
			...
			Если Ответ = КодВозвратаДиалога.ОК Тогда
				...
				ОтключитьОбработчикОжидания("ПроверитьФормыСсылокОтложенноЛкс");
