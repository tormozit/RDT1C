...
Процедура КоманднаяПанельФормыСравнить(Кнопка)
	...
	ирОбщий.СравнитьСодержимоеЭлементаУправленияЛкс(ЭтаФорма, ЭлементыФормы.РезультатТабДокСвод);
...
Процедура ОформитьТекущиеСтроки()
	ирОбщий.ТабличныйДокументОформитьТекущиеСтрокиЛкс(ЭтаФорма, ЭлементыФормы.РезультатТабДокСвод);
КонецПроцедуры
