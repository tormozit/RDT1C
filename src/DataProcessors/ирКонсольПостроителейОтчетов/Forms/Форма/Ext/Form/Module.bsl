...
Процедура СохранитьИмяФайла()
	...
	ирОбщий.СохранитьЗначениеЛкс("КонсольОтчетов_ИмяФайла", ИмяФайла);
...
Процедура ВосстановитьИмяФайла()
	...
	ИмяФайла = ирОбщий.ВосстановитьЗначениеЛкс("КонсольОтчетов_ИмяФайла");
...
Функция ЗагрузитьЗапросыИзФайла(ПриЗапуске, ОчиститьПередЗагрузкой = Истина, ИмяФайлаДляЧтения = "")
	...
	КонецЕсли;
	Попытка
		ПолученноеЗначение = ирОбщий.ПрочитатьЗначениеИзФайлаСКонтролемПотерьЛкс(ИмяФайлаДляЧтения);
...
Процедура ПриОткрытии()
	...
	ДопСвойства = ирОбщий.ДопСвойстваЭлементаФормыЛкс(ЭтаФорма, ЭлементыФормы.РезультатТабДокСвод);
...
Процедура КоманднаяПанельФормыСравнить(Кнопка)
	...
	ирОбщий.ЗапомнитьСодержимоеЭлементаФормыДляСравненияЛкс(ЭтаФорма, ЭлементыФормы.РезультатТабДокСвод);
...
ирОбщий.ИнициироватьФормуЛкс(ЭтаФорма, "Обработка.ирКонсольПостроителейОтчетов.Форма.Форма");
