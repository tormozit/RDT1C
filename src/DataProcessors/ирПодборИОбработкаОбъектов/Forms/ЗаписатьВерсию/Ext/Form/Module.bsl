...
Процедура вВыполнитьОбработку(Кнопка = Неопределено) Экспорт 
	...
	НастройкаВыполнения.ПользовательИдентификатор = Пользователь.УникальныйИдентификатор;
	НастройкаВыполнения.ПользовательПолноеИмя = Пользователь.ПолноеИмя;
...
мНастройка = Новый Структура("Дата, Комментарий, Узел, ПользовательИдентификатор, ПользовательИмя, ПользовательПолноеИмя");
