...
Процедура ПриОткрытии()
	...
	ЭлементыФормы.КомпоновщикОтбор.Колонки.ПравоеЗначениеДляКраткогоОтображенияЭлемента.ЭлементУправления.УстановитьДействие("НачалоВыбораИзСписка", Новый Действие("ОтборЗначениеНачалоВыбораИзСписка"));
	ЭлементыФормы.КомпоновщикОтбор.Колонки.ПравоеЗначениеДляКраткогоОтображенияЭлемента.ЭлементУправления.УстановитьДействие("ПриИзменении", Новый Действие("ОтборЗначениеПриИзменении"));
...
Процедура КП_ДоступныеПоляПерейтиКОпределению(Кнопка)
	...
	Если ЭлементыФормы.Панель.ТекущаяСтраница <> ЭлементыФормы.Панель.Страницы.НастройкаВыборки  Тогда
		Возврат;
	КонецЕсли; 
	ДоступноеПоле = ЭлементыФормы.КомпоновщикДоступныеПоля.ТекущаяСтрока;
	Если ДоступноеПоле = Неопределено Тогда
		Возврат;
	КонецЕсли; 
...
Процедура СтрокаПоискаДоступныхПолейПриИзменении(Знач Элемент = Неопределено, Знач АктивизироватьПервуюСтроку = Неопределено, Знач Текст = Неопределено)
	...
	ирКлиент.ПрименитьСтрокуПоискаКТабличномуПолюДереваЛкс(ЭтаФорма, ЭлементыФормы.КомпоновщикДоступныеПоля, Текст, "Заголовок", АктивизироватьПервуюСтроку <> Ложь,, Кнопки, Истина);
