...
Функция вВыполнитьОбработку(Кнопка = Неопределено) Экспорт
	...
	Тогда
		Если Не ЗначениеЗаполнено(ИмяФайла) Тогда
			ирОбщий.СообщитьЛкс("Необходимо заполнить имя файла выгрузки");
			Возврат 0;
		КонецЕсли; 
	КонецЕсли;
...
Процедура ИмяФайлаНачалоВыбора(Элемент, СтандартнаяОбработка)
	...
	ПолноеИмяФайла = ирКлиент.ВыбратьФайлЛкс(, "zip",, Элемент.Значение);
...
ирКлиент.ИнициироватьФормуЛкс(ЭтаФорма, "Обработка.ирПодборИОбработкаОбъектов.Форма.ВыгрузкаВФайл");
