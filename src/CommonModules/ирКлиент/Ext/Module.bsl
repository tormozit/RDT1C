...
Процедура ОтправитьЗапросHTTPФоновоЛкс(Знач Браузер, Знач Адрес, Знач ТелоЗапросаСтрока, Знач Заголовки) Экспорт
	...
	КонецЦикла;
	Браузер.sendHttpRequest(Адрес, ТелоЗапросаСтрока, ирОбщий.ОбъектВСтрокуJSONЛкс(ЗаголовкиМассив));
КонецПроцедуры
