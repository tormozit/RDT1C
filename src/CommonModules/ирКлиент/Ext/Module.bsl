...
Функция ПараметрыВыбораОбъектаМетаданныхЛкс(ОтображатьСсылочныеОбъекты = Ложь, ОтображатьВыборочныеТаблицы = Ложь, ОтображатьРегистры = Ложь, ОтображатьПоследовательности = Ложь,
	...
	ОтображатьРегламентныеЗадания = Ложь, ОтображатьСетевыеСервисы = Ложь, ОтображатьРоли = Ложь, ОтображатьПодсистемы = Ложь, ОтображатьВиртуальныеТаблицы = Ложь, ОтображатьОбщиеКоманды = Истина) Экспорт 
...
Процедура ОткрытьНастройкиПоляТекстаПрограммыНаЗаднемПланеЛкс() Экспорт 
	...
	ирОбщий.СообщитьЛкс("Для получения методов и переменных модулей нужно обновить кэш модулей через открывшуюся форму настроек поля текста программы.");
