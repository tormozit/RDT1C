...
функция ОписаниеПоставкиЛкс() Экспорт
	...
	Если ирКэш.ЛиПортативныйРежимЛкс() Тогда
		...
		ОписаниеПоставки.ИспользуемаяВерсия = ОписаниеПоставки.НазваниеВарианта + " " + ирПортативный.мВерсия;
	ИначеЕсли ирКэш.ЛиЭтоРасширениеКонфигурацииЛкс() Тогда 
		...
		КонецЕсли; 
		ОписаниеПоставки.ИспользуемаяВерсия = ОписаниеПоставки.НазваниеВарианта + " " + Метаданные.Подсистемы.ИнструментыРазработчикаTormozit.Комментарий;
	Иначе
