...
Функция ИмяТаблицыИзМетаданныхЛкс(Знач ПолноеИмяМД, ЛиТаблицаИзменений = Ложь, ЛиДвиженияССубконтоДляРегистраБухгалтерии = Истина, ТолькоРазрешенные = Ложь) Экспорт 
