...
Функция СловарьШаблоновХраненияБДЛкс(ЛиИменаБД = Ложь, АдресЧужойСхемыБД = "") Экспорт
	...
	Для Каждого СтрокаРезультата Из Результат Цикл
		...
		Вычислитель = ирОбщий.НовыйВычислительРегВыражений();
...
Функция СобытияПоИмениТипаЭлементаФормыЛкс(Знач ИмяОбщегоТипа) Экспорт 
...
Функция ОткрытыеФормыВсеЛкс() Экспорт 
	
	ирПлатформа = ирКэш.Получить();
	#Если Сервер И Не Сервер Тогда
		ирПлатформа = Обработки.ирПлатформа.Создать();
	#КонецЕсли
	Результат = ирПлатформа.ОткрытыеФормыЧужие;
	Если Результат = Неопределено Тогда
		Результат = Новый Соответствие;
		ирПлатформа.ОткрытыеФормыЧужие = Результат;
	КонецЕсли; 
	Возврат Результат;
...
Функция КодыКлавишЛкс() Экспорт 
	...
	Результат = Новый Соответствие();
	// Порядок модификаторов CTRL+ALT+SHIFT
	Результат.Вставить("ALT+Up", "01318");
	Результат.Вставить("ALT+Down", "01320");
	Результат.Вставить("ALT+F2", "01137");
	Результат.Вставить("ALT+SHIFT+V", "17494");
	Результат.Вставить("CTRL", "00017");
	Результат.Вставить("CTRL+~", "04288"); // CTRL+Ё
	Результат.Вставить("CTRL+A", "04161");
	Результат.Вставить("CTRL+C", "04163");
	Результат.Вставить("CTRL+F", "04166");
	Результат.Вставить("CTRL+G", "04167");
	Результат.Вставить("CTRL+V", "04182");
	Результат.Вставить("CTRL+F3", "04210");
	Результат.Вставить("CTRL+[-]", "02237");
	Результат.Вставить("CTRL+SHIFT+F3", "20594");
	Результат.Вставить("CTRL+SHIFT+Space", "20512");
	Результат.Вставить("CTRL+ALT+Space", "05152");
	Результат.Вставить("CTRL+ALT+G", "05191");
	Результат.Вставить("CTRL+ALT+P", "04114");
	Результат.Вставить("CTRL+Home", "02340");
	Результат.Вставить("CTRL+End", "02339");
	Результат.Вставить("CTRL+Up", "04390");
	Результат.Вставить("CTRL+Down", "04392");
	Результат.Вставить("CTRL+Space", "20512");
	Результат.Вставить("Up", "00294");
	Результат.Вставить("Down", "00296");
	Результат.Вставить("Left", "00293");
	Результат.Вставить("Right", "00295");
	Результат.Вставить("PgDown", "00289");
	Результат.Вставить("PgUp", "00290");
	Результат.Вставить("Home", "00292");
	Результат.Вставить("End", "00291");
	Результат.Вставить("Esc", "00027");
	Результат.Вставить("F2", "00113");
	Результат.Вставить("F3", "00114");
...
Функция ДоступнаСхемаЗапросаЛкс(Знач РасширенныеФункции = Ложь) Экспорт 
