...
Функция СобытияПоИмениОбщегоТипаЛкс(Знач ИмяОбщегоТипа) Экспорт 
...
Функция ПассивнаяФормаПоИмениЛкс(Знач ИмяФормы) Экспорт
	...
	Попытка
		#Если Клиент Тогда 
			...
			КонецЕсли;
			Результат = ирКлиент.ПассивнаяФормаПоИмениЛкс(ИмяФормы);
		#КонецЕсли
	Исключение
...
Функция ПолеТекстаМодуляЛкс(ИмяМодуля) Экспорт
	...
	ПолеТекстаМодуля.УстановитьТекст(,,,,, ИмяМодуля);
...
Функция ПолеТекстаПрограммы(Знач ЯзыкПрограммы = 0, Знач НачалоТекста = "") Экспорт
	Результат = ирКэш.Получить().ПолеТекстаПрограммы(ЯзыкПрограммы, НачалоТекста);
	Возврат Результат;
КонецФункции
