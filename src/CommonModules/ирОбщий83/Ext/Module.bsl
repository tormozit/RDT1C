...
Функция СтрНайтиЛкс(Строка, ПодстрокаПоиска, ЛиПоискСКонца = Ложь, НачальнаяПозиция = Неопределено, НомерВхождения = Неопределено) Экспорт 
	Возврат СтрНайти(Строка, ПодстрокаПоиска, ?(ЛиПоискСКонца, НаправлениеПоиска.СКонца, НаправлениеПоиска.СНачала), НачальнаяПозиция, НомерВхождения) 
КонецФункции
