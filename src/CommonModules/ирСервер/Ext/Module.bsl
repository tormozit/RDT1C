...
//
Функция НайтиПоСсылкамЛкс(МассивСсылок, Знач ИскатьВложенныеДоЧислаСтрок = 0, ТаблицаРезультатов = Неопределено) Экспорт
	...
	Если ЗначениеЗаполнено(ИскатьВложенныеДоЧислаСтрок) Тогда   
		...
		Для Каждого ИскомаяСсылка Из МассивСсылок Цикл
			ТекстСсылки = ирОбщий.ТекстПоискаСсылкиВXMLЛкс(ИскомаяСсылка);
