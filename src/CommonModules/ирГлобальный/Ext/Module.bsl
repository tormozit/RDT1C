							...
							Если Не ВводДоступен Тогда 
								...
								Если Метаданные.Справочники.Количество() > 200 Тогда
									...
									Если СтрокаТипа <> Неопределено Тогда
										ТаблицаТиповМетаобъектов = ирОбщий.БыстрыйМассивЛкс(СтрокаТипа);
									КонецЕсли;
								КонецЕсли;
								Для Каждого СтрокаТипаМетаОбъектов Из ТаблицаТиповМетаобъектов Цикл
									ИндикаторТипа = ирОбщий.ПолучитьИндикаторПроцессаЛкс(Метаданные[СтрокаТипаМетаОбъектов.Множественное].Количество(), "Поиск формы " + СтрокаТипаМетаОбъектов.Единственное);
...
Процедура ЗагрузитьДанныеВТабличноеПолеАктивнойФормыЛкс(Параметры) Экспорт 
	...
	ирОбщий.ЗагрузитьДанныеВТабличноеПолеЛкс(Форма, ТабличноеПоле,,,, Форма);
