...
Функция КлючБазыВСпискеПользователяЛкс() Экспорт 
	...
	Если ирОбщий.ЛиИдентификацияБазыВСпискеПоНаименованиюЛкс() Тогда
		...
		ВычислительРегулярныхВыражений.Pattern = "(?:/IBName\s*""?(.+?))(""| /|$)";
...
Функция НастройкиБазыНаКлиентеЛкс() Экспорт 
	...
	#КонецЕсли
	СтрокаТекущейБазы = ТаблицаБазКлиента.Найти(НРег(ирКэш.КлючБазыВСпискеПользователяЛкс()), "КлючСтроки");
