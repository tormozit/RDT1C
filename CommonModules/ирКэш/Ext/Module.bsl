...
Функция ТаблицаВсехТаблицБДЛкс() Экспорт 
	...
	Если ФоновоеЗадание <> Неопределено Тогда 
		...
		Если ФоновоеЗадание.Состояние = СостояниеФоновогоЗадания.Завершено Тогда 
			ТаблицаВсехТаблицБД = ПолучитьИзВременногоХранилища(СостояниеРасчета.АдресВременногоХранилища);
			УдалитьИзВременногоХранилища(СостояниеРасчета.АдресВременногоХранилища);
		КонецЕсли; 
	КонецЕсли; 
...
Функция СостояниеПодготовкиКэшаЛкс() Экспорт 
	...
	ПараметраЗадания[0] = АдресВременногоХранилища;
