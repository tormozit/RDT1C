...
Функция ЭталонныйНаборЗаписейЛкс(Знач ПолноеИмяТаблицыБД) Экспорт 
	...
	НаборЗаписей = ирОбщий.СоздатьНаборЗаписейПоИмениТаблицыБДЛкс(ПолноеИмяТаблицыБД).Методы;
...
Функция КаталогИзданияПлатформыВПрофиле() Экспорт

	ИДВерсииПлатформы = ирОбщий.ИДВерсииПлатформы();
