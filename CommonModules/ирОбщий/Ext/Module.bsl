...
Функция ОбъектБДПоКлючуЛкс(Знач ИмяОсновнойТаблицы, Знач КлючОбъекта = Неопределено, Знач СохранятьИдентификаторСсылки = Ложь, Знач ЧитатьДанныеРегистраИлиКонстанты = Истина,
	...
	РазрешитьИмитаторы = ОбъектыНаСервере И Не ирКэш.ЛиПортативныйРежимЛкс() И Не ЭтоМетаСсылка И Не ирКэш.Получить().НеИспользоватьИмитаторыОбъектовДанных;
	...
	Если РазрешитьИмитаторы И РазрешитьВложенныйВызов И ЭтоСсылочныйОбъект Тогда
