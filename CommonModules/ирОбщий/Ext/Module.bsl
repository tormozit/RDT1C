...
Функция ПрочитатьДополнительныеПоляСсылающихсяОбъектовЛкс(Знач ТабличноеПоле, Знач КомпоновщикДопПолей, Знач ТаблицаДанных = Неопределено, ИмяПоляСсылки = "Данные") Экспорт 
	...
	СтандартныеРеквизиты.Добавить("Проведен");
	СтандартныеРеквизиты.Добавить("ЭтоГруппа");
	СтандартныеРеквизиты.Добавить("Дата");
	Для Каждого ИмяРеквизита Из СтандартныеРеквизиты Цикл
		...
		КонецЕсли; 
		СтрокаВыбора = СтрокаВыбора + ",
		|	Т.Объект." + ИмяРеквизита + " КАК " + ИмяРеквизита;
	КонецЦикла;
