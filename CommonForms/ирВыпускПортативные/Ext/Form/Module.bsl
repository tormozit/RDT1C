...
Процедура ПриЗакрытии()
	...
	СохранитьЗначение("ирВыпускПортативные.Каталог", Каталог);
	СохранитьЗначение("ирВыпускПортативные.СтрокаСоединенияБазыПодсистемы", СтрокаСоединенияБазыПодсистемы);
...
Процедура ПриОткрытии()
	...
	Подверсия = "1";
	Каталог = ВосстановитьЗначение("ирВыпускПортативные.Каталог");
	СтрокаСоединенияБазыПодсистемы = ВосстановитьЗначение("ирВыпускПортативные.СтрокаСоединенияБазыПодсистемы");
