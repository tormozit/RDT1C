...
Процедура ИскомоеСловоПриИзменении(Элемент = Неопределено)
	...
	ирОбщий.ПолеВводаСИсториейВыбора_ПриИзмененииЛкс(Элемент, "ирСинтаксПомощник");
...
Процедура ИскомоеСловоНачалоВыбораИзСписка(Элемент, СтандартнаяОбработка)
	...
	ирОбщий.ПолеВводаСИсториейВыбора_НачалоВыбораИзСпискаЛкс(Элемент, "ирСинтаксПомощник");
...
Процедура ОбновитьПодходящиеСлова()
	...
	ирОбщий.СкопироватьОтборЛкс(ВременнныйПостроительЗапроса.Отбор, ЭлементыФормы.ТаблицаИндекса.ОтборСтрок, Истина);
