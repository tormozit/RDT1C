...
Процедура ЗагрузитьИндекс(ОпределятьКнигуПоОткрытойСтранице = Ложь) Экспорт
	...
	Если ТекущийФайлИндекса = ФайлИндекса Тогда
		Возврат;
	КонецЕсли;
	лТаблицаИндекса = мПлатформа.ПрочитатьИндексАрхиваСинтаксПомощника(АрхивСинтаксПомощника);
	Если лТаблицаИндекса = Неопределено Тогда
		...
		мПлатформа.ЗаписатьИндексАрхиваСинтаксПомощника(АрхивСинтаксПомощника, лТаблицаИндекса);
	КонецЕсли;
