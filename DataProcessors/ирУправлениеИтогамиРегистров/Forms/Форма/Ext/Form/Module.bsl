...
Процедура ВыполнитьКомандуПользователяВФорме(Команда = "", ПериодИтогов = Неопределено) Экспорт 
	...
	БлокируемыеЭлементы.Добавить(Кнопки.ПодменюИтоги);
	БлокируемыеЭлементы.Добавить(Кнопки.ПодменюТекущиеИтоги);
	БлокируемыеЭлементы.Добавить(Кнопки.ПодменюРазделениеИтогов);
	БлокируемыеЭлементы.Добавить(Кнопки.УстановитьПериодИтогов);
	БлокируемыеЭлементы.Добавить(Кнопки.ПодменюПересчет);
	#Если Сервер И Не Сервер Тогда
	...
	ирОбщий.УправлениеИтогамиРегистров_ВыполнитьКомандуЛкс(ОбщиеПараметрыОбработки(), МоментНачала, РегистрДляОбработки, Команда, ПериодИтогов,,
		ЭтаФорма, ЭлементыФормы.КПТаблицаРегистров.Кнопки.ОбработкаРегистров, "ВыполнитьКомандуЗавершение", БлокируемыеЭлементы);
