...
Процедура ОбработатьИсключениеПоОбъекту(ОбъектБД, ОписаниеОшибки, ВывестиСообщение = Истина, Сообщения = "") Экспорт 
...
Функция ВыполнитьЗагрузку(Параметры) Экспорт 
	...
	Попытка
		...
		#Если Сервер И Не Сервер Тогда
			...
			ЗаписатьОбъект();
		#КонецЕсли
	    СтруктураПотоков = ирОбщий.НоваяСтруктураМногопоточнойОбработкиЛкс("ЗаписатьОбъект", ЭтотОбъект, "ЗагрузитьРезультатЗаписиОбъекта", КоличествоОбъектовВПорции,
...
Процедура ЗагрузитьРезультатЗаписиОбъекта(Знач Результат, Знач ОбъектБД) Экспорт 
	...
	Если Результат.Успех Тогда
		Возврат;
	КонецЕсли; 
	ОбработатьИсключениеПоОбъекту(ОбъектБД, Результат.ОписаниеОшибки,, Результат.Сообщения);
