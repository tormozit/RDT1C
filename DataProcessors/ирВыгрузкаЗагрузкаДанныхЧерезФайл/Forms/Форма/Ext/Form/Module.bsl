Функция СохраняемаяНастройкаФормы(выхНаименование, выхИменаСвойств) Экспорт 
	выхИменаСвойств = "Реквизит.ВыгружатьДвиженияВместеСДокументами, Реквизит.ВыполнятьНаСервере, Реквизит.ИмяФайла, Реквизит.ИспользоватьXDTO, Реквизит.ПропускатьОшибки,
	|Реквизит.СопоставлятьПредопределенные, Реквизит.УзелВыборкиДанных, Реквизит.УзелОтправитель";
...
Процедура ДействияФормыВыполнить(Кнопка)
	...
	Если ЭлементыФормы.ПанельОсновная.ТекущаяСтраница = ЭлементыФормы.ПанельОсновная.Страницы.Выгрузка Тогда
		Результат = ирОбщий.ВыгрузкаЗагрузкаДанныхЧерезФайл_ВыполнитьВыгрузкуЛкс(ОбщиеПараметрыОбработки(),, ЭтаФорма);
	Иначе
		ПодключитьОбработчикОжидания("ДобавитьВРезультатыПоследнийПрочитанныйОбъект", 0.1, Истина);
		Результат = ирОбщий.ВыгрузкаЗагрузкаДанныхЧерезФайл_ВыполнитьЗагрузкуЛкс(ОбщиеПараметрыОбработки(),,, ЭтаФорма);
...
Процедура КоманднаяПанельРезультатЗагрузкиОтборБезЗначенияВТекущейКолонке(Кнопка)
	...
	ирОбщий.ТабличноеПолеОтборБезЗначенияВТекущейКолонке_КнопкаЛкс(ЭлементыФормы.РезультатЗагрузки);
...
Процедура РезультатЗагрузкиПриВыводеСтроки(Элемент, ОформлениеСтроки, ДанныеСтроки)
