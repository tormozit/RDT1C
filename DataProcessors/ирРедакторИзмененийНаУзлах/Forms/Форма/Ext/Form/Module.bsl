...
Процедура КоманднаяПанельДереваОбъектовСравнить(Кнопка)
	...
	ирОбщий.СравнитьСодержимоеЭлементаУправленияЛкс(ЭтаФорма, ЭлементыФормы.ДеревоТаблиц);
...
Процедура КоманднаяПанельДереваОбъектовПоказыватьИтоги(Кнопка)
	
	ирОбщий.ТабличноеПолеКнопкаОтображенияИтоговНажатиеЛкс(ЭлементыФормы.ДеревоТаблиц, Кнопка);
	
КонецПроцедуры

Процедура КПУзлыПоказыватьИтоги(Кнопка)
	
	ирОбщий.ТабличноеПолеКнопкаОтображенияИтоговНажатиеЛкс(ЭлементыФормы.Узлы, Кнопка);
