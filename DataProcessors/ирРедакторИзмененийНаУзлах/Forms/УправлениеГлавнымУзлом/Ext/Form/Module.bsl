...
Процедура ПриОткрытии()
	...
	ЭтаФорма.НовыйГлавныйУзел = ВосстановитьЗначение("ирРедакторИзмененийНаУзлах.НовыйГлавныйУзел");
	Если НовыйГлавныйУзел <> Неопределено Тогда
		ЭтаФорма.НовыйПланОбмена = НовыйГлавныйУзел.Метаданные().Представление();
	КонецЕсли;
...
Процедура ПриЗакрытии()
	...
	СохранитьЗначение("ирРедакторИзмененийНаУзлах.НовыйГлавныйУзел", ЭтаФорма.НовыйГлавныйУзел);
