...
Процедура ПередОткрытием(Отказ, СтандартнаяОбработка)
	...
	ИмяФайлаНастроек = БазоваяФорма.ПолучитьПолноеИмяФайлаНастроек();
...
ирОбщий.ИнициализироватьФормуЛкс(ЭтаФорма, "Обработка.ирМобильный.Форма.ФормаНастроек");
БазоваяФорма = ирОбщий.ПолучитьФормуЛкс("Обработка.ирМобильный.Форма.Форма");
