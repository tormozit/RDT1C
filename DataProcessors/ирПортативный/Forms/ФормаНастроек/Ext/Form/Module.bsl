...
Процедура ПередОткрытием(Отказ, СтандартнаяОбработка)
	...
	ЭтаФорма.ПеренаправлениеКлавиатурногоВводаВОбычномПриложении = ирОбщий.ЛиПеренаправлениеКлавиатурногоВводаВОбычномПриложенииЛкс();
...
Процедура ОсновныеДействияФормыСохранитьНастройки(Кнопка = Неопределено)
	...
	ирОбщий.СохранитьЗначениеЛкс("ПеренаправлениеКлавиатурногоВводаВОбычномПриложении", ЭтаФорма.ПеренаправлениеКлавиатурногоВводаВОбычномПриложении);
...
Процедура ПеренаправлениеКлавиатурногоВводаПодробнееНажатие(Элемент)
