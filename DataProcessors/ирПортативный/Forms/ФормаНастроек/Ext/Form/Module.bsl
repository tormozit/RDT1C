...
Процедура ПередОткрытием(Отказ, СтандартнаяОбработка)
	...
	Если Не ЭлементыФормы.ЭмуляцияЗаписиНаСервере.Доступность Тогда
		ЭлементыФормы.НадписьДоступностьЗаписиНаСервере.Заголовок = "Запись на сервере доступна. Эмуляция не требуется.";
	КонецЕсли; 
...
Процедура ПриОткрытии()
	...
	ЭлементыФормы.ЛиНизкоуровневоеПолучениеОписанийОбъектов.Видимость = Не ирКэш.Получить().ЛиИнформаторНедоступен();
