...
Процедура ПередОткрытием(Отказ, СтандартнаяОбработка)
	...
	Если Не ирКэш.ЛиПортативныйРежимЛкс() Тогда
		ЭтаФорма.КаталогОбъектовДляОтладки = ХранилищеОбщихНастроек.Загрузить(ирОбщий.ИмяПродуктаЛкс(), "КаталогОбъектовДляОтладки");
	КонецЕсли; 
...
Процедура ОсновныеДействияФормыСохранитьНастройки(Кнопка = Неопределено)
	...
	ХранилищеОбщихНастроек.Сохранить(ирОбщий.ИмяПродуктаЛкс(), "ЛиНизкоуровневоеПолучениеОписанийОбъектов", ЭтаФорма.ЛиНизкоуровневоеПолучениеОписанийОбъектов);
	ирКэш.Получить().АвторегистрацияComКомпонент = ЭтаФорма.АвторегистрацияComКомпонент;
	ХранилищеОбщихНастроек.Сохранить(ирОбщий.ИмяПродуктаЛкс(), "АвторегистрацияComКомпонент", ЭтаФорма.АвторегистрацияComКомпонент);
	Если Не ирКэш.ЛиПортативныйРежимЛкс() Тогда
		ХранилищеОбщихНастроек.Сохранить(ирОбщий.ИмяПродуктаЛкс(), "КаталогОбъектовДляОтладки", ЭтаФорма.КаталогОбъектовДляОтладки);
	КонецЕсли; 
