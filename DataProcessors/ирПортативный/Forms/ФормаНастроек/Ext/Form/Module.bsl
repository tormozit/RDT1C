...
Процедура ПередОткрытием(Отказ, СтандартнаяОбработка)
	...
	ЭтаФорма.НеИспользоватьИмитаторыОбъектовДанных = ирКэш.Получить().НеИспользоватьИмитаторыОбъектовДанных;
...
Процедура ОсновныеДействияФормыСохранитьНастройки(Кнопка = Неопределено)
	...
	ирКэш.Получить().НеИспользоватьИмитаторыОбъектовДанных = ЭтаФорма.НеИспользоватьИмитаторыОбъектовДанных;
	ирОбщий.СохранитьЗначениеЛкс("НеИспользоватьИмитаторыОбъектовДанных", ЭтаФорма.НеИспользоватьИмитаторыОбъектовДанных);
