...
Процедура ПриОткрытии()
	...
	//ЭтаФорма.ПоказыватьИндексы = ХранилищеОбщихНастроек.Загрузить(ирОбщий.ИмяПродуктаЛкс(), "КонструкторЗапроса.ПоказыватьИндексы"); // Много времени уходит на получение структуры БД
	ЗначениеНастройки = ХранилищеОбщихНастроек.Загрузить(ирОбщий.ИмяПродуктаЛкс(), "КонструкторЗапроса.ИерархическийСтильЛогическихВыражений");
...
Процедура ПриЗакрытии()
	...
	//ХранилищеОбщихНастроек.Сохранить(ирОбщий.ИмяПродуктаЛкс(), "КонструкторЗапроса.ПоказыватьИндексы", ПоказыватьИндексы);
	ХранилищеОбщихНастроек.Сохранить(ирОбщий.ИмяПродуктаЛкс(), "КонструкторЗапроса.ИерархическийСтильЛогическихВыражений", ИерархическийСтильЛогическихВыражений);
