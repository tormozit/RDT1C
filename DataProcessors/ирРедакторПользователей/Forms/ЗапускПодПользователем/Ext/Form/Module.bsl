...
Процедура ПриОткрытии()
	...
	ЭлементыФормы.РежимИнтерфейсаТакси.Доступность = Метаданные.РежимСовместимостиИнтерфейса = Метаданные.СвойстваОбъектов.РежимСовместимостиИнтерфейса.Версия8_2РазрешитьТакси;
