...
Процедура ОсновныеДействияФормыОК(Кнопка)
	...
	МассивНастроек = ирОбщий.ПолучитьМассивИзСтрокиСРазделителемЛкс(ИменаНастроекУправляемогоПриложения, ",", Истина);
	МассивСвойств = ирОбщий.ПолучитьМассивИзСтрокиСРазделителемЛкс(ИменаСвойствПользователя, ",", Истина);
		...
		Если ЭлементыФормы.ПанельНастроекУправляемогоПриложения.Доступность Тогда
			...
			Для Каждого ИмяСвойства Из МассивНастроек Цикл
				Если Не ЭтаФорма[ИмяСвойства + "Установить"] Тогда
					Продолжить;
				КонецЕсли; 
				НастройкиКлиентскогоПриложения[ИмяСвойства] = Вычислить(ИмяСвойства + "." + ЭтаФорма[ИмяСвойства + "Значение"]);
	...
	Если ЗначениеЗаполнено(ПараметрИмяПользователя) Тогда
		Если ЭлементыФормы.ПанельНастроекУправляемогоПриложения.Доступность Тогда
			...
			Если НастройкиКлиентскогоПриложения = Неопределено Тогда
				НастройкиКлиентскогоПриложения = Новый НастройкиКлиентскогоПриложения;
			КонецЕсли;
			ЭтаФорма.ВариантМасштабаФормКлиентскогоПриложенияЗначение = НастройкиКлиентскогоПриложения.ВариантМасштабаФормКлиентскогоПриложения;
			ЭтаФорма.ВариантИнтерфейсаКлиентскогоПриложенияЗначение = НастройкиКлиентскогоПриложения.ВариантИнтерфейсаКлиентскогоПриложения;
			...
			ЭтаФорма.РежимОткрытияФормПриложенияЗначение = НастройкиКлиентскогоПриложения.РежимОткрытияФормПриложения;
		КонецЕсли; 
