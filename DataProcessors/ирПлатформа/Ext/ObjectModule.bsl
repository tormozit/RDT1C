			...
			Если ВычислятьТипы Тогда
				...
				Для Каждого ИмяОбщегоТипа Из МассивТиповЗначения Цикл
					...
					ИначеЕсли ИмяОбщегоТипа = "Отбор" Тогда 
						ПараметрыЗаписиОбъектов = ирКэш.ПараметрыЗаписиОбъектовЛкс();
						Если Не ПараметрыЗаписиОбъектов.ОбъектыНаСервере Или ПараметрыЗаписиОбъектов.НеИспользоватьИмитаторыОбъектовДанных Тогда
