...
Функция ПодключитьПерехватКлавиатуры() Экспорт 
	...
	КонецЕсли; 
	Если мПерехватКлавиатуры = Неопределено Тогда
		мПерехватКлавиатуры = ПолучитьОбъектВнешнейКомпонентыИзМакета("ПерехватКлавиатуры", "AddIn.ПерехватКлавиатуры.KeyboardHook", "ПерехватКлавиатуры", ТипВнешнейКомпоненты.Native);
		мПерехватКлавиатуры.ЗахватРазрешен = Истина;
		мПерехватКлавиатуры.СобытиеПриНажатии = Истина;
		мПерехватКлавиатуры.ЗахватПервым = Истина;
	КонецЕсли; 
