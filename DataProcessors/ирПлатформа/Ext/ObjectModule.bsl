...
Функция ИдентификаторПроцессаОтладчика() Экспорт
...
Функция ПортДляПодключенияОтладчика(ИдентификаторПроцессаОтладчика) Экспорт
		
	ИдентификаторПроцесса = ИдентификаторПроцессаОС();
	Команда = "netstat -n -a -o";
	ТекстРезультата = ТекстРезультатаКомандыСистемы(Команда);
	RegExp.Global = Истина;
