...
Процедура ИндикацияТекущегоЭлемента()
	...
	ИначеЕсли ТекущаяСтрока.Тип = Тип("КолонкаТабличногоПоля") Тогда
		...
		ирОбщий.ПрисвоитьЕслиНеРавноЛкс(Форма.ТекущийЭлемент, ЭлементФормыСтрокиДерева(СтрокаДереваТабличногоПоля));
		ЭлементФормы = ЭлементФормыСтрокиДерева(ТекущаяСтрока);
		...
		ирОбщий.ПрисвоитьЕслиНеРавноЛкс(ЭлементФормыСтрокиДерева(СтрокаДереваТабличногоПоля).ТекущаяКолонка, ЭлементФормы);
	ИначеЕсли ТекущаяСтрока.Тип = Тип("СтраницаПанели") Тогда
		...
		Если ТекущаяСтрока.Видимость Тогда
			ирОбщий.ПрисвоитьЕслиНеРавноЛкс(ЭлементФормыСтрокиДерева(СтрокаДереваПанели).ТекущаяСтраница, ЭлементФормыСтрокиДерева(ТекущаяСтрока));
...
Процедура ПоказатьВложенныйЭлементФормы(Знач ТекущаяСтрока)
	...
	Тогда
		ирОбщий.ПрисвоитьЕслиНеРавноЛкс(Форма.ТекущийЭлемент, ЭлементФормыСтрокиДерева(ТекущаяСтрока.Родитель.Родитель));
		ирОбщий.ПрисвоитьЕслиНеРавноЛкс(ЭлементФормыСтрокиДерева(ТекущаяСтрока.Родитель.Родитель).ТекущаяСтраница, ЭлементФормыСтрокиДерева(ТекущаяСтрока.Родитель));
	КонецЕсли;
