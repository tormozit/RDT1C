...
Процедура ПолеВыбораКолонкиПриИзменении(Элемент)
	...
	Иначе
		...
		КолонкиТП = КолонкиТП();
		ЭлементаУправленияЦели = КолонкиТП[СоответствиеКолонокДанным[Элемент.Значение]];
...
Процедура ОтборЗначениеНачалоВыбораИзСписка(Элемент, СтандартнаяОбработка)
	...
	ирОбщий.ПолеВводаСИсториейВыбора_НачалоВыбораИзСпискаЛкс(Элемент, КлючИсторииВыбораЗначенияОтбора());
...
Функция КлючИсторииВыбораЗначенияОтбора()
	
	Результат = ПолноеИмяМД + ".Отбор." + ЭлементыФормы.Отбор.ТекущаяСтрока.Имя;
	Возврат Результат;
...
Процедура ОтборЗначениеПриИзменении(Элемент)
	...
	ирОбщий.ПолеВводаСИсториейВыбора_ПриИзмененииЛкс(Элемент, КлючИсторииВыбораЗначенияОтбора(),,,, ЭлементыФормы.Отбор.ТекущаяСтрока.Значение);
