...
Процедура ОтборЗначениеАвтоПодборТекста(Элемент, Текст, ТекстАвтоПодбора, СтандартнаяОбработка)
	...
	Тогда
		...
		УстановитьЗначениеОтбора(Текст);
	КонецЕсли; 
...
Процедура ОтборЗначениеПриИзменении(Элемент)
	...
	ирОбщий.ПолеВводаСИсториейВыбора_ПриИзмененииЛкс(Элемент, КлючИсторииВыбораЗначенияОтбора(),,, );
	УстановитьЗначениеОтбора(Элемент.Значение);
	
КонецПроцедуры

Процедура УстановитьЗначениеОтбора(Знач НовоеЗначение)
