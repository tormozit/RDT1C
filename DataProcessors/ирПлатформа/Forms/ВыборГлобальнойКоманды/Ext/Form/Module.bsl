Процедура ПриОткрытии()
	...
	Команды.Добавить("РедактироватьОбъектИзТекущейЯчейкиАктивнойФормыЛкс", "Редактировать объект из текущей ЯЧЕЙКИ",, ирКэш.КартинкаИнструментаЛкс("Обработка.ирРедакторОбъектаБД"));
