	...
	Если ТабличноеПоле <> Неопределено Тогда
		...
		Если ТекущаяКолонка <> Неопределено Тогда 
			...
			Если ЗначениеЗаполнено(ДанныеКолонки) Тогда
				...
				НоваяКолонка = ТаблицаКолонок.Найти(ДанныеКолонки, "Имя");
...
Процедура КоманднаяПанельТаблицаГруппировкаТаблицы(Кнопка)
	...
	МассивВыделенныхСтрок = ирОбщий.ВыделенныеСтрокиТабличногоПоляВВизуальномПорядкеЛкс(ЭлементыФормы.ТаблицаКолонок);
