...
Процедура ПриОткрытии()
	...
	КонецЕсли; 
	ЭлементыФормы.ПолеТаблицы.ТолькоПросмотр = ТолькоПросмотр; // Чтобы открытие ссылок из ячеек работало
...
Процедура КоманднаяПанельТаблицаОбработкаОбъектов(Кнопка)
...
Процедура КоманднаяПанельТаблицаСУзитьТипыЗначений(Кнопка)
	...
	КонецЕсли;
	НоваяТаблица = ирОбщий.ПолучитьТаблицуСМинимальнымиТипамиКолонокЛкс(ПолучитьРезультат());
