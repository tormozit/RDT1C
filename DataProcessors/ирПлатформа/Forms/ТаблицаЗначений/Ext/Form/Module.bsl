...
Процедура ПриОткрытии()
	...
	Если ТабличноеПоле <> Неопределено Тогда
		Если ТабличноеПоле.ТекущаяКолонка <> Неопределено Тогда 
			ДанныеКолонки = ирОбщий.ПолучитьПутьКДаннымКолонкиТабличногоПоляЛкс(ТабличноеПоле);
...
Процедура КоманднаяПанельТаблицаВывестиВТабличныйДокумент(Кнопка)
	...
	ирОбщий.ВывестиТабличноеПолеВТабличныйДокументИПоказатьЛкс(ЭлементыФормы.ПолеТаблицы);
