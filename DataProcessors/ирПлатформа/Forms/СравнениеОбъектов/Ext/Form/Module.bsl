...
Функция ОбновитьСоставСвойств()
	...
	Для Каждого СтрокаСвойства Из СвойстваОбъектов Цикл
		...
		Иначе
			СтрокаXML1 = ирОбщий.СохранитьОбъектВВидеСтрокиXMLЛкс(СтрокаСвойства["Значение1"],,, Ложь);
			СтрокаXML2 = ирОбщий.СохранитьОбъектВВидеСтрокиXMLЛкс(СтрокаСвойства["Значение2"],,, Ложь);
			Если Ложь
				Или (Истина
