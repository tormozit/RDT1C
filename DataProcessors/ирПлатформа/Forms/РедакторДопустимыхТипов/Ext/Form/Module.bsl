...
Функция ПолучитьОтобранныеСтрокиТаблицы() Экспорт
	...
	ирОбщий.СкопироватьОтборПостроителяЛкс(ВременнныйПостроительЗапроса.Отбор, ЭлементыФормы.ТаблицаТипов.ОтборСтрок);
...
Процедура ПриОткрытии()
	...
	Для Каждого СтруктураТипа Из ТаблицаСтруктурТипов Цикл
		...
		Если СтрокаДереваТипов = Неопределено Тогда
			МассивФрагментов = ирОбщий.ПолучитьМассивИзСтрокиСРазделителемЛкс(КонкретныйТип);
			ТекущееИмя = "";
...
Процедура ПолеВвода1ПриИзменении(Элемент)
	...
	ирОбщий.ПолеВводаСИсториейВыбора_ПриИзмененииЛкс(Элемент, "РедакторДопустимыхТипов");
...
Процедура ПолеВвода1НачалоВыбораИзСписка(Элемент, СтандартнаяОбработка)
	...
	ирОбщий.ПолеВводаСИсториейВыбора_НачалоВыбораИзСпискаЛкс(Элемент, "РедакторДопустимыхТипов");
