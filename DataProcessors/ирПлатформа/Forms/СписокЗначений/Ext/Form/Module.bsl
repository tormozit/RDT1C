...
Процедура КоманднаяПанель1Подбор(Кнопка)
	...
	КонецЕсли; 
	ирОбщий.ОткрытьПодборСВыборомТипаЛкс(ЭлементыФормы.Таблица, ОписаниеТипов, НачальноеЗначениеВыбораЛ);
...
Процедура КоманднаяПанель1ВТаблицу(Кнопка)
	...
	КонецЦикла;
	ирОбщий.ОткрытьФормуПроизвольногоЗначенияЛкс(ТаблицаЛ,,,, Ложь);
