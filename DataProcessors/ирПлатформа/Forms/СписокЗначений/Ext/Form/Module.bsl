...
Процедура ОбновитьВидимостьКолонок()
	...
	ЭлементыФормы.Таблица.Колонки.Пометка.Видимость = Не ПоказыватьТолькоЗначения;
	ЭлементыФормы.Таблица.Колонки.Представление.Видимость = Не ПоказыватьТолькоЗначения;
