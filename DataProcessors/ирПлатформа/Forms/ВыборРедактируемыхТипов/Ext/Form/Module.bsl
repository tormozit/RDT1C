...
Функция ПолучитьОтобранныеСтрокиТаблицы() Экспорт
	...
	ирОбщий.СкопироватьОтборЛкс(ВременнныйПостроительЗапроса.Отбор, ЭлементыФормы.ТаблицаРедактируемыхТипов.ОтборСтрок, Истина);
...
Процедура ПолеВвода1ПриИзменении(Элемент)
	...
	ирОбщий.ПолеВводаСИсториейВыбора_ПриИзмененииЛкс(Элемент, "ВыборРедактируемыхТипов");
