...
Процедура ОбновитьТаблицу()
	...
	СтрокаКомпоненты.ЗависящаяФункцияПодсистемы = "Форма автодополнения контекстной подсказки при отключенном перенаправлении клавиатурного ввода и форма индекса синтакс-помощника";
