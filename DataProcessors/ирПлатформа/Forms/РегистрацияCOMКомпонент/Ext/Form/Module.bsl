...
Процедура ОбновитьТаблицу()
	...
	СтрокаКомпоненты.ЗависящаяФункцияПодсистемы = "Форма автодополнения контекстной подсказки при отключенном перенаправлении клавиатурного ввода и индекс в форме синтакс-помощника";
	...
	СтрокаКомпоненты.ЗависящаяФункцияПодсистемы = "Режим дерева запроса в консоли запросов, конструктора запросов ИР и шаблоны текста в контекстной подсказке";
