...
Процедура ОбновитьСоставСвойств()
	...
	Для Каждого Колонка Из Колонки Цикл
		ИмяКолонкиДанных = ирОбщий.ПолучитьПутьКДаннымКолонкиТабличногоПоляЛкс(ТабличноеПоле, Колонка);
		...
		Иначе
			...
			СтрокаСвойства.ОписаниеТипов = ирОбщий.ПолучитьТипЗначенияЭлементаФормыЛкс(Колонка);
		КонецЕсли; 
...
Процедура ЗагрузитьДанныеСтроки(УстановитьТекущуюСтроку = Ложь, ПроверитьНеизменностьКолонок = Истина)
	...
	Для Каждого СтрокаСвойства Из СвойстваСтроки Цикл
		...
		Иначе
			СтрокаСвойства.Значение = ТабличноеПоле.ТекущаяСтрока[СтрокаСвойства.Данные];
			КолонкаТабличногоПоля = ТабличноеПоле.Колонки[СтрокаСвойства.Имя];
			Попытка
...
Процедура ДействияФормыТекущаяКолонкаИсточника(Кнопка = Неопределено)
	...
	ТабличноеПоле = КлючУникальности;
	ИмяКолонкиДанных = ирОбщий.ПолучитьПутьКДаннымКолонкиТабличногоПоляЛкс(ТабличноеПоле);
...
Процедура ДействияФормыТекущаяСтрока(Кнопка = Неопределено)
	...
	ТабличноеПоле = КлючУникальности;
	ТекущаяСтрокаИсточника = ТабличноеПоле.ТекущаяСтрока;
