...
Процедура ТаблицаВыбор(Элемент, ВыбраннаяСтрока, Колонка, СтандартнаяОбработка)
	...
	ОбъектМД = Метаданные.НайтиПоПолномуИмени(ВыбраннаяСтрока.Хранение);
	Если ирОбщий.ЛиКорневойТипКонстантыЛкс(ирОбщий.ПолучитьПервыйФрагментЛкс(ВыбраннаяСтрока.Хранение)) Тогда
