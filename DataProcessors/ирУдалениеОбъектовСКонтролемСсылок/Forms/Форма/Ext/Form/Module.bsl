...
Процедура ПриОткрытии()
	...
	Если УдаляемыеОбъекты.Количество() = 0 Тогда
		...
		КонецЕсли;
	КонецЕсли; 
	НастройкиДопПолей = ВосстановитьЗначение("ирУдалениеОбъектовСКонтролемСсылок.ДопПоля");
...
Процедура ПриЗакрытии()
	...
	СохранитьЗначение("ирУдалениеОбъектовСКонтролемСсылок.ДопПоля", КомпоновщикДопПолей.ПолучитьНастройки());
