...
Процедура ОсновныеДействияФормыЗагрузить(Кнопка)
	...
	КонецЕсли; 
	ОчиститьСообщения();
	РезультатОбработки = ирОбщий.ирЗагрузкаТабличныхДанных_ЗагрузитьЛкс(ОбщиеПараметрыОбработки(), Истина,, ЭтаФорма);
...
Процедура КоманднаяПанельТаблицаБДЗагрузитьБезЗаписи(Кнопка)
	...
	ОчиститьСообщения();
	РезультатОбработки = ирОбщий.ирЗагрузкаТабличныхДанных_ЗагрузитьЛкс(ОбщиеПараметрыОбработки(), Ложь,, ЭтаФорма);
	Если РезультатОбработки = Неопределено Тогда
		Возврат;
	КонецЕсли; 
	ЗаполнитьЗначенияСвойств(ЭтаФорма, РезультатОбработки); 
