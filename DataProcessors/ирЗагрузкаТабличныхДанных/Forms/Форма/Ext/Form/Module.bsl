...
Процедура ЗапуститьЗагрузку(Знач Кнопка, Знач Записывать)
	...
	Если Записывать И Кнопка.Картинка <> ирКэш.КартинкаПоИмениЛкс("ирОстановить") Тогда
		РеквизитыОбработки = РеквизитыОбработки();
		КоличествоСтрокДляОбработки = РеквизитыОбработки.ТаблицаЗначенийОтобранное.Количество();
	...
	#КонецЕсли
	ирОбщий.ВыполнитьЗаданиеФормыЛкс("ЗагрузитьВТаблицуБДИзТаблицыЗначений", ПараметрыЗадания, ЭтаФорма, "ЗагрузкаДанных",,
		Кнопка, "ЗагрузитьДанныеЗавершение",, БлокируемыеЭлементыФормы, Истина);
