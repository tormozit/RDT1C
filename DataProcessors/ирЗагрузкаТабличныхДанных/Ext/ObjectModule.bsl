...
//  массив частей даты
//
Функция ПолучитьЧастиПредставленияДаты(Знач Представление, выхПозицияГода = Неопределено)
...
Функция мПривестиКДате(Представление, ОписаниеТипов = Неопределено, Примечание = "", АмериканскоеПоложениеМесяца = Ложь) Экспорт 
	...
	Если Результат = '00010101' Тогда
		...
		МассивЧастей = ПолучитьЧастиПредставленияДаты(Представление, ПозицияГода);
