...
Функция ПерейтиКОпределению(Знач НомерСтроки = 0, Знач НомерКолонки = 0) Экспорт 
	...
	Если Лев(ТекущееВыражение, 1) = "&" Тогда
		УспехВычисления = Неопределено;
		ЗначениеПараметра = ВычислитьПараметр(ТекущееВыражение, УспехВычисления);
...
Функция ВычислитьПараметр(Знач ТекущееВыражение, УспехВычисления = Истина)
	...
	Если СтрокаПараметра <> Неопределено Тогда
		...
		Если СтрокаПараметра.ЭтоВыражение = Истина Тогда
			Попытка 
				ЗначениеПараметра = Вычислить(СтрокаПараметра.Значение);
	...
	Если Событие <> Неопределено Тогда
		...
		ИначеЕсли Событие.event = "EVENT_ON_LINK_CLICK" Тогда
			...
			ИначеЕсли Событие.params.label = "Знач" Тогда
				ирОбщий.ОткрытьЗначениеЛкс(ВычислитьПараметр(Событие.params.href));
			ИначеЕсли Ложь
		...
		ИначеЕсли Событие.event = "EVENT_BEFORE_HOVER" Тогда
			...
			Если Лев(ОбъектноеВыражение, 1) = "&" Тогда
				УспехЗначения = Ложь;
				ЗначениеВыражения = ВычислитьПараметр(ОбъектноеВыражение, УспехЗначения);
