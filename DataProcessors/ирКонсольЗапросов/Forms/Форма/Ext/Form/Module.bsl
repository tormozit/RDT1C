...
Процедура МенюДереваЗапросаВыполнитьВсеПодзапросы(Кнопка)
	...
	Тогда
		...
		КонецЕсли;
	КонецЕсли; 
	Количество = ВсеСтрокиДерева.Количество();
...
Процедура СвойстваСтрокиРезультатаПриВыводеСтроки(Элемент, ОформлениеСтроки, ДанныеСтроки)
	...
	Иначе
		ЗначениеЯчейки = ДанныеСтроки.ТипЗначения.ПривестиЗначение();
		ТекстЯчейки = Формат(ЗначениеЯчейки, ФорматнаяСтрока);
		ЯчейкиЗначения.УстановитьТекст(ТекстЯчейки);
		ирОбщий.ТабличноеПолеПриВыводеСтрокиЛкс(Элемент, ОформлениеСтроки, ДанныеСтроки,
...
Процедура СтрокаПоискаПриИзменении(Элемент)
	...
	ирОбщий.ПолеВводаСИсториейВыбора_ПриИзмененииЛкс(Элемент, Метаданные().Имя);
	ирОбщий.ПрименитьСтрокуПоискаКТабличномуПолюДереваЛкс(ЭлементыФормы.ДеревоЗапросов, СтрокаПоискаВДереве, "ТекстЗапроса, Запрос", мСтруктураПоискаВДеревеЗапроса);
...
Процедура ВпередНажатие(Элемент)
	...
	ирОбщий.СледующееВхождениеСтрокиПоискаВТабличномПолеДереваЛкс(ЭлементыФормы.ДеревоЗапросов, мСтруктураПоискаВДеревеЗапроса);
	
КонецПроцедуры

Процедура НазадНажатие(Элемент)
	
	ирОбщий.ПредыдущееВхождениеСтрокиПоискаВТабличномПолеДереваЛкс(ЭлементыФормы.ДеревоЗапросов, мСтруктураПоискаВДеревеЗапроса);
