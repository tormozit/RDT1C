...
Перем мНеинтерактивныйРежим Экспорт;
...
Процедура ПриЗакрытии()
	...
	Если мНеинтерактивныйРежим <> Истина Тогда
...
Процедура КоманднаяПанельКоллекцияОткрытьТаблицу(Кнопка)
	...
	ирОбщий.ОткрытьЗначениеЛкс(ЭлементыФормы.РезультатКоллекция.Значение.Скопировать(),,,, Ложь,, ЭлементыФормы.РезультатКоллекция);
