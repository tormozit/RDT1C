...
Процедура ВычислитьПараметрыЗапроса(ОбъектЗапроса = Неопределено)
	...
	Для каждого СтрокаПараметра Из Параметры Цикл
		Если Не ирОбщий.ЛиИмяПеременнойЛкс(СтрокаПараметра.ИмяПараметра) Тогда
			Продолжить;
		КонецЕсли; 
		ОбъектЗапроса.Параметры.Вставить(СтрокаПараметра.ИмяПараметра, СтрокаПараметра.Значение);
	КонецЦикла;
	...
	//	Для каждого СтрокаПараметра Из Параметры Цикл
	//		ПараметрСхемы = мСхемаКомпоновки.Параметры.Найти(СтрокаПараметра.ИмяПараметра);
	//		Если Истина
	...
	//		Тогда
	//			Компоновщик.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра(СтрокаПараметра.ИмяПараметра, СтрокаПараметра.Значение); 
	//		КонецЕсли; 
	//	КонецЦикла;
	...
	//				ЗначениеПараметра = МакетКомпоновкиДанных.ЗначенияПараметров.Найти(СтрокаПараметра.ИмяПараметра);
	//				Если Истина
	...
	//					ОбновитьТипЗначенияВСтрокеПараметровВФорме(СтрокаПараметра);
	//					мОбъектЗапроса.Параметры.Вставить(СтрокаПараметра.ИмяПараметра, СтрокаПараметра.Значение);
	//				КонецЕсли; 
	//			КонецЕсли; 
	//		КонецЦикла;
	//	КонецЕсли; 
