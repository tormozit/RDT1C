...
Процедура ЗаменитьЛитераломЗНАЧЕНИЕОбращенияКПараметру(Знач СтрокаПараметра)
	...
	Если Ложь
		...
		Для Каждого ЭлементМассива Из Массив Цикл
			...
			КонецЕсли; 
			ТекстЗаменыЭлемента = ирОбщий.ЛитеральноеПредставлениеЗначенияВЗапросеЛкс(ЭлементМассива, Истина);
	...
	Иначе
		...
		ТекстЗамены = ирОбщий.ЛитеральноеПредставлениеЗначенияВЗапросеЛкс(ЗначениеПараметра, Истина);
	КонецЕсли; 
