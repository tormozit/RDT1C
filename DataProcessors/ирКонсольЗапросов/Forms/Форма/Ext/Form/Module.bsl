...
Процедура ПриОткрытии()
	...
	Если ПоказыватьИтогиТаблицы = Истина Тогда
		КоманднаяПанельКоллекцияПоказыватьИтоги(ЭлементыФормы.КоманднаяПанельКоллекция.Кнопки.ПоказыватьИтоги);
	КонецЕсли; 
...
Процедура КоманднаяПанельКоллекцияПоказыватьИтоги(Кнопка)
	...
	ирОбщий.ТабличноеПолеКнопкаОтображенияИтоговНажатиеЛкс(ЭлементыФормы.РезультатКоллекция, Кнопка);
