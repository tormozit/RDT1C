...
Процедура СохранитьИмяФайла()
	...
	ирОбщий.СохранитьЗначениеЛкс("ирКонсольЗапросов_ИмяФайла", мИмяФайла);
...
Процедура ВосстановитьИмяФайла()
	...
	мИмяФайла = ирОбщий.ВосстановитьЗначениеЛкс("ирКонсольЗапросов_ИмяФайла");
...
Процедура ПриОткрытии()
	...
	Тогда
		...
		ИспользоватьАвтосохранение = ирОбщий.ВосстановитьЗначениеЛкс("ирКонсольЗапросов_ИспользоватьАвтосохранение");
...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	Если СохранитьВФайл(Истина) Тогда
		...
		ирОбщий.СохранитьЗначениеЛкс("ирКонсольЗапросов_ИспользоватьАвтосохранение", ИспользоватьАвтосохранение);
...
Функция ОбработатьСтрокуДереваЗапроса(СтрокаДерева, НачальнаяСтрока = 1, НачальнаяКолонка = 1)
	...
	Если СтрокаДерева.ТипУзла = "<TableWithName>" Тогда
		...
		Если Истина
			...
			И мВременныеТаблицыМенеджера1С[НРег(ИмяВременнойТаблицы)] <> Неопределено
		Тогда
