...
Процедура КоманднаяПанельОтборНайтиВСписке(Кнопка)
	...
	ирОбщий.ПоказатьДоступноеПолеЭлементаНастроекКомпоновкиЛкс(ЭлементыФормы.ДоступныеПоля, ЭлементыФормы.Отбор);
	
КонецПроцедуры

Процедура КоманднаяПанельОтборПарНайтиВСписке(Кнопка)
	
	ирОбщий.ПоказатьДоступноеПолеЭлементаНастроекКомпоновкиЛкс(ЭлементыФормы.ДоступныеПоляПар, ЭлементыФормы.ОтборПар);
	
КонецПроцедуры

Процедура КоманднаяПанельНастройкиОтчетаНайтиВСписке(Кнопка)
	
	ирОбщий.ПоказатьДоступноеПолеЭлементаНастроекКомпоновкиЛкс(ЭлементыФормы.ДоступныеПоля, ЭлементыФормы.НастройкаСравнения);
