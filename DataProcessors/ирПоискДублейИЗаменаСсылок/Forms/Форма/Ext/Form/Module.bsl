...
Процедура КоманднаяПанельНастройкиОтчетаПоиск(Кнопка)
	...
	Тогда
		...
		ЗапросСОтборомОбщим = ирОбщий.ЗапросИзКомпоновкиЛкс(мСхемаКомпоновкиОбщая, КомпоновщикСравнения.ПолучитьНастройки(),,, "Ссылка");
		ТекстИндексов = "";
...
Процедура КоманднаяПанельНастройкиОтчетаИсполняемыйЗапрос(Кнопка)
	...
	ЗапросСОтбором = ирОбщий.ЗапросИзКомпоновкиЛкс(мСхемаКомпоновкиОбщая, НастройкиДляОтбора,,, "Ссылка");
