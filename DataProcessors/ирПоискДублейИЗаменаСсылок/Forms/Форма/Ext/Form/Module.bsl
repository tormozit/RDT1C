...
Процедура ОбновитьПодменюПоследнихОтборов()
	...
	#КонецЕсли
	ирОбщий.ПоследниеВыбранныеЗаполнитьПодменюЛкс(ЭтаФорма, ЭлементыФормы.КоманднаяПанельОтбор.Кнопки.ПоследниеОтборы, ПолноеИмяОбъекта, Новый Действие("ПоследниеОтборыНажатие"), "Отборы");
