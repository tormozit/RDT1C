...
Процедура НайтиПоРавенствуРеквизитов(ЗапросПоиска, ТекстИдексов)
	...
	НайденныеГруппы = РезультатПакета[1].Выгрузить();
	...
	мРезультатыПоиска = РезультатПакета[2].Выгрузить();
...
Функция ПолучитьЗапросПоискаДублейПоРавенствуРеквизитов(ЗапросСОтбором, выхТекстИдексов = "")
	...
	ТекстЗапросаПоиска = " // Группы дублей
...
Процедура КоманднаяПанельНастройкиОтчетаПоиск(Кнопка)
	...
	Иначе
		ТекстИдексов = "";
		ЗапросПоискаДублей = ПолучитьЗапросПоискаДублейПоРавенствуРеквизитов(ЗапросСОтбором, ТекстИдексов);
