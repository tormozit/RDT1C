...
Процедура ПравилаЗаменыСсылокПометкаПриИзменении(Элемент)
	...
	ПравилаКонкуренты = ПравилаЗаменыСсылок.НайтиСтроки(Новый Структура("НаЧтоЗаменять", ТекущаяСтрока.НаЧтоЗаменять));
