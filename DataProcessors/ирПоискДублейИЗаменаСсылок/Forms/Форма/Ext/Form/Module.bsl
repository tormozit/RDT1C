...
Процедура КлсПолеТекстовогоДокументаСКонтекстнойПодсказкойНажатие(Кнопка)
	...
	мПолеТекстовогоДокументаСКонтекстнойПодсказкой.ЛиСерверныйКонтекст = ВыполнятьНаСервере;
...
Процедура ВнешнееСобытие(Источник, Событие, Данные) Экспорт
	...
	Если мПолеТекстовогоДокументаСКонтекстнойПодсказкой = Неопределено Тогда
		Возврат;
	КонецЕсли; 
	#Если Сервер И Не Сервер Тогда
	    мПолеТекстовогоДокументаСКонтекстнойПодсказкой = Обработки.ирКлсПолеТекстовогоДокументаСКонтекстнойПодсказкой.Создать();
	#КонецЕсли
	мПолеТекстовогоДокументаСКонтекстнойПодсказкой.ВнешнееСобытиеОбъекта(Источник, Событие, Данные);
...
Функция СохраняемаяНастройкаФормы(выхНаименование, выхИменаСвойств) Экспорт 
	...
	выхИменаСвойств = "Реквизит.АвтовидимостьКолонокСоставаГруппы, Реквизит.АвтоматическийВыборПриЗамещенииВРегистреСведений, Реквизит.ВыполнятьНаСервере, Реквизит.ДопустимоеРазличиеСлов, Реквизит.ИзменятьПоляПоСвязямПараметровВыбора, Реквизит.КоличествоОбъектовВПорции, Реквизит.КоличествоПотоков, Реквизит.КомментироватьЗаменуСсылок, Реквизит.КомпоновкаСсылающихсяОбъектов, Реквизит.НастройкиПоискаДублей, Реквизит.ОбработкаЗаменыДанных, Реквизит.ОбщаяТранзакция, Реквизит.ОпределятьСвязьПоВладельцуПоДанным, Реквизит.ПерезаписыватьПравильныеПослеЗамены, Реквизит.ПолноеИмяОбъекта, Реквизит.СнятьПометкиУдаленияПравильныхПослеЗамены, Реквизит.УчитыватьПравыеПробелыСтрок, Форма.НайденныеГруппы, Форма.ПравилаЗаменыСсылок, Форма.РежимПроизвольногоЗапроса";
...
Процедура ОткрытьСЗаполнениемГруппДублейПоТаблицеПар(Знач ТаблицаПар, Знач ИмяКолонкиТаблицыПарНеправильный, Знач ИмяКолонкиТаблицыПарПравильный) Экспорт
	...
	ТаблицаПар = ирОбщий.ТаблицаСМинимальнымиТипамиКолонокЛкс(ТаблицаПар.Скопировать(, СтрокаИменКолонок));
...
Процедура ПриОткрытии()
	...
	мПолеТекстовогоДокументаСКонтекстнойПодсказкой = ирОбщий.СоздатьОбъектПоПолномуИмениМетаданныхЛкс("Обработка.ирКлсПолеТекстовогоДокументаСКонтекстнойПодсказкой");
	#Если Сервер И Не Сервер Тогда
		мПолеТекстовогоДокументаСКонтекстнойПодсказкой = Обработки.ирКлсПолеТекстовогоДокументаСКонтекстнойПодсказкой.Создать();
	#КонецЕсли
