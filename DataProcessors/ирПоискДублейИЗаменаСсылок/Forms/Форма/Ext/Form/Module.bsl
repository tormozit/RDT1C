...
Функция СохраняемаяНастройкаФормы(выхНаименование, выхИменаСвойств) Экспорт 
	...
	выхИменаСвойств = "Реквизит.АвтовидимостьКолонокСоставаГруппы, Реквизит.АвтоматическийВыборПриЗамещенииВРегистреСведений, Реквизит.ВыполнятьНаСервере, Реквизит.ДопустимоеРазличиеСлов,
	|Реквизит.ИзменятьПоляПоСвязямПараметровВыбора, Реквизит.КомментироватьЗаменуСсылок, Реквизит.КомпоновкаСсылающихсяОбъектов, Реквизит.НастройкиПоискаДублей, Реквизит.ОбработкаЗаменыДанных,
	|Реквизит.ОбщаяТранзакция, Реквизит.ОпределятьСвязьПоВладельцуПоДанным, Реквизит.ПерезаписыватьПравильныеПослеЗамены, Реквизит.ПолноеИмяОбъекта, Реквизит.СнятьПометкиУдаленияПравильныхПослеЗамены,
