...
Процедура КоманднаяПанель1Сравнить(Кнопка)
	...
	СравниваемыйДокумент1 = ирОбщий.ВывестиТабличноеПолеКоллекцииВТабличныйДокументСНастройкойЛкс(ЭлементыФормы.ОбластиБлокировки, ВыводБезОформления);
	СравниваемыйДокумент2 = ирОбщий.ВывестиТабличноеПолеКоллекцииВТабличныйДокументСНастройкойЛкс(ЭлементыФормы.ОбластиБлокировкиБлокиратора, ВыводБезОформления);
