...
Процедура КоманднаяПанельЖурналРегистрацииПоказыватьИтоги(Кнопка)
	
	ирОбщий.ТабличноеПолеКнопкаОтображенияИтоговНажатиеЛкс(ЭлементыФормы.ТаблицаЖурнала, Кнопка);
