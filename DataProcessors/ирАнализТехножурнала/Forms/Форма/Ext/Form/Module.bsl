...
Процедура ОбновитьТаблицуЖурнала() Экспорт
	...
	ирОбщий.ПрочитатьТехножурналЛкс(МоментНачалаЗагрузки, ОбщиеПараметрыОбработки, ФильтрЗагрузки,
		ЭтаФорма, Кнопка, "ОбновитьТаблицуЖурналаЗавершение");
...
Процедура ОбновитьТаблицуЖурналаЗавершение(СостояниеЗадания = Неопределено, РезультатЗадания = Неопределено) Экспорт 
	...
	Тогда
		...
		КонецЕсли; 
		МоментНачалаЗагрузки = РезультатЗадания.МоментНачалаЗагрузки;
