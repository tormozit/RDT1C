...
Процедура ДействияФормыСравнить(Кнопка)
	...
	ирОбщий.СравнитьСодержимоеЭлементаУправленияЛкс(ЭтаФорма, ЭлементыФормы.ЗначенияСвойств);
...
Процедура ДействияФормыОткрытьМенеджерТабличногоПоля(Кнопка)
	...
	ирОбщий.ОткрытьМенеджерТабличногоПоляЛкс(ЭлементыФормы.ЗначенияСвойств, ЭтаФорма);
