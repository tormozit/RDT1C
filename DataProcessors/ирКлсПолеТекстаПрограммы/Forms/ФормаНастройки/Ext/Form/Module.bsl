...
Процедура ОсновныеДействияФормыОК(Кнопка)
	...
	ирОбщий.СохранитьЗначениеЛкс(ИмяКласса + ".ГлубокоВычислятьТипыВСпискеАвтодополнения", ГлубокоВычислятьТипыВСпискеАвтодополнения);
...
Процедура ПриОткрытии()
	...
	ГлубокоВычислятьТипыВСпискеАвтодополнения = ирОбщий.ВосстановитьЗначениеЛкс(ИмяКласса + ".ГлубокоВычислятьТипыВСпискеАвтодополнения");
	...
	ПоказыватьВсеТипыВСпискеАвтодополненияHTML = ирОбщий.ВосстановитьЗначениеЛкс(ИмяКласса + ".ПоказыватьВсеТипыВСпискеАвтодополненияHTML");
