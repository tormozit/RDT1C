...
Функция ФоновыеЗаданияПодробно(ТаблицаЗаданий, ДляСбораСтатистики, КонечныйОтбор, ОтборФоновыхЗаданий, ОтображатьИндикатор,
	АвтообновлениеСпискаМетодов = Ложь, ПолучатьОшибкиИзЖурнала = Ложь, ПолучатьСообщенияПользователю = Ложь, ФоновыеЗаданияСоответствие = Неопределено) Экспорт 
