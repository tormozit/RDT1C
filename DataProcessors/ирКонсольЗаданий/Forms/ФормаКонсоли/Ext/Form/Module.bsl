...
Процедура СписокФоновыхЗаданийВыбор(Элемент, ВыбраннаяСтрока, Колонка, СтандартнаяОбработка)
	...
	ИначеЕсли Колонка = ЭлементыФормы.СписокФоновыхЗаданий.Колонки.ОшибкиЖР Тогда
		ФоновоеЗадание = ФоновыеЗаданияСоответствие.Получить(ВыбраннаяСтрока.Идентификатор);
...
Функция ОтборДляЖурналаПоСтрокеЗадания(Знач ТекущаяСтрока)
...
Процедура КоманднаяПанельМетодыПерейтиКРегламентномуЗаданию(Кнопка)
	...
	ЭлементыФормы.СписокРегламентныхЗаданий.ТекущаяСтрока = СписокРегламентныхЗаданий.Найти(ТекущаяСтрока.Метаданные, "МетаданныеИмя");
...
Процедура КоманднаяПанельРегламентныеЗаданияПерейтиКМетоду(Кнопка)
	...
	ЭлементыФормы.Методы.ТекущаяСтрока = Методы.Найти(ТекущаяСтрока.ИмяМетода, "ИмяМетода");
