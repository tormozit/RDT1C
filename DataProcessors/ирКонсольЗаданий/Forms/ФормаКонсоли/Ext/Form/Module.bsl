...
Функция ОбновитьСписокФоновыхЗаданий(ВызовВнутриОбновленияРегламентныхЗаданий = Ложь, ДляСбораСтатистики = Ложь, Перезапустить = Ложь)
	...
	КонецЕсли;
	Если КонечныйОтбор.Количество() <= 1 Тогда
	...
	ПараметрыЗадания.Вставить("ФоновыеЗаданияСоответствие", ФоновыеЗаданияСоответствие);
...
Процедура ПриОткрытии()
	...
	ЭлементыФормы.КПФоновыеЗадания.Кнопки.ОтладчикФоновыхЗаданий.Доступность = Не ирКэш.ЛиПортативныйРежимЛкс() Или ирКэш.ЭтоФайловаяБазаЛкс();
