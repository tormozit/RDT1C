...
Процедура СписокФоновыхЗаданийПриВыводеСтроки(Элемент, ОформлениеСтроки, ДанныеСтроки)
	...
	КонецЕсли;
	ирОбщий.ОформитьЯчейкуСРасширеннымЗначениемЛкс(ОформлениеСтроки.Ячейки.РазделениеДанных,, Элемент.Колонки.РазделениеДанныхСеанса);
...
Процедура КоманднаяПанельФоновыеЗаданияОтборПоТекущему(Кнопка = Неопределено)
...
Процедура СписокФоновыхЗаданийВыбор(Элемент, ВыбраннаяСтрока, Колонка, СтандартнаяОбработка)
	...
	ИначеЕсли Колонка = Элемент.Колонки.Ошибки Тогда
		...
		КонецЕсли; 
	ИначеЕсли Колонка = Элемент.Колонки.РазделениеДанных Тогда
