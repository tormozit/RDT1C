...
Процедура УстановитьОбъектМетаданных(ПолноеИмяТаблицы = Неопределено) Экспорт
	...
	СтарыйОбъектМетаданных = ОбъектМетаданных;
	
КонецПроцедуры

Процедура СохранитьНастройкиКолонок()
	
	Если Не ЗначениеЗаполнено(СтарыйОбъектМетаданных) Тогда
		Возврат;
	КонецЕсли; 
	...
	КонецЦикла;
	ХранилищеОбщихНастроек.Сохранить(ирОбщий.ИмяПродуктаЛкс(), "ДинамическийСписок." + СтарыйОбъектМетаданных + "." + РежимВыбора, НастройкиКолонок.Выгрузить());
...
Процедура ЗагрузитьНастройкиКолонок()
	...
	Если СохраненныеНастройки = Неопределено Тогда
		Возврат;
	КонецЕсли; 
	НастройкиКолонок.Загрузить(СохраненныеНастройки);
...
Процедура КП_СписокСброситьНастройкиКолонок(Кнопка)
	...
	ХранилищеОбщихНастроек.Сохранить(ирОбщий.ИмяПродуктаЛкс(), "ДинамическийСписок." + СтарыйОбъектМетаданных + "." + РежимВыбора, Неопределено);
	УстановитьОбъектМетаданных();
