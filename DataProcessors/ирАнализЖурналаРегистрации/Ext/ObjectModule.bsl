...
Функция ЗагрузитьДанныеЖурнала(ЭтаФорма = Неопределено, Кнопка = Неопределено) Экспорт 
	...
	Иначе
		...
		Иначе
			...
			ОписаниеЗадания = ирОбщий.ОписаниеФоновогоЗаданияФормыЛкс("Выгрузка", "ирСервер.ВыгрузитьЖурналРегистрацииФоновоЛкс", ПараметрыЗадания, "Отбор - " + ПредставлениеОтбора, 
