...
Процедура ОбновитьТаблицуРеквизитов()
	...
	КонецЦикла;
	Если ирКэш.НомерВерсииБСПЛкс() > 200 И ирОбщий.ЛиСсылочныйОбъектМетаданных(мОбъектМД) И Метаданные.ОбщиеМодули.Найти("УправлениеСвойствами") <> Неопределено Тогда
