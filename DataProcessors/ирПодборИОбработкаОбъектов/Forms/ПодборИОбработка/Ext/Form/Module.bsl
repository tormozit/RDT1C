...
Процедура ПриПолученииДанныхДоступныхПолей(Элемент, ОформленияСтрок)
	...
	Для Каждого ОформлениеСтроки Из ОформленияСтрок Цикл
		Если Не МноготабличнаяВыборка И КоллекцияОтключенныхПолей <> Неопределено И КоллекцияОтключенныхПолей.Найти("__" + ОформлениеСтроки.ДанныеСтроки.Поле) <> Неопределено Тогда
