...
Процедура ОбъектыДляОбработкиОбработкаВыбора(Элемент, Знач ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Для Каждого ЭлементМассива Из ВыбранноеЗначение Цикл
		...
		Тогда
			СтруктураКлюча = ирОбщий.СтруктураИзКлючаЗаписиЛкс(ЭлементМассива);
			...
			Если НайденнаяСтрока = Неопределено Тогда
				СтрокаОбъекта = НайденныеОбъекты.Добавить();
				СтрокаРезультата = ирОбщий.СтрокаТаблицыБДПоКлючуЛкс(ирОбщий.ПолучитьИмяТаблицыИзМетаданныхЛкс(ПолноеИмяМДЭлемента), СтруктураКлюча);
	...
	Для Каждого КлючЗаписи Из Массив Цикл
		...
		Иначе
			Если ирОбщий.ЛиКлючЗаписиРегистраЛкс(ТипКлючаЗаписи) Тогда 
				КлючЗаписи = ирОбщий.СтруктураИзКлючаЗаписиЛкс(КлючЗаписи);
			КонецЕсли; 
