...
Процедура ОтборКомпоновкиЗначениеНачалоВыбораИзСписка(Элемент, СтандартнаяОбработка)
	...
	ирОбщий.ПолеВводаСИсториейВыбора_НачалоВыбораИзСпискаЛкс(ЭлементыФормы.КомпоновщикОтбор.Колонки.ПравоеЗначениеДляКраткогоОтображенияЭлемента.ЭлементУправления,
		ОбластьПоиска + ".Отбор." + ЭлементыФормы.КомпоновщикОтбор.ТекущаяСтрока.ЛевоеЗначение);
...
Процедура ДобавитьЗначениеОтбораВИсторию()
	...
	ирОбщий.ПолеВводаСИсториейВыбора_ПриИзмененииЛкс(ЭлементыФормы.КомпоновщикОтбор.Колонки.ПравоеЗначениеДляКраткогоОтображенияЭлемента.ЭлементУправления,
		ОбластьПоиска + ".Отбор." + ЭлементыФормы.КомпоновщикОтбор.ТекущаяСтрока.ЛевоеЗначение,,,, ЭлементыФормы.КомпоновщикОтбор.ТекущаяСтрока.ПравоеЗначение);
