...
Функция ЛиЗапрешеноЗапоминатьЗначенияОтбора()
	...
	Возврат Ложь
		Или МноготабличнаяВыборка 
		Или ТипЗнч(ЭлементыФормы.КомпоновщикОтбор.ТекущаяСтрока) <> Тип("ЭлементОтбораКомпоновкиДанных")
		Или Найти(ЭлементыФормы.КомпоновщикОтбор.ТекущаяСтрока.ЛевоеЗначение, ".") > 0;
