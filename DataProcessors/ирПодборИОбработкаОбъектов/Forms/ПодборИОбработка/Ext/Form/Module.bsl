...
Процедура ПриОткрытии()
	...
	ВосстановленныеДоступныеОбработки = ирОбщий.ВосстановитьЗначениеЛкс("ДоступныеОбработки");
	...
	ВосстановленныеВыбранныеОбработки = ирОбщий.ВосстановитьЗначениеЛкс("ВыбранныеОбработки");
...
Процедура ПриЗакрытии()
    ...
    ирОбщий.СохранитьЗначениеЛкс("ДоступныеОбработки", ДоступныеОбработки);
	ирОбщий.СохранитьЗначениеЛкс("ВыбранныеОбработки", ВыбранныеОбработкиДляСохранения);
...
Процедура КоманднаяПанельНайденныеОбъектыУстановитьФлажки(Кнопка)
	...
	ирОбщий.ИзменитьПометкиВыделенныхСтрокЛкс(ЭлементыФормы.ОбъектыДляОбработки, мИмяКолонкиПометки, Истина,,, Ложь);

КонецПроцедуры

Процедура КоманднаяПанельНайденныеОбъектыСнятьФлажки(Кнопка)

	ирОбщий.ИзменитьПометкиВыделенныхСтрокЛкс(ЭлементыФормы.ОбъектыДляОбработки, мИмяКолонкиПометки, Ложь,,, Ложь);
...
Процедура ГлавнаяКоманднаяПанельОчиститьНатройкиОбработок(Кнопка)
	...
	ирОбщий.СохранитьЗначениеЛкс("ДоступныеОбработки", Неопределено);
	ирОбщий.СохранитьЗначениеЛкс("ВыбранныеОбработки", Неопределено);
...
Функция УстановитьОбластьПоиска(пОбластьПоиска = Null) Экспорт
	...
	Иначе
		...
		ОписаниеТаблицы = ирОбщий.ПолучитьОписаниеТаблицыБДИис(ОбластьПоиска);
