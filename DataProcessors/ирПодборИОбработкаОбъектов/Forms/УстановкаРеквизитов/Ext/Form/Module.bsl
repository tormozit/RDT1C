...
Процедура ОбновитьТаблицуРеквизитов()
	...
	ИмяТаблицы = ирОбщий.ПолучитьИмяТаблицыИзМетаданныхЛкс(мОбъектМД);
	СтруктураКлюча = ирОбщий.ПолучитьСтруктуруКлючаТаблицыБДЛкс(ИмяТаблицы);
	КомпоновщикОбхода = ирКэш.ПолучитьКомпоновщикТаблицыМетаданныхЛкс(ИмяТаблицы);
