...
Процедура вВыполнитьОбработку() Экспорт
	...
	ОбработаноОбъектов = ирОбщий.ПодборИОбработкаОбъектов_ВыполнитьОбработкуЛкс("ОтменитьПроведениеДокументов", ОбщиеПараметрыОбработки(), ПолучитьНастройкуЛкс(),, ЭтаФорма);
