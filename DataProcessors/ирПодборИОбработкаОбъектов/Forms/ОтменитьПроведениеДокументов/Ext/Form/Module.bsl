...
Процедура вВыполнитьОбработку() Экспорт
	...
	ОбработаноОбъектов = ирОбщий.ПодборИОбработкаОбъектов_ВыполнитьОбработкуЛкс("ОтменитьПроведениеДокументов", ОбщиеПараметрыОбработки(), ПолучитьНастройку(),, ЭтаФорма);
...
ирОбщий.ИнициализироватьФормуЛкс(ЭтаФорма, "Обработка.ирПодборИОбработкаОбъектов.Форма.ОтменитьПроведениеДокументов");
