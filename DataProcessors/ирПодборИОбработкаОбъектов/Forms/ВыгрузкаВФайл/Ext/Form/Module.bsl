...
Функция вВыполнитьОбработку(Кнопка = Неопределено) Экспорт
	...
	БлокируемыеЭлементыФормы.Добавить(ЭтаФорма.ЭлементыФормы.ИмяФайла.Имя);
	#Если Сервер И Не Сервер Тогда
		ВыполнитьОбработкуЗавершение();
	#КонецЕсли
	ирОбщий.ПодборИОбработкаОбъектов_ВыполнитьОбработкуЛкс("ВыгрузкаВФайл", ОбщиеПараметрыОбработки(), ПолучитьНастройкуЛкс(),, ЭтаФорма, Кнопка, "ВыполнитьОбработкуЗавершение",,
