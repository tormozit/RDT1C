...
Процедура вВыполнитьОбработку(Кнопка = Неопределено) Экспорт 
	...
	ирОбщий.ПодборИОбработкаОбъектов_ВыполнитьОбработкуЛкс("ИзменитьПометкуНаУдаление", ОбщиеПараметрыОбработки, ПолучитьНастройкуЛкс(),, ЭтаФорма, Кнопка, "ВыполнитьОбработкуЗавершение");
КонецПроцедуры
