...
Процедура вВыполнитьОбработку(Кнопка = Неопределено) Экспорт 
	...
	ирОбщий.ПодборИОбработкаОбъектов_ВыполнитьОбработкуЛкс("ИзменитьРегистрациюНаУзле", ОбщиеПараметрыОбработки, ПолучитьНастройкуЛкс(),, ЭтаФорма, Кнопка, "ВыполнитьОбработкуЗавершение");
