...
Процедура вВыполнитьОбработку() Экспорт 
	...
	ОбработаноОбъектов = ирОбщий.ПодборИОбработкаОбъектов_ВыполнитьОбработкуЛкс("ИзменитьРегистрациюНаУзле", ОбщиеПараметрыОбработки(), ПолучитьНастройкуЛкс(),, ЭтаФорма);
