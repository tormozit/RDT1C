...
Процедура вВыполнитьОбработку() Экспорт
	...
	ОбработаноОбъектов = ирОбщий.ПодборИОбработкаОбъектов_ВыполнитьОбработкуЛкс("ОчиститьДвиженияДокументов", ОбщиеПараметрыОбработки(), ПолучитьНастройку(),, ЭтаФорма);
...
ирОбщий.ИнициализироватьФормуЛкс(ЭтаФорма, "Обработка.ирПодборИОбработкаОбъектов.Форма.ОчиститьДвиженияДокументов");
