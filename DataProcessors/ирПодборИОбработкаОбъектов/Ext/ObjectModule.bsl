			...
			Для ИндексКлюча = 0 По КоличествоОбъектов - 1 Цикл
				...
				#Если Не Клиент Тогда
					...
					Для Каждого СообщениеОбъекта Из СообщенияОбъекта Цикл
						...
						#КонецЕсли
						СообщенияОбработки.ЗаписатьБезОбработки(СообщениеОбъекта.Текст);
					КонецЦикла;
				#КонецЕсли
	...
	Попытка
		...
		Иначе
			...
			Если ЗагрузитьСтрокиПослеОбработки Тогда
				...
				КонецЕсли; 
			КонецЕсли; 
			Если Не ирОбщий.ЛиКорневойТипСсылкиЛкс(ТипТаблицы) Тогда
				Попытка
...
мИмяКолонкиСообщенияОбработки = "_СообщенияОбработки";
