...
Процедура КоманднаяПанельНайденныеОбъектыОткрытьТаблицу(Кнопка)
	...
	ирОбщий.ОткрытьФормуПроизвольногоЗначенияЛкс(БитыеСсылки.Выгрузить(), Ложь,,,,, ЭлементыФормы.БитыеСсылки);
...
Процедура КП_СвязанныеДанныеОткрытьТаблицу(Кнопка)
	...
	ирОбщий.ОткрытьФормуПроизвольногоЗначенияЛкс(СвязанныеДанные.Выгрузить(), Ложь,,,,, ЭлементыФормы.СвязанныеДанные);
