...
Процедура ЗначенияВыбор(Элемент, ВыбраннаяСтрока, Колонка, СтандартнаяОбработка)
	...
	КонецЕсли;
	Если Истина
		И ЭлементыФормы.ОсновныеДействияФормы.Кнопки.Применить.Доступность
		И ОсновныеДействияФормыПрименить() 
	Тогда 
...
Функция ЭтоНеограниченнаяСтроковаяКолонка()
	...
	Возврат ирОбщий.ЭтоОписаниеТиповНеограниченнойСтрокиЛкс(мОписаниеТиповКолонки);
