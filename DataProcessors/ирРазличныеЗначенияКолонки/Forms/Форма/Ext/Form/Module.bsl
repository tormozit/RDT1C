...
Функция ОбновитьДанные()
	...
	ДанныеКолонки = ирОбщий.ПолучитьПутьКДаннымКолонкиТабличногоПоляЛкс(ИсточникДействий);
...
Процедура ОсновныеДействияФормыОК(Кнопка = Неопределено)
	...
	ДанныеКолонки = ирОбщий.ПолучитьПутьКДаннымКолонкиТабличногоПоляЛкс(ЭтаФорма.ВладелецФормы);
