...
Функция ОбновитьДанные()
	...
	Иначе	
		...
		//КомпоновщикОбъектаМД = ирКэш.КомпоновщикТаблицыМетаданныхЛкс(ПолноеИмяМД);
	...
	Если УстановитьТекущуюСтроку Тогда 
		...
		СтрокаЗначения = ОсновнойЭУ.Значение.НайтиСтроки(Новый Структура("Значение, ТипЗначения", ТекущееЗначениеЛ, "" + ТипЗнч(ТекущееЗначение)));
