...
Функция ОбновитьДанные(РежимОтладки = Ложь)
	...
	ИмяТипаЗначения = ирОбщий.ОбщийТипДанныхТабличногоПоляЛкс(ИсточникДействий,,, ПолноеИмяТаблицыБД, ДанныеТабличногоПоля);
	...
	Если ВыгрузкаРезультата = Неопределено Тогда
		...
		#КонецЕсли
	КонецЕсли; 
	ВыгрузкаРезультата = ирОбщий.ТаблицаСМинимальнымиТипамиКолонокЛкс(ВыгрузкаРезультата);
	...
	Тогда
		...
		КонецЕсли; 
		Если Отбор <> Неопределено Тогда
			ирОбщий.СкопироватьОтборЛюбойЛкс(НастройкаКомпоновки.Отбор, ИсточникДействий.ОтборСтрок);
