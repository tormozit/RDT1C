...
Функция ОбновитьДанные(РежимОтладки = Ложь, ИзменятьФлагУчитыватьОтбор = Ложь)
	...
	Тогда
		...
		Тогда
			...
			КонецЦикла;
		КонецЕсли; 
		ЗаполнитьИменаТиповЗначений(ТаблицаРезультата);
	...
	Иначе
		...
		Иначе
			...
			ЗаполнитьИменаТиповЗначений(ВыгрузкаРезультата);
		КонецЕсли;
	КонецЕсли;
...
Процедура ЗаполнитьИменаТиповЗначений(Знач ТаблицаРезультата)
