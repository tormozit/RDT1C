...
Процедура ОбновитьИндексНажатие(Элемент)
	ирОбщий.ОбновитьИндексПолнотекстовогоПоискаЛкс(ОбщиеПараметрыОбработки(), ЭтаФорма, ЭлементыФормы.ОбновитьИндекс, "ОбновитьИндексЗавершение");
КонецПроцедуры
...
Процедура КП_ТаблицаПорцииСсылкиОтборБезЗначенияВТекущейКолонке(Кнопка)
	...
	ирОбщий.ТабличноеПолеОтборДляЗначенияВТекущейКолонкеЛкс(ЭлементыФормы.ТаблицаПорции);
...
Процедура КП_ТаблицаПорцииСравнить(Кнопка)
	...
	ирОбщий.СравнитьСодержимоеЭлементаУправленияЛкс(ЭтаФорма, ЭлементыФормы.ТаблицаПорции);
...
ирОбщий.ИнициализироватьФормуЛкс(ЭтаФорма, "Обработка.ирПолнотекстовыйПоискДанных.Форма.Форма");
РазмерПорции = 20;
Нечеткость = 25;
