...
Функция ПрименитьИзменившиесяНастройки()
	...
	Для Каждого КлючИЗначение Из мСоответствияСобытий Цикл
		...
		Если мНастройки[ИмяРеквизита] И ИмяСобытия = констСобытиеДоступ_Доступ И мМенялисьНастройкиДоступа Тогда
			
			ИспользованиеСобытия.ОписаниеИспользования = НастройкиДоступа;
			
		ИначеЕсли мНастройки[ИмяРеквизита] И ИмяСобытия = констСобытиеДоступ_ОтказВДоступе И мМенялисьНастройкиОтказаВДоступе Тогда
		...
		Попытка
			...
			мНастройки[ИмяРеквизита] = мНастройки[ИмяРеквизита];
			Если мНастройки[ИмяРеквизита] И ИмяСобытия = констСобытиеДоступ_Доступ И мМенялисьНастройкиДоступа Тогда
				мМенялисьНастройкиДоступа = Ложь;
			ИначеЕсли мНастройки[ИмяРеквизита] И ИмяСобытия = констСобытиеДоступ_ОтказВДоступе И мМенялисьНастройкиОтказаВДоступе Тогда
				мМенялисьНастройкиОтказаВДоступе = Ложь;
