...
Функция СравнитьТаблицыВФорме(Кнопка = Неопределено) Экспорт
	...
	Тогда 
		...
		#КонецЕсли
		РезультатЗадания = ирОбщий.СравнениеТаблиц_СравнитьЛкс(ОбщиеПараметрыОбработки(), МоментНачала, РежимСравненияСВыгрузкой,,, 
			ЭтаФорма, Кнопка, "СравнитьТаблицыЗавершение");
