...
Процедура ЗаполнитьПредставления()
	...
	Для Каждого ДоступноеПоле Из ПостроительОтчетовВременный.ДоступныеПоля Цикл
		...
		Иначе
			НоваяСтрока.Представление = ЛксПолучитьПредставлениеИзИдентификатора(ДоступноеПоле.Имя);
...
Процедура ЗаполнитьПараметры(ЗаменятьТипы = Ложь)
	...
	Для каждого ПараметрЗапроса Из ПараметрыЗапроса Цикл
		...
		Тогда 
			СтрокаПараметров.ПредставлениеПараметра = ЛксПолучитьПредставлениеИзИдентификатора(ИмяПараметра);
		КонецЕсли;
...
Процедура ПараметрыИмяПараметраПриИзменении(Элемент)
	...
	Если ПустаяСтрока(ЭлементыФормы.Параметры.ТекущиеДанные.ПредставлениеПараметра) Тогда
		ЭлементыФормы.Параметры.ТекущиеДанные.ПредставлениеПараметра = ЛксПолучитьПредставлениеИзИдентификатора(ЭлементыФормы.Параметры.ТекущиеДанные.ИмяПараметра);
	КонецЕсли;
