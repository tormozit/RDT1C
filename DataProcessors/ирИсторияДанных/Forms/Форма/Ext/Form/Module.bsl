Функция СохраняемаяНастройкаФормы(выхНаименование, выхИменаСвойств) Экспорт 
	выхИменаСвойств = "Реквизит.ВычислятьПоля, Реквизит.ВычислятьКоличествоВерсий, Реквизит.МаксКоличествоВерсий, Форма.ИмяПредставление, Форма.НачалоПериода, Форма.КонецПериода";
...
Процедура КПТипыОбновить(Кнопка = Неопределено)
	...
	#КонецЕсли
	ирОбщий.ОбновитьИтогиИсторииДанныхПоТипамЛкс(ОбщиеПараметрыОбработки(), ОтборВерсий(),, 
