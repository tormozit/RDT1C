...
Процедура ОбновитьИндексНажатие(Элемент)
	ирОбщий.ОбновитьИндексПолнотекстовогоПоискаЛкс(ЭтаФорма, ЭлементыФормы.ОбновитьИндекс, "ОбновитьИндексЗавершение");
КонецПроцедуры
...
Процедура ОбновитьИндексЗавершение(СостояниеЗадания = Неопределено, РезультатЗадания = Неопределено, ПараметрыЗадания = Неопределено) Экспорт 
