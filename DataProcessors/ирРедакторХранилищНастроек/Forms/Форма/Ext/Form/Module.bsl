...
Процедура ПроверитьИзменениеОтбораТабличногоПоляДляИстории(ПутьКДанным)
	...
	ПодключитьОбработчикИзмененияДанных("ЭлементыФормы.ОписаниеНастроек.Отбор", "ПроверитьИзменениеОтбораТабличногоПоляДляИстории", Истина);
...
Процедура ОбновитьПодменюПоследнихОтборов()
	...
	#КонецЕсли
	ирОбщий.ПоследниеВыбранныеЗаполнитьПодменюЛкс(ЭтаФорма, ЭлементыФормы.КоманднаяПанельНастроек.Кнопки.ПоследниеОтборы, ЭлементыФормы.ОписаниеНастроек, Новый Действие("ПоследниеОтборыНажатие"), "Отборы");

КонецПроцедуры

Функция ПоследниеОтборыНажатие(Кнопка) Экспорт
	
	НастройкаКомпоновки = ирОбщий.ВыбранныйЭлементПоследнихЗначенийЛкс(ЭтаФорма, ЭлементыФормы.ОписаниеНастроек, Кнопка, "Отборы", Истина);
	#Если Сервер И Не Сервер Тогда
		НастройкаКомпоновки = Новый НастройкиКомпоновкиДанных;
	#КонецЕсли
	ОтключитьОбработчикИзмененияДанных("ЭлементыФормы.ОписаниеНастроек.Отбор");
	ирОбщий.СкопироватьОтборЛюбойЛкс(ЭлементыФормы.ОписаниеНастроек.ОтборСтрок, НастройкаКомпоновки.Отбор);
	ПроверитьИзменениеОтбораТабличногоПоляДляИстории("");
