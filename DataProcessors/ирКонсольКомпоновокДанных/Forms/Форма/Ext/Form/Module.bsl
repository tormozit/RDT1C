...
Процедура КоманднаяПанельТаблицаЗначенийПоказыватьИтоги(Кнопка)
	
	ирОбщий.ТабличноеПолеКнопкаОтображенияИтоговНажатиеЛкс(ЭлементыФормы.ТаблицаЗначений, Кнопка);
	
КонецПроцедуры

Процедура КоманднаяПанельДеревоЗначенийПоказыватьИтоги(Кнопка)
	
	ирОбщий.ТабличноеПолеКнопкаОтображенияИтоговНажатиеЛкс(ЭлементыФормы.ДеревоЗначений, Кнопка);
