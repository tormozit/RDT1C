...
Процедура СоздатьФайл(Отладка = Ложь) Экспорт 
	...
	мТекущаяСтрокаДереваАлгоритмов.Наименование = ирОбщий.ПолучитьАвтоУникальноеИмяВКоллекцииЛкс(ДеревоАлгоритмов.Строки, мТекущаяСтрокаДереваАлгоритмов, "Наименование", Ложь, БазовоеИмяНовойСтроки());
