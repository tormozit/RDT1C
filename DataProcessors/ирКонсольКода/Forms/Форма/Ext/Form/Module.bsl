...
Процедура ПриОткрытии()
	...
	КонецЕсли; 
	мИсторияФайлов = ХранилищеОбщихНастроек.Загрузить("ИнструментыРазработчикаTormozit", "ирКонсольКода_мИсторияФайлов");
...
Процедура ВосстановитьИмяФайла()
	...
	мИмяФайла = ХранилищеОбщихНастроек.Загрузить("ИнструментыРазработчикаTormozit", "ирКонсольКода_ИмяФайла");
...
Процедура СохранитьИмяФайла()
	...
	ХранилищеОбщихНастроек.Сохранить("ИнструментыРазработчикаTormozit", "ирКонсольКода_ИмяФайла", мИмяФайла);
	Если ЗначениеЗаполнено(мИмяФайла) Тогда
		ирОбщий.ДобавитьВИсториюЭлементЛкс(мИсторияФайлов, мИмяФайла);
		ХранилищеОбщихНастроек.Сохранить("ИнструментыРазработчикаTormozit", "ирКонсольКода_мИсторияФайлов", мИсторияФайлов);
		ОбновитьПодменюИсторииФайлов();
	КонецЕсли; 
