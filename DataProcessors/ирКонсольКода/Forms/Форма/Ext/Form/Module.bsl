...
Процедура ПриОткрытии()
	...
	КонецЕсли; 
	мИсторияФайлов = ХранилищеОбщихНастроек.Загрузить(ирОбщий.ИмяПродуктаЛкс(), "ирКонсольКода_мИсторияФайлов");
...
Процедура ВосстановитьИмяФайла()
	...
	мИмяФайла = ХранилищеОбщихНастроек.Загрузить(ирОбщий.ИмяПродуктаЛкс(), "ирКонсольКода_ИмяФайла");
...
Процедура СохранитьИмяФайла()
	...
	ХранилищеОбщихНастроек.Сохранить(ирОбщий.ИмяПродуктаЛкс(), "ирКонсольКода_ИмяФайла", мИмяФайла);
	Если ЗначениеЗаполнено(мИмяФайла) Тогда
		ирОбщий.ДобавитьВИсториюЭлементЛкс(мИсторияФайлов, мИмяФайла);
		ХранилищеОбщихНастроек.Сохранить(ирОбщий.ИмяПродуктаЛкс(), "ирКонсольКода_мИсторияФайлов", мИсторияФайлов);
		ОбновитьПодменюИсторииФайлов();
	КонецЕсли; 
