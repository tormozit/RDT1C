...
Процедура ПараметрыПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	Если НоваяСтрока Тогда
		Если Копирование Тогда
			Элемент.ТекущиеДанные.Имя = ирОбщий.ПолучитьАвтоУникальноеИмяВКоллекцииЛкс(Элемент.ТекущиеДанные.Владелец(), Элемент.ТекущиеДанные);
		Иначе
...
Процедура ЗагрузитьИзФайла(ИмяФайла = "", НовыйФормат = Истина)
	...
	Иначе
		Если ТипЗнч(ПолученноеЗначение) = Тип("Структура") Тогда
			...
			НоваяСтрока.Наименование = ирОбщий.ПолучитьАвтоУникальноеИмяВКоллекцииЛкс(ДеревоАлгоритмов.Строки, НоваяСтрока, "Наименование", Ложь, "Алгоритм");
...
Процедура СоздатьФайл(Отладка = Ложь) Экспорт 
	...
	мТекущаяСтрокаДереваАлгоритмов.Наименование = ирОбщий.ПолучитьАвтоУникальноеИмяВКоллекцииЛкс(ДеревоАлгоритмов.Строки, мТекущаяСтрокаДереваАлгоритмов, "Наименование", Ложь, "Алгоритм");
...
Процедура ДеревоАлгоритмовПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель)
	...
	КонецЕсли; 
	НоваяСтрока.Наименование = ирОбщий.ПолучитьАвтоУникальноеИмяВКоллекцииЛкс(ТекущийРодитель.Строки, НоваяСтрока.Наименование, "Наименование", Ложь, "Алгоритм");
