...
Функция ВыполнитьЛокально(ТекстДляВыполнения, ЛиСинтаксическийКонтроль = Ложь) Экспорт
	...
	Иначе
		Попытка
			ирОбщий.ВыполнитьАлгоритмВКонтекстеЛкс(ТекстДляВыполнения, СтруктураПараметров, КонтекстВыполнения = "Сервер", РежимВнешнейОбработки, ИмяФайлаВнешнейОбработки, ЛиСинтаксическийКонтроль, ВремяНачала);
		Исключение
...
Функция ПолучитьОбновитьФайлВнешнейОбработки(СтруктураПараметров = Неопределено) Экспорт
	...
	ирОбщий.ОбновитьМодульВнешнейОбработкиДляОтладкиЛкс(ИмяФайлаВнешнейОбработки, ИмяВнешнейОбработки, ТекстМодуля, ТекстМодуляТекущейВнешнейОбработки, ДатаИзмененияВнешнейОбработки, КонтекстВыполнения <> "Клиент");
