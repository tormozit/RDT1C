...
Процедура ВосстановитьИмяФайла()
	...
	мИмяФайла = ирОбщий.ВосстановитьЗначениеЛкс("ирКонсольКода_ИмяФайла");
...
Процедура СохранитьИмяФайла()
	...
	ирОбщий.СохранитьЗначениеЛкс("ирКонсольКода_ИмяФайла", мИмяФайла);
	Если ЗначениеЗаполнено(мИмяФайла) Тогда
...
Процедура КоманднаяПанельВстроенныйЯзыкВставитьУказаниеТипаПеременной(Кнопка)
	...
	ЭлементыФормы.ВстроенныйЯзык.ВыделенныйТекст = "//: <ИмяПеременной> = Новый (""ТаблицаЗначений"");" + Символы.ПС;
