...
Процедура РедакторHTMLonclick(ДанныеСобытия) Экспорт
	...
	Если Событие <> Неопределено Тогда
		...
		ИначеЕсли Событие.event = "EVENT_BEFORE_SIGNATURE" Тогда
			ПолеТекстаАлгоритма.РедакторHTML_ПередПоказомСигнатуры(Событие.params.activeParameter, Событие.params.word, Событие.params.activeSignature);
		...
		КонецЕсли;
	Иначе
		ПолеТекстаАлгоритма.РедакторHTML_ПриКлике();
	КонецЕсли;
