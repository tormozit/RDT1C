...
Функция ВыполнитьЛокально(ТекстДляВыполнения, ЛиСинтаксическийКонтроль = Ложь) Экспорт
	...
	Если Не ЛиСинтаксическийКонтроль И ЧерезФоновоеЗадание Тогда
		...
		// Баг 8.3 Мутабельные значения в структуре во временном хранилище превращаются в копии других значений https://partners.v8.1c.ru/forum/t/1768348/m/1768348
