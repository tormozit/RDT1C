...
Процедура ПриОткрытии()
	...
	#КонецЕсли
	ПолеВстроенногоЯзыка.Инициализировать(, ЭтаФорма, ЭлементыФормы.ВстроенныйЯзык, ЭлементыФормы.КоманднаяПанельВстроенныйЯзык, Ложь, "ВыполнитьЛокально", ЭтаФорма);
...
Процедура КоманднаяПанельВстроенныйЯзыкСообщитьСразу(Кнопка)
	...
	#Если Сервер И Не Сервер Тогда
		ирОбщий.СообщитьЛкс();
	#КонецЕсли
	ЭлементыФормы.ВстроенныйЯзык.ВыделенныйТекст = "ирОбщий.СообщитьЛкс();";
	// Антибаг 8.3.12 https://partners.v8.1c.ru/forum/t/1719342/m/1719342
	ЭлементыФормы.ВстроенныйЯзык.ВыделенныйТекст = Символы.ПС;
