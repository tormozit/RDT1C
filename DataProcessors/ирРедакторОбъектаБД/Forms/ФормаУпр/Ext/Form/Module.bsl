...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПоляДляЗапоминанияТипов.Добавить(Элементы.РеквизитыТаблицаЗначение);
...
Функция ПоместитьДанныеОбъектаВФорму(СтруктураОбъекта, ДанныеИзБД = Истина) 
	...
	//	//СтароеИмяТекущегоРеквизита = ЭлементыФормы.РеквизитыТаблица.ТекущаяСтрока.ИмяРеквизита; // Упр
	//	СтароеИмяТекущегоРеквизита = ЭлементыФормы.РеквизитыТаблица.ДанныеСтроки(ЭлементыФормы.РеквизитыТаблица.ТекущаяСтрока).ИмяРеквизита;
	//КонецЕсли; 
	СтароеИмяТекущегоРеквизита = Неопределено;
...
Процедура РеквизитыТаблицаЗначениеРеквизитаПриИзменении(Знач Элемент = Неопределено, Знач ТекущиеДанные = Неопределено)
	...
	Если фОбъект.мРежимМенеджераЗаписи Тогда
		...
		Если СтрокаОтбора.Количество() > 0 Тогда
			...
			ЭлементыФормы.ТаблицаОтбора.ТекущаяСтрока = СтрокаОтбора.ПолучитьИдентификатор(); // Упр
...
Процедура РеквизитыТаблицаПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	ПолеВводаЗначения = Элемент.ПодчиненныеЭлементы.РеквизитыТаблицаЗначение;
...
Процедура ОтобратьСтраницыРегистров(Текст = Неопределено)
	...
	Если ТекущаяКолонка <> Неопределено Тогда
		...
		Тогда
			ПолеОтбора = ирОбщий.ПолучитьПутьКДаннымКолонкиТабличногоПоляЛкс(ТабличноеПоле);
		ИначеЕсли Ложь
...
Процедура НайтиНажатие(Элемент = Неопределено)
	...
	Тогда
		...
		КонецЦикла; 
	Иначе
		НайтиЗначениеВТаблицеОбъекта(ЭлементыФормы.НаборЗаписей, ЭлементыФормы.ПанельОбъект.ПодчиненныеЭлементы.СтраницаНаборЗаписей.Имя, фОбъект.ИскомоеЗначение);
	КонецЕсли; 
...
Процедура РеквизитыТаблицаВыбор(Элемент, ВыбраннаяСтрока, Колонка, СтандартнаяОбработка)
	...
	ЭлементыФормы = Элементы;
	ВыбраннаяСтрока = ирОбщий.ДанныеТекущейСтрокиЛкс(Элемент);
