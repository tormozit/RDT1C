...
Процедура ПоместитьСтрокуНабораВТаблицуРеквизитов(ДанныеИзБД = Ложь)
	...
	Для Каждого ДоступноеПоле Из мПоляТаблицыБД Цикл
		...
		СтрокаРеквизита = ЗаполнитьСтрокуТаблицыРеквизиты(СтрокаНабора[ИмяРеквизитаФормы], ИмяРеквизитаФормы, ДоступноеПоле.Заголовок, ДоступноеПоле.ТипЗначения, , ДанныеИзБД, ПодсказкаРеквизита);
...
Функция ИмяРеквизитаФормыИзДоступногоПоля(КолонкаНабора)
	...
	// Упр
	Если КолонкаНабора.ТипЗначения.СодержитТип(Тип("ХранилищеЗначения")) Тогда
