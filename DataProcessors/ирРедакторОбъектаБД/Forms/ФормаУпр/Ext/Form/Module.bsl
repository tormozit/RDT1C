...
Функция ПоместитьДанныеОбъектаВФорму(СтруктураОбъекта, ДанныеИзБД = Истина) 
	...
	Если ЭлементыФормы.РеквизитыТаблица.ТекущаяСтрока <> Неопределено Тогда
		СтароеИмяТекущегоРеквизита = ирОбщий.ДанныеСтрокиТабличногоПоляЛкс(ЭлементыФормы.РеквизитыТаблица).ИмяРеквизита;
	КонецЕсли; 
...
&НаКлиенте
Процедура ВыбОбъектНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
Процедура ОбновитьТипЗначенияВСтрокеОтбора(Знач СтрокаОтбора = Неопределено)
	...
	КонецЕсли; 
	ирОбщий.ОбновитьТипЗначенияВСтрокеТаблицыЛкс(СтрокаОтбора,,,,, ирСервер.ПолучитьТаблицуДочернихРеквизитовЛкс(ЭлементыФормы.ТаблицаОтбора));
...
&НаКлиенте
Процедура РеквизитыТаблицаЗначениеРеквизитаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ИмяОсновнойТаблицыНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ПолеВводаКолонки_НачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
Процедура ОбновитьСлужубныеДанныеФормы()
