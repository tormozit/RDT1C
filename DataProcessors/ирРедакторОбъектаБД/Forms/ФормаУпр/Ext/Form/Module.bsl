...
Процедура ЗаписатьРегистры(СсылкаДокумента, ОбратимаяЗапись = Ложь)
	...
	Для Каждого МетаРегистр из ОбъектыМД Цикл
		...
		СтруктураОбъекта = ирОбщий.ОбъектБДПоКлючуЛкс(ИмяТаблицыБДРегистра, Новый Структура(ИмяПоляОтбора, СсылкаДокумента),, Ложь, ОбъектыНаСервере());
...
Процедура ИмяОсновнойТаблицыПриИзменении()
	...
	ЭлементыФОрмы.ПанельОбъект.ПодчиненныеЭлементы.СтраницаДополнительныеСвойства.Видимость = Не фОбъект.ЭтоМетаСсылка;
...
Процедура КоманднаяПанельНабораДвиженийРедакторОбъектаБДНабораДвижений(Кнопка)
	...
	ИмяПоляОтбора = ирОбщий.ИмяПоляОтбораПодчиненногоНабораЗаписейЛкс(ИмяТаблицыБДРегистра);
	СтруктураОбъекта = ирОбщий.ОбъектБДПоКлючуЛкс(ИмяТаблицыБДРегистра, Новый Структура(ИмяПоляОтбора, фОбъект.ВыбОбъект),, Ложь, ОбъектыНаСервере());
...
Функция ПолучитьXMLВсехОбъектовИзБД()
	...
	Тогда
		...
		Для Каждого МетаРегистр из ОбъектыМД Цикл
			...
			ИмяТаблицыБДРегистра = ирОбщий.ПолучитьИмяТаблицыИзМетаданныхЛкс(МетаРегистр);
			ИмяПоляОтбора = ирОбщий.ИмяПоляОтбораПодчиненногоНабораЗаписейЛкс(ИмяТаблицыБДРегистра);
			СтруктураНабора = ирОбщий.ОбъектБДПоКлючуЛкс(ИмяТаблицыБДРегистра, Новый Структура(ИмяПоляОтбора, СтруктураОбъекта.Методы.Ссылка),,, ОбъектыНаСервере());
...
Процедура ДобавляемоеСвойствоПриИзменении(Элемент)
	...
	Если Не ЗначениеЗаполнено(фОбъект.ДобавляемоеСвойство) Тогда
		Возврат;
	КонецЕсли; 
	СтрокаСвойства = ДобавитьДопСвойствоНаФорму(фОбъект.ДобавляемоеСвойство);
...
Процедура ОткрытьДинамичекийСписокДвижения(ИспользоватьДинамическийСписокИР)
	...
	ИмяПоляОтбора = ирОбщий.ИмяПоляОтбораПодчиненногоНабораЗаписейЛкс(ИмяТаблицыБДРегистра);
	ирОбщий.ОткрытьФормуСпискаЛкс(ИмяТаблицыБДРегистра,, ИспользоватьДинамическийСписокИР,,,,,, Новый Структура(ИмяТаблицыБДРегистра, фОбъект.ВыбОбъект));
