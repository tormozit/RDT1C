...
Процедура УстановитьРежимТолькоИзбранныеСвязанныеКолонки()
	...
	фОбъект.ТолькоИзбранное = Истина;
	ЭлементыФормы.КП_СвязанныеКолонки.Кнопки.ТолькоИзбранное.Пометка = фОбъект.ТолькоИзбранное;
...
Процедура ОсновныеДействияФормыОткрытьЗагрузкуТабличныхДанных(Кнопка)
...
Процедура КП_СвязанныеКолонкиТолькоИзбранное(Кнопка)
	...
	фОбъект.ТолькоИзбранное = Не фОбъект.ТолькоИзбранное;
	ЭлементыФормы.КП_СвязанныеКолонки.Кнопки.ТолькоИзбранное.Пометка = фОбъект.ТолькоИзбранное;
	ОбновитьТаблицуСвязанныхКолонок();
	ОбновитьОтборСвязанныхДанных(ЭтаФорма);
...
Процедура КонтекстныеМенюИсследовать(Кнопка = Неопределено)
	...
	КонецЕсли; 
	Исследовать(МетаданныеРеквизита);
