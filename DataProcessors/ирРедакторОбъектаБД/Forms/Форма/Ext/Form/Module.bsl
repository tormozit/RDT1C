...
Функция ЗаполнитьСтрокуТаблицыРеквизиты(Значение, ИмяРеквизита, Представление = "", ОписаниеТипов = Неопределено, ТолькоПросмотр = Ложь, ДанныеИзБД = Истина, ПодсказкаРеквизита = "")
	...
	ирОбщий.ОбновитьТипЗначенияИзОписанияТиповЛкс(строкаТзРеквизиты, "РасширенноеЗначение");
...
Функция ПоместитьДанныеОбъектаВФорму(Объект, ДанныеИзБД = Истина) 
	...
	Если мЭтоСсылочныйОбъект Тогда
		...
		КонецЕсли; 
		ЗаполнитьСтрокуТаблицыРеквизиты(?(Объект.ЭтоНовый(), Объект.ПолучитьСсылкуНового(), ВыбОбъект), "Ссылка", "Идентификатор", ОписаниеТиповИД, мЭтоВнешнийОбъект Или Не Объект.ЭтоНовый());
		...
		Для Каждого ДоступноеПоле Из мПоляТаблицыБД Цикл
			...
			Иначе
				ПодсказкаРеквизита = "";
			КонецЕсли; 
			ЗаполнитьСтрокуТаблицыРеквизиты(Объект, ИмяПоля, ДоступноеПоле.Заголовок, ДоступноеПоле.ТипЗначения, Ложь
...
Процедура ПоместитьСтрокуНабораВТаблицуРеквизитов(ДанныеИзБД = Ложь)
	...
	Для Каждого ДоступноеПоле Из мПоляТаблицыБД Цикл
		...
		Иначе
			ПодсказкаРеквизита = "";
		КонецЕсли; 
		СтрокаРеквизита = ЗаполнитьСтрокуТаблицыРеквизиты(СтрокаНабора, ИмяПоля, ДоступноеПоле.Заголовок, ДоступноеПоле.ТипЗначения, , ДанныеИзБД, ПодсказкаРеквизита);
...
Процедура РеквизитыТаблицаЗначениеРеквизитаПриИзменении(Элемент = Неопределено, ТекущиеДанные = Неопределено)
	...
	ирОбщий.ОбновитьТипЗначенияИзОписанияТиповЛкс(ТекущиеДанные, "РасширенноеЗначение");
	Если мРежимМенеджераЗаписи Тогда
