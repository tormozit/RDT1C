...
Процедура НастроитьТабличноеПолеДвижений(Знач ТабличноеПолеНабораДвижений)
	...
	КонецЕсли; 
	ТабличноеПолеНабораДвижений.ФиксацияСлева = 1;
...
Процедура РеквизитыТаблицаВыбор(Элемент, ВыбраннаяСтрока, Колонка, СтандартнаяОбработка)
	...
	Если Колонка = ЭлементыФормы.РеквизитыТаблица.Колонки.Подсказка И ЗначениеЗаполнено(ВыбраннаяСтрока.Подсказка) Тогда
		...
		СтандартнаяОбработка = Ложь;
	Иначе
		Если ирОбщий.ЯчейкаТабличногоПоляРасширенногоЗначения_ВыборЛкс(Элемент, СтандартнаяОбработка, ВыбраннаяСтрока.ОригинальноеЗначениеРеквизита, ВыбраннаяСтрока.РазрешеноИзменение) Тогда 
