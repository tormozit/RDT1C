...
Функция ПоместитьДанныеОбъектаВФорму(Объект, ДанныеИзБД = Истина) 
	...
	Если мЭтоСсылочныйОбъект Тогда
		...
		ЗаполнитьСтрокуТаблицыРеквизиты(ЗначениеРеквизита, "Идентификатор", "Идентификатор*", ОписаниеТиповИД, мЭтоМетаСсылка Или мЭтоВнешнийОбъект Или Не Объект.ЭтоНовый());
...
Процедура РеквизитыТаблицаЗначениеРеквизитаПриИзменении(Элемент = Неопределено, ТекущиеДанные = Неопределено)
	...
	Если ТекущиеДанные.ИмяРеквизита = "Идентификатор" И мЭтоСсылочныйОбъект Тогда
