...
Процедура УстановитьМакетКомпоновкиДанных(Знач МакетКомпоновкиДанных = Неопределено)
	...
	ЭлементыФормы.МакетаКомпоновкиПлоский.ВставитьОбласть(ПолучитьПредставлениеМакетовИТелаМакетаКомпоновкиДанных(,, КопияМакета).Область());
	ЭлементыФормы.МакетКомпоновкиXML.УстановитьТекст(ирОбщий.СохранитьОбъектВВидеСтрокиXMLЛкс(мМакетКомпоновкиДанных));
