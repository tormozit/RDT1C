...
Процедура СохранитьТекущиеНастройкиВСтроку()
	...
	Тогда
		...
		Для Каждого Тн ИЗ мТекущаяСтрока.Настройки Цикл
			...
			Тогда
				Если Не ирОбщий.СтрокиРавныЛкс(
					ирОбщий.СохранитьОбъектВВидеСтрокиXMLЛкс(КомпоновщикНастроек.Настройки),
					ирОбщий.СохранитьОбъектВВидеСтрокиXMLЛкс(Тн.Настройки.Получить()))
				Тогда
