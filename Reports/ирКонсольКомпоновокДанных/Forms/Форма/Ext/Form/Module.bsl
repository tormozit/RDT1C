...
Функция СкомпоноватьРезультатМой()
	...
	СтраницаРезультата = ЭлементыФормы.ПанельРезультатов.ТекущаяСтраница;
	Если СтраницаРезультата = ЭлементыФормы.ПанельРезультатов.Страницы.МакетКомпоновки Тогда
		Если Истина
	...
	Результат = ирОбщий.СкомпоноватьОтчетВКонсолиЛкс(КоллекцияВывода, МакетКомпоновкиДанных, СтруктураВнешниеНаборыДанных(), Автофиксация, МодальныйРежим, ЛиОтладка, АдресДанныхРасшифровки, НаСервере);
