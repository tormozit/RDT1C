			...
			Для Каждого ИмяТЧ Из ТабличныеЧасти Цикл
				...
				Для Каждого ИмяПоляОбъекта Из ПоляТЧ Цикл
					Для Каждого ДоступноеПраво Из ДоступныеПрава Цикл
						Если Ложь
							Или ЛиКорневойТипСсылочный И Не ПраваСсылочные.Свойство(ДоступноеПраво.Значение) 
							Или ЛиКорневойТипРегистра И Не ПраваРегистры.Свойство(ДоступноеПраво.Значение) 
							Или ЛиКорневойТипЖурнала И Не ПраваЖурналы.Свойство(ДоступноеПраво.Значение) 
							Или ЛиКорневойТипПоследовательности И Не ПраваПоследовательность.Свойство(ДоступноеПраво.Значение) 
							Или (Истина
								И ЛиКорневойТипНехранимый 
								И Не ПраваНехранимые.Свойство(ДоступноеПраво.Значение)
								И Не (КорневойТип = "ОбщийРеквизит" И ДоступноеПраво.Значение = "Редактирование")
								И Не (КорневойТип = "ОбщаяФорма" И ДоступноеПраво.Значение = "Использование"))
						Тогда
							Продолжить;
						КонецЕсли; 
						//ИндикаторРолей = ирОбщий.ПолучитьИндикаторПроцессаЛкс(Метаданные.Роли.Количество(), "Роли");
						Для Каждого РольЦикл Из Роли Цикл
							Право = ДоступноеПраво.Значение;
							ПрерватьЦикл = Ложь;
							...
							СтрокаТаблицы.Право = ДоступноеПраво.Значение;
