...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ТаблицаПодписки.Колонки.Добавить("ПодпискаПорядок", Новый ОписаниеТипов("Число"));
	...
	Для Каждого Подписка Из Метаданные.ПодпискиНаСобытия Цикл
		...
		Для Каждого ТипОбъекта Из Подписка.Источник.Типы() Цикл
			...
			СтрокаТаблицы.ТипОбъекта = ирОбщий.ПолучитьПервыйФрагментЛкс(СтруктураТипа.ИмяОбщегоТипа);
